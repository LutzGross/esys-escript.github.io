        ...
        const escript::Data& X, const escript::Data& Y) const
{
    ...
    const double w0 = 0.00093037914038584273081*m_dx[1]*m_dx[2]/m_dx[0];
    const double w1 = 0.00093037914038584273081*m_dx[2];
    const double w2 = -0.000249294339321148701*m_dx[1];
    const double w3 = 0.00093037914038584273081*m_dx[0]*m_dx[2]/m_dx[1];
    const double w4 = -0.000249294339321148701*m_dx[0];
    const double w5 = 0.00093037914038584273081*m_dx[1];
    const double w6 = 0.00093037914038584273081*m_dx[0];
    const double w7 = -0.000249294339321148701*m_dx[0]*m_dx[1]/m_dx[2];
    const double w8 = 0.0034722222222222222222*m_dx[2];
    const double w9 = 0.012958509748503046158*m_dx[0]*m_dx[2]/m_dx[1];
    const double w10 = -0.0034722222222222222222*m_dx[0];
    const double w11 = 0.0034722222222222222222*m_dx[1];
    const double w12 = 0.012958509748503046158*m_dx[0];
    const double w13 = -0.0034722222222222222222*m_dx[0]*m_dx[1]/m_dx[2];
    const double w14 = 0.012958509748503046158*m_dx[1]*m_dx[2]/m_dx[0];
    const double w15 = 0.012958509748503046158*m_dx[1];
    const double w16 = 0.012958509748503046158*m_dx[2];
    const double w17 = 0.04836181677178996241*m_dx[1];
    const double w18 = 0.04836181677178996241*m_dx[0];
    const double w19 = -0.04836181677178996241*m_dx[0]*m_dx[1]/m_dx[2];
    const double w20 = -0.000249294339321148701*m_dx[2];
    const double w21 = -0.04836181677178996241*m_dx[2];
    const double w22 = -0.0034722222222222222222*m_dx[0]*m_dx[2]/m_dx[1];
    const double w23 = 0.00093037914038584273081*m_dx[0]*m_dx[1]/m_dx[2];
    const double w24 = -0.04836181677178996241*m_dx[0]*m_dx[2]/m_dx[1];
    const double w25 = 0.012958509748503046158*m_dx[0]*m_dx[1]/m_dx[2];
    const double w26 = -0.000249294339321148701*m_dx[0]*m_dx[2]/m_dx[1];
    const double w27 = -0.0034722222222222222222*m_dx[1]*m_dx[2]/m_dx[0];
    const double w28 = -0.000249294339321148701*m_dx[1]*m_dx[2]/m_dx[0];
    const double w29 = -0.04836181677178996241*m_dx[1]*m_dx[2]/m_dx[0];
    const double w30 = 0.0001966122466178319053*m_dx[1]*m_dx[2];
    const double w31 = 0.0001966122466178319053*m_dx[0]*m_dx[2];
    const double w32 = 0.0001966122466178319053*m_dx[0]*m_dx[1];
    const double w33 = 0.0007337668937680108255*m_dx[1]*m_dx[2];
    const double w34 = 0.0027384553284542113967*m_dx[0]*m_dx[2];
    const double w35 = 0.0027384553284542113967*m_dx[0]*m_dx[1];
    const double w36 = 0.0027384553284542113967*m_dx[1]*m_dx[2];
    const double w37 = 0.0007337668937680108255*m_dx[0]*m_dx[2];
    const double w38 = 0.010220054420048834761*m_dx[1]*m_dx[2];
    const double w39 = 0.010220054420048834761*m_dx[0]*m_dx[2];
    const double w40 = 0.038141762351741127649*m_dx[0]*m_dx[1];
    const double w41 = 0.000052682092703316795698*m_dx[0]*m_dx[1];
    const double w42 = 0.0007337668937680108255*m_dx[0]*m_dx[1];
    const double w43 = 0.010220054420048834761*m_dx[0]*m_dx[1];
    const double w44 = -0.038141762351741127649*m_dx[0]*m_dx[2];
    const double w45 = -0.000052682092703316795698*m_dx[0]*m_dx[2];
    const double w46 = 0.000052682092703316795698*m_dx[1]*m_dx[2];
    const double w47 = 0.038141762351741127649*m_dx[1]*m_dx[2];
    const double w48 = 0.027777777777777777778*m_dx[1]*m_dx[2];
    const double w49 = 0.027777777777777777778*m_dx[0]*m_dx[2];
    const double w50 = 0.055555555555555555556*m_dx[0]*m_dx[1];
    const double w51 = -0.055555555555555555556*m_dx[0]*m_dx[2];
    const double w52 = -0.027777777777777777778*m_dx[0]*m_dx[1];
    const double w53 = -0.013888888888888888889*m_dx[1]*m_dx[2];
    const double w54 = 0.0000415490565535247835*m_dx[0]*m_dx[1]*m_dx[2];
    const double w55 = 0.0005787037037037037037*m_dx[0]*m_dx[1]*m_dx[2];
    const double w56 = 0.0080603027952983270684*m_dx[0]*m_dx[1]*m_dx[2];
    const double w57 = 0.0001550631900643071218*m_dx[0]*m_dx[1]*m_dx[2];
    const double w58 = 0.002159751624750507693*m_dx[0]*m_dx[1]*m_dx[2];
    const double w59 = 0.03008145955644280058*m_dx[0]*m_dx[1]*m_dx[2];
    const double w60 = 0.000011133036149792012194*m_dx[0]*m_dx[1]*m_dx[2];
    const double w61 = -0.077751058491018276948*m_dx[1]*m_dx[2];
    const double w62 = -0.077751058491018276948*m_dx[0]*m_dx[2];
    const double w63 = -0.077751058491018276948*m_dx[0]*m_dx[1];
    const double w64 = -0.020833333333333333333*m_dx[0]*m_dx[2];
    const double w65 = -0.020833333333333333333*m_dx[0]*m_dx[1];
    const double w66 = -0.020833333333333333333*m_dx[1]*m_dx[2];
    const double w67 = -0.0055822748423150563848*m_dx[0]*m_dx[1];
    const double w68 = -0.0055822748423150563848*m_dx[0]*m_dx[2];
    const double w69 = -0.0055822748423150563848*m_dx[1]*m_dx[2];
    const double w70 = 0.061320326520293008568*m_dx[0]*m_dx[1]*m_dx[2];
                    ...
                    for (index_t k0=0; k0<m_NE[0]; ++k0)  {
                        ...
                        if (!A.isEmpty()) {
                            ...
                            if (A.actsExpanded()) {
                                ...
                                const double tmp0 = 24*w11*(-A_02 + A_20);
                                const double tmp1 = 24*w10*(A_12 - A_21);
                                const double tmp2 = 12*w8*(A_01 + A_10);
                                const double tmp3 = 12*w11*(-A_02 + A_20);
                                const double tmp4 = 12*w10*(A_12 - A_21);
                                const double tmp5 = 24*w8*(-A_01 - A_10);
                                const double tmp6 = 12*w11*(-A_02 - A_20);
                                const double tmp7 = 24*w10*(-A_12 + A_21);
                                const double tmp8 = 24*w8*(A_01 - A_10);
                                const double tmp9 = 24*w11*(A_02 - A_20);
                                const double tmp10 = 12*w10*(A_12 + A_21);
                                const double tmp11 = 24*w8*(-A_01 + A_10);
                                const double tmp12 = 12*w8*(-A_01 - A_10);
                                const double tmp13 = 12*w11*(A_02 - A_20);
                                const double tmp14 = 24*w8*(A_01 + A_10);
                                const double tmp15 = 12*w11*(A_02 + A_20);
                                const double tmp16 = 12*w10*(-A_12 - A_21);
                                const double tmp17 = 12*w10*(-A_12 + A_21);
                                const double tmp18 = 24*w11*(-A_02 - A_20);
                                const double tmp19 = 12*w8*(A_01 - A_10);
                                const double tmp20 = 24*w10*(A_12 + A_21);
                                const double tmp21 = 24*w11*(A_02 + A_20);
                                const double tmp22 = 12*w8*(-A_01 + A_10);
                                const double tmp23 = 24*w10*(-A_12 - A_21);
                                EM_S[INDEX2(0,0,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp14 + tmp21 + tmp23;
                                EM_S[INDEX2(0,1,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp16 + tmp8 + tmp9;
                                EM_S[INDEX2(0,2,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp11 + tmp15 + tmp7;
                                EM_S[INDEX2(0,3,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp13 + tmp17 + tmp5;
                                EM_S[INDEX2(0,4,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp0 + tmp1 + tmp2;
                                EM_S[INDEX2(0,5,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp18 + tmp19 + tmp4;
                                EM_S[INDEX2(0,6,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp20 + tmp22 + tmp3;
                                EM_S[INDEX2(0,7,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp10 + tmp12 + tmp6;
                                EM_S[INDEX2(1,0,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp0 + tmp11 + tmp16;
                                EM_S[INDEX2(1,1,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp18 + tmp23 + tmp5;
                                EM_S[INDEX2(1,2,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp14 + tmp17 + tmp3;
                                EM_S[INDEX2(1,3,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp6 + tmp7 + tmp8;
                                EM_S[INDEX2(1,4,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp21 + tmp22 + tmp4;
                                EM_S[INDEX2(1,5,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp1 + tmp12 + tmp9;
                                EM_S[INDEX2(1,6,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp10 + tmp15 + tmp2;
                                EM_S[INDEX2(1,7,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp19 + tmp20;
                                EM_S[INDEX2(2,0,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp15 + tmp8;
                                EM_S[INDEX2(2,1,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp13 + tmp14 + tmp4;
                                EM_S[INDEX2(2,2,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp20 + tmp21 + tmp5;
                                EM_S[INDEX2(2,3,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp10 + tmp11 + tmp9;
                                EM_S[INDEX2(2,4,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp19 + tmp23 + tmp3;
                                EM_S[INDEX2(2,5,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp16 + tmp2 + tmp6;
                                EM_S[INDEX2(2,6,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp0 + tmp12 + tmp7;
                                EM_S[INDEX2(2,7,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp18 + tmp22;
                                EM_S[INDEX2(3,0,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp3 + tmp4 + tmp5;
                                EM_S[INDEX2(3,1,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp11 + tmp6;
                                EM_S[INDEX2(3,2,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp0 + tmp10 + tmp8;
                                EM_S[INDEX2(3,3,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp14 + tmp18 + tmp20;
                                EM_S[INDEX2(3,4,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp12 + tmp15 + tmp16;
                                EM_S[INDEX2(3,5,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp22 + tmp23;
                                EM_S[INDEX2(3,6,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp19 + tmp21;
                                EM_S[INDEX2(3,7,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp2 + tmp7 + tmp9;
                                EM_S[INDEX2(4,0,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp2 + tmp7 + tmp9;
                                EM_S[INDEX2(4,1,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp19 + tmp21;
                                EM_S[INDEX2(4,2,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp22 + tmp23;
                                EM_S[INDEX2(4,3,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp12 + tmp15 + tmp16;
                                EM_S[INDEX2(4,4,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp14 + tmp18 + tmp20;
                                EM_S[INDEX2(4,5,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp0 + tmp10 + tmp8;
                                EM_S[INDEX2(4,6,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp11 + tmp6;
                                EM_S[INDEX2(4,7,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp3 + tmp4 + tmp5;
                                EM_S[INDEX2(5,0,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp18 + tmp22;
                                EM_S[INDEX2(5,1,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp0 + tmp12 + tmp7;
                                EM_S[INDEX2(5,2,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp16 + tmp2 + tmp6;
                                EM_S[INDEX2(5,3,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp19 + tmp23 + tmp3;
                                EM_S[INDEX2(5,4,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp10 + tmp11 + tmp9;
                                EM_S[INDEX2(5,5,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp20 + tmp21 + tmp5;
                                EM_S[INDEX2(5,6,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp13 + tmp14 + tmp4;
                                EM_S[INDEX2(5,7,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp15 + tmp8;
                                EM_S[INDEX2(6,0,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp19 + tmp20;
                                EM_S[INDEX2(6,1,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp10 + tmp15 + tmp2;
                                EM_S[INDEX2(6,2,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp1 + tmp12 + tmp9;
                                EM_S[INDEX2(6,3,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp21 + tmp22 + tmp4;
                        ...
                        if (!B.isEmpty()) {
                            ...
                            if (B.actsExpanded()) {
                                ...
                                EM_S[INDEX2(0,0,8)]+=4*B_0*w53 + B_1*w51 - B_2*w50;
                                EM_S[INDEX2(0,1,8)]+=4*B_0*w53 - B_1*w49 + B_2*w52;
                                EM_S[INDEX2(0,2,8)]+=-B_0*w48 + B_1*w51 + B_2*w52;
                                EM_S[INDEX2(0,3,8)]+=-B_0*w48 - B_1*w49 + B_2*w52/2;
                                EM_S[INDEX2(0,4,8)]+=-B_0*w48 - B_1*w49 - B_2*w50;
                                EM_S[INDEX2(0,5,8)]+=-B_0*w48 + B_1*w51/4 + B_2*w52;
                                EM_S[INDEX2(0,6,8)]+=B_0*w53 - B_1*w49 + B_2*w52;
                                EM_S[INDEX2(0,7,8)]+=B_0*w53 + B_1*w51/4 + B_2*w52/2;
                                EM_S[INDEX2(1,0,8)]+=-4*B_0*w53 - B_1*w49 + B_2*w52;
                                EM_S[INDEX2(1,1,8)]+=-4*B_0*w53 + B_1*w51 - B_2*w50;
                                EM_S[INDEX2(1,2,8)]+=B_0*w48 - B_1*w49 + B_2*w52/2;
                                EM_S[INDEX2(1,3,8)]+=B_0*w48 + B_1*w51 + B_2*w52;
                                EM_S[INDEX2(1,4,8)]+=B_0*w48 + B_1*w51/4 + B_2*w52;
                                EM_S[INDEX2(1,5,8)]+=B_0*w48 - B_1*w49 - B_2*w50;
                                EM_S[INDEX2(1,6,8)]+=-B_0*w53 + B_1*w51/4 + B_2*w52/2;
                                EM_S[INDEX2(1,7,8)]+=-B_0*w53 - B_1*w49 + B_2*w52;
                                EM_S[INDEX2(2,0,8)]+=-B_0*w48 - B_1*w51 + B_2*w52;
                                EM_S[INDEX2(2,1,8)]+=-B_0*w48 + B_1*w49 + B_2*w52/2;
                                EM_S[INDEX2(2,2,8)]+=4*B_0*w53 - B_1*w51 - B_2*w50;
                                EM_S[INDEX2(2,3,8)]+=4*B_0*w53 + B_1*w49 + B_2*w52;
                                EM_S[INDEX2(2,4,8)]+=B_0*w53 + B_1*w49 + B_2*w52;
                                EM_S[INDEX2(2,5,8)]+=B_0*w53 - B_1*w51/4 + B_2*w52/2;
                                EM_S[INDEX2(2,6,8)]+=-B_0*w48 + B_1*w49 - B_2*w50;
                                EM_S[INDEX2(2,7,8)]+=-B_0*w48 - B_1*w51/4 + B_2*w52;
                                EM_S[INDEX2(3,0,8)]+=B_0*w48 + B_1*w49 + B_2*w52/2;
                                EM_S[INDEX2(3,1,8)]+=B_0*w48 - B_1*w51 + B_2*w52;
                                EM_S[INDEX2(3,2,8)]+=-4*B_0*w53 + B_1*w49 + B_2*w52;
                                EM_S[INDEX2(3,3,8)]+=-4*B_0*w53 - B_1*w51 - B_2*w50;
                                EM_S[INDEX2(3,4,8)]+=-B_0*w53 - B_1*w51/4 + B_2*w52/2;
                                EM_S[INDEX2(3,5,8)]+=-B_0*w53 + B_1*w49 + B_2*w52;
                                EM_S[INDEX2(3,6,8)]+=B_0*w48 - B_1*w51/4 + B_2*w52;
                                EM_S[INDEX2(3,7,8)]+=B_0*w48 + B_1*w49 - B_2*w50;
                                EM_S[INDEX2(4,0,8)]+=-B_0*w48 - B_1*w49 + B_2*w50;
                                EM_S[INDEX2(4,1,8)]+=-B_0*w48 + B_1*w51/4 - B_2*w52;
                                EM_S[INDEX2(4,2,8)]+=B_0*w53 - B_1*w49 - B_2*w52;
                                EM_S[INDEX2(4,3,8)]+=B_0*w53 + B_1*w51/4 + B_2*w50/4;
                                EM_S[INDEX2(4,4,8)]+=4*B_0*w53 + B_1*w51 + B_2*w50;
                                EM_S[INDEX2(4,5,8)]+=4*B_0*w53 - B_1*w49 - B_2*w52;
                                EM_S[INDEX2(4,6,8)]+=-B_0*w48 + B_1*w51 - B_2*w52;
                                EM_S[INDEX2(4,7,8)]+=-B_0*w48 - B_1*w49 + B_2*w50/4;
                                EM_S[INDEX2(5,0,8)]+=B_0*w48 + B_1*w51/4 - B_2*w52;
                                EM_S[INDEX2(5,1,8)]+=B_0*w48 - B_1*w49 + B_2*w50;
                                EM_S[INDEX2(5,2,8)]+=-B_0*w53 + B_1*w51/4 + B_2*w50/4;
                                EM_S[INDEX2(5,3,8)]+=-B_0*w53 - B_1*w49 - B_2*w52;
                                EM_S[INDEX2(5,4,8)]+=2*B_0*w48 - B_1*w49 - B_2*w52;
                                EM_S[INDEX2(5,5,8)]+=-4*B_0*w53 + B_1*w51 + B_2*w50;
                                EM_S[INDEX2(5,6,8)]+=B_0*w48 - B_1*w49 + B_2*w50/4;
                                EM_S[INDEX2(5,7,8)]+=B_0*w48 + B_1*w51 - B_2*w52;
                                EM_S[INDEX2(6,0,8)]+=B_0*w53 + B_1*w49 - B_2*w52;
                                EM_S[INDEX2(6,1,8)]+=B_0*w53 - B_1*w51/4 + B_2*w50/4;
                                EM_S[INDEX2(6,2,8)]+=-B_0*w48 + B_1*w49 + B_2*w50;
                                EM_S[INDEX2(6,3,8)]+=-B_0*w48 - B_1*w51/4 - B_2*w52;
                                EM_S[INDEX2(6,4,8)]+=-B_0*w48 - B_1*w51 - B_2*w52;
                                EM_S[INDEX2(6,5,8)]+=-B_0*w48 + B_1*w49 + B_2*w50/4;
                                EM_S[INDEX2(6,6,8)]+=4*B_0*w53 - B_1*w51 + B_2*w50;
                                EM_S[INDEX2(6,7,8)]+=4*B_0*w53 + B_1*w49 - B_2*w52;
                                EM_S[INDEX2(7,0,8)]+=-B_0*w53 - B_1*w51/4 + B_2*w50/4;
                                EM_S[INDEX2(7,1,8)]+=-B_0*w53 + B_1*w49 - B_2*w52;
                                EM_S[INDEX2(7,2,8)]+=B_0*w48 - B_1*w51/4 - B_2*w52;
                                EM_S[INDEX2(7,3,8)]+=B_0*w48 + B_1*w49 + B_2*w50;
                                EM_S[INDEX2(7,4,8)]+=B_0*w48 + B_1*w49 + B_2*w50/4;
                                EM_S[INDEX2(7,5,8)]+=B_0*w48 - B_1*w51 - B_2*w52;
                                EM_S[INDEX2(7,6,8)]+=-4*B_0*w53 + B_1*w49 - B_2*w52;
                                EM_S[INDEX2(7,7,8)]+=-4*B_0*w53 - B_1*w51 + B_2*w50;
                            }
                        }
                        ///////////////
                        // process C //
                        ...
                        if (!C.isEmpty()) {
                            ...
                            if (C.actsExpanded()) {
                                ...
                                EM_S[INDEX2(0,0,8)]+=4*C_0*w53 + C_1*w51 - C_2*w50;
                                EM_S[INDEX2(0,1,8)]+=-4*C_0*w53 - C_1*w49 + C_2*w52;
                                EM_S[INDEX2(0,2,8)]+=-C_0*w48 - C_1*w51 + C_2*w52;
                                EM_S[INDEX2(0,3,8)]+=C_0*w48 + C_1*w49 + C_2*w52/2;
                                EM_S[INDEX2(0,4,8)]+=-C_0*w48 - C_1*w49 + C_2*w50;
                                EM_S[INDEX2(0,5,8)]+=C_0*w48 + C_1*w51/4 - C_2*w52;
                                EM_S[INDEX2(0,6,8)]+=C_0*w53 + C_1*w49 - C_2*w52;
                                EM_S[INDEX2(0,7,8)]+=-C_0*w53 - C_1*w51/4 + C_2*w50/4;
                                EM_S[INDEX2(1,0,8)]+=4*C_0*w53 - C_1*w49 + C_2*w52;
                                EM_S[INDEX2(1,1,8)]+=-4*C_0*w53 + C_1*w51 - C_2*w50;
                                EM_S[INDEX2(1,2,8)]+=-C_0*w48 + C_1*w49 + C_2*w52/2;
                                EM_S[INDEX2(1,3,8)]+=C_0*w48 - C_1*w51 + C_2*w52;
                                EM_S[INDEX2(1,4,8)]+=-C_0*w48 + C_1*w51/4 - C_2*w52;
                                EM_S[INDEX2(1,5,8)]+=C_0*w48 - C_1*w49 + C_2*w50;
                                EM_S[INDEX2(1,6,8)]+=C_0*w53 - C_1*w51/4 + C_2*w50/4;
                                EM_S[INDEX2(1,7,8)]+=-C_0*w53 + C_1*w49 - C_2*w52;
                                EM_S[INDEX2(2,0,8)]+=-C_0*w48 + C_1*w51 + C_2*w52;
                                EM_S[INDEX2(2,1,8)]+=C_0*w48 - C_1*w49 + C_2*w52/2;
                                EM_S[INDEX2(2,2,8)]+=4*C_0*w53 - C_1*w51 - C_2*w50;
                                EM_S[INDEX2(2,3,8)]+=-4*C_0*w53 + C_1*w49 + C_2*w52;
                                EM_S[INDEX2(2,4,8)]+=C_0*w53 - C_1*w49 - C_2*w52;
                                EM_S[INDEX2(2,5,8)]+=-C_0*w53 + C_1*w51/4 + C_2*w50/4;
                                EM_S[INDEX2(2,6,8)]+=-C_0*w48 + C_1*w49 + C_2*w50;
                                EM_S[INDEX2(2,7,8)]+=C_0*w48 - C_1*w51/4 - C_2*w52;
                                EM_S[INDEX2(3,0,8)]+=-C_0*w48 - C_1*w49 + C_2*w52/2;
                                EM_S[INDEX2(3,1,8)]+=C_0*w48 + C_1*w51 + C_2*w52;
                                EM_S[INDEX2(3,2,8)]+=4*C_0*w53 + C_1*w49 + C_2*w52;
                                EM_S[INDEX2(3,3,8)]+=-4*C_0*w53 - C_1*w51 - C_2*w50;
                                EM_S[INDEX2(3,4,8)]+=C_0*w53 + C_1*w51/4 + C_2*w50/4;
                                EM_S[INDEX2(3,5,8)]+=-C_0*w53 - C_1*w49 - C_2*w52;
                                EM_S[INDEX2(3,6,8)]+=-C_0*w48 - C_1*w51/4 - C_2*w52;
                                EM_S[INDEX2(3,7,8)]+=C_0*w48 + C_1*w49 + C_2*w50;
                                EM_S[INDEX2(4,0,8)]+=-C_0*w48 - C_1*w49 - C_2*w50;
                                EM_S[INDEX2(4,1,8)]+=C_0*w48 + C_1*w51/4 + C_2*w52;
                                EM_S[INDEX2(4,2,8)]+=C_0*w53 + C_1*w49 + C_2*w52;
                                EM_S[INDEX2(4,3,8)]+=-C_0*w53 - C_1*w51/4 + C_2*w52/2;
                                EM_S[INDEX2(4,4,8)]+=4*C_0*w53 + C_1*w51 + C_2*w50;
                                EM_S[INDEX2(4,5,8)]+=-4*C_0*w53 - C_1*w49 - C_2*w52;
                                EM_S[INDEX2(4,6,8)]+=-C_0*w48 - C_1*w51 - C_2*w52;
                                EM_S[INDEX2(4,7,8)]+=C_0*w48 + C_1*w49 + C_2*w50/4;
                                EM_S[INDEX2(5,0,8)]+=-C_0*w48 + C_1*w51/4 + C_2*w52;
                                EM_S[INDEX2(5,1,8)]+=C_0*w48 - C_1*w49 - C_2*w50;
                                EM_S[INDEX2(5,2,8)]+=C_0*w53 - C_1*w51/4 + C_2*w52/2;
                                EM_S[INDEX2(5,3,8)]+=-C_0*w53 + C_1*w49 + C_2*w52;
                                EM_S[INDEX2(5,4,8)]+=4*C_0*w53 - C_1*w49 - C_2*w52;
                                EM_S[INDEX2(5,5,8)]+=-4*C_0*w53 + C_1*w51 + C_2*w50;
                                EM_S[INDEX2(5,6,8)]+=-C_0*w48 + C_1*w49 + C_2*w50/4;
                                EM_S[INDEX2(5,7,8)]+=C_0*w48 - C_1*w51 - C_2*w52;
                                EM_S[INDEX2(6,0,8)]+=C_0*w53 - C_1*w49 + C_2*w52;
                                EM_S[INDEX2(6,1,8)]+=-C_0*w53 + C_1*w51/4 + C_2*w52/2;
                                EM_S[INDEX2(6,2,8)]+=-C_0*w48 + C_1*w49 - C_2*w50;
                                EM_S[INDEX2(6,3,8)]+=C_0*w48 - C_1*w51/4 + C_2*w52;
                                EM_S[INDEX2(6,4,8)]+=-C_0*w48 + C_1*w51 - C_2*w52;
                                EM_S[INDEX2(6,5,8)]+=C_0*w48 - C_1*w49 + C_2*w50/4;
                                EM_S[INDEX2(6,6,8)]+=4*C_0*w53 - C_1*w51 + C_2*w50;
                                EM_S[INDEX2(6,7,8)]+=-4*C_0*w53 + C_1*w49 - C_2*w52;
                                EM_S[INDEX2(7,0,8)]+=C_0*w53 + C_1*w51/4 + C_2*w52/2;
                                EM_S[INDEX2(7,1,8)]+=-C_0*w53 - C_1*w49 + C_2*w52;
                                EM_S[INDEX2(7,2,8)]+=-C_0*w48 - C_1*w51/4 + C_2*w52;
                                EM_S[INDEX2(7,3,8)]+=C_0*w48 + C_1*w49 - C_2*w50;
                                EM_S[INDEX2(7,4,8)]+=-C_0*w48 - C_1*w49 + C_2*w50/4;
                                EM_S[INDEX2(7,5,8)]+=C_0*w48 + C_1*w51 - C_2*w52;
                                EM_S[INDEX2(7,6,8)]+=4*C_0*w53 + C_1*w49 - C_2*w52;
                                EM_S[INDEX2(7,7,8)]+=-4*C_0*w53 - C_1*w51 + C_2*w50;
                            }
                        }
                        ///////////////
                        // process D //
                        ...
                        if (!D.isEmpty()) {
                            ...
                            if (D.actsExpanded()) {
                                ...
                                const double D_0 = D_p[0];
                                EM_S[INDEX2(0,0,8)]+=64*D_0*w55;
                                EM_S[INDEX2(0,1,8)]+=32*D_0*w55;
                                EM_S[INDEX2(0,2,8)]+=32*D_0*w55;
                                EM_S[INDEX2(0,3,8)]+=16*D_0*w55;
                                EM_S[INDEX2(0,4,8)]+=32*D_0*w55;
                                EM_S[INDEX2(0,5,8)]+=16*D_0*w55;
                                EM_S[INDEX2(0,6,8)]+=16*D_0*w55;
                                EM_S[INDEX2(0,7,8)]+=8*D_0*w55;
                                EM_S[INDEX2(1,0,8)]+=32*D_0*w55;
                                EM_S[INDEX2(1,1,8)]+=64*D_0*w55;
                                EM_S[INDEX2(1,2,8)]+=16*D_0*w55;
                                EM_S[INDEX2(1,3,8)]+=32*D_0*w55;
                                EM_S[INDEX2(1,4,8)]+=16*D_0*w55;
                                EM_S[INDEX2(1,5,8)]+=32*D_0*w55;
                                EM_S[INDEX2(1,6,8)]+=8*D_0*w55;
                                EM_S[INDEX2(1,7,8)]+=16*D_0*w55;
                                EM_S[INDEX2(2,0,8)]+=32*D_0*w55;
                                EM_S[INDEX2(2,1,8)]+=16*D_0*w55;
                                EM_S[INDEX2(2,2,8)]+=64*D_0*w55;
                                EM_S[INDEX2(2,3,8)]+=32*D_0*w55;
                                EM_S[INDEX2(2,4,8)]+=16*D_0*w55;
                                EM_S[INDEX2(2,5,8)]+=8*D_0*w55;
                                EM_S[INDEX2(2,6,8)]+=32*D_0*w55;
                                EM_S[INDEX2(2,7,8)]+=16*D_0*w55;
                                EM_S[INDEX2(3,0,8)]+=16*D_0*w55;
                                EM_S[INDEX2(3,1,8)]+=32*D_0*w55;
                                EM_S[INDEX2(3,2,8)]+=32*D_0*w55;
                                EM_S[INDEX2(3,3,8)]+=64*D_0*w55;
                                EM_S[INDEX2(3,4,8)]+=8*D_0*w55;
                                EM_S[INDEX2(3,5,8)]+=16*D_0*w55;
                                EM_S[INDEX2(3,6,8)]+=16*D_0*w55;
                                EM_S[INDEX2(3,7,8)]+=32*D_0*w55;
                                EM_S[INDEX2(4,0,8)]+=32*D_0*w55;
                                EM_S[INDEX2(4,1,8)]+=16*D_0*w55;
                                EM_S[INDEX2(4,2,8)]+=16*D_0*w55;
                                EM_S[INDEX2(4,3,8)]+=8*D_0*w55;
                                EM_S[INDEX2(4,4,8)]+=64*D_0*w55;
                                EM_S[INDEX2(4,5,8)]+=32*D_0*w55;
                                EM_S[INDEX2(4,6,8)]+=32*D_0*w55;
                                EM_S[INDEX2(4,7,8)]+=16*D_0*w55;
                                EM_S[INDEX2(5,0,8)]+=16*D_0*w55;
                                EM_S[INDEX2(5,1,8)]+=32*D_0*w55;
                                EM_S[INDEX2(5,2,8)]+=8*D_0*w55;
                                EM_S[INDEX2(5,3,8)]+=16*D_0*w55;
                                EM_S[INDEX2(5,4,8)]+=32*D_0*w55;
                                EM_S[INDEX2(5,5,8)]+=64*D_0*w55;
                                EM_S[INDEX2(5,6,8)]+=16*D_0*w55;
                                EM_S[INDEX2(5,7,8)]+=32*D_0*w55;
                                EM_S[INDEX2(6,0,8)]+=16*D_0*w55;
                                EM_S[INDEX2(6,1,8)]+=8*D_0*w55;
                                EM_S[INDEX2(6,2,8)]+=32*D_0*w55;
                                EM_S[INDEX2(6,3,8)]+=16*D_0*w55;
                                EM_S[INDEX2(6,4,8)]+=32*D_0*w55;
                                EM_S[INDEX2(6,5,8)]+=16*D_0*w55;
                                EM_S[INDEX2(6,6,8)]+=64*D_0*w55;
                                EM_S[INDEX2(6,7,8)]+=32*D_0*w55;
                                EM_S[INDEX2(7,0,8)]+=8*D_0*w55;
                                EM_S[INDEX2(7,1,8)]+=16*D_0*w55;
                                EM_S[INDEX2(7,2,8)]+=16*D_0*w55;
                                EM_S[INDEX2(7,3,8)]+=32*D_0*w55;
                                EM_S[INDEX2(7,4,8)]+=16*D_0*w55;
                                EM_S[INDEX2(7,5,8)]+=32*D_0*w55;
                                EM_S[INDEX2(7,6,8)]+=32*D_0*w55;
                                EM_S[INDEX2(7,7,8)]+=64*D_0*w55;
                            }
                        }
                        ///////////////
                        // process X //
                        ...
                        if (!X.isEmpty()) {
                            ...
                            if (X.actsExpanded()) {
                                ...
                                EM_F[0]+=18*X_0*w53 + 12*X_1*w64 + 12*X_2*w65;
                                EM_F[1]+=-18*X_0*w53 + 12*X_1*w64 + 12*X_2*w65;
                                EM_F[2]+=18*X_0*w53 - 12*X_1*w64 + 12*X_2*w65;
                                EM_F[3]+=-18*X_0*w53 - 12*X_1*w64 + 12*X_2*w65;
                                EM_F[4]+=18*X_0*w53 + 12*X_1*w64 - 12*X_2*w65;
                                EM_F[5]+=-18*X_0*w53 + 12*X_1*w64 - 12*X_2*w65;
                                EM_F[6]+=18*X_0*w53 - 12*X_1*w64 - 12*X_2*w65;
                                EM_F[7]+=-18*X_0*w53 - 12*X_1*w64 - 12*X_2*w65;
                            }
                        }
                        ///////////////
                        // process Y //
...
void Brick::assemblePDESingleReduced(Paso_SystemMatrix* mat,
        ...
        const escript::Data& X, const escript::Data& Y) const
{
    const double w6 = 0.0625*m_dx[0];
    const double w5 = 0.0625*m_dx[1];
    const double w1 = 0.0625*m_dx[2];
    const double w14 = 0.03125*m_dx[0]*m_dx[1];
    const double w13 = 0.03125*m_dx[0]*m_dx[2];
    const double w12 = 0.03125*m_dx[1]*m_dx[2];
    const double w18 = 0.015625*m_dx[0]*m_dx[1]*m_dx[2];
    const double w11 = 0.0625*m_dx[0]*m_dx[1]/m_dx[2];
    const double w3 = 0.0625*m_dx[0]*m_dx[2]/m_dx[1];
    const double w0 = 0.0625*m_dx[1]*m_dx[2]/m_dx[0];
                            ...
                            if (A.actsExpanded()) {
                                ...
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        const double tmp22 = 12*w8*(-A_01 + A_10);
                                        const double tmp23 = 24*w10*(-A_12 - A_21);
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp14 + tmp21 + tmp23;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp16 + tmp8 + tmp9;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp11 + tmp15 + tmp7;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp13 + tmp17 + tmp5;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp0 + tmp1 + tmp2;
                                        EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp18 + tmp19 + tmp4;
                                        EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp20 + tmp22 + tmp3;
                                        EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp10 + tmp12 + tmp6;
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp0 + tmp11 + tmp16;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp18 + tmp23 + tmp5;
                                        EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp14 + tmp17 + tmp3;
                                        EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp6 + tmp7 + tmp8;
                                        EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp21 + tmp22 + tmp4;
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp1 + tmp12 + tmp9;
                                        EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp10 + tmp15 + tmp2;
                                        EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp19 + tmp20;
                                        EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp15 + tmp8;
                                        EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp13 + tmp14 + tmp4;
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp20 + tmp21 + tmp5;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp10 + tmp11 + tmp9;
                                        EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp19 + tmp23 + tmp3;
                                        EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp16 + tmp2 + tmp6;
                                        EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp0 + tmp12 + tmp7;
                                        EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp18 + tmp22;
                                        EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp3 + tmp4 + tmp5;
                                        EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp11 + tmp6;
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp0 + tmp10 + tmp8;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp14 + tmp18 + tmp20;
                                        EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp12 + tmp15 + tmp16;
                                        EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp22 + tmp23;
                                        EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp19 + tmp21;
                                        EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp2 + tmp7 + tmp9;
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp2 + tmp7 + tmp9;
                                        EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp19 + tmp21;
                                        EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp13 + tmp22 + tmp23;
                                        EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp12 + tmp15 + tmp16;
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp14 + tmp18 + tmp20;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp0 + tmp10 + tmp8;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=-16*A_00*w27 + 32*A_11*w22 - 16*A_22*w13 + tmp1 + tmp11 + tmp6;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=16*A_00*w27 + 16*A_11*w22 - 8*A_22*w13 + tmp3 + tmp4 + tmp5;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=16*A_00*w27 - 8*A_11*w22 + 16*A_22*w13 + tmp17 + tmp18 + tmp22;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=-16*A_00*w27 - 16*A_11*w22 + 32*A_22*w13 + tmp0 + tmp12 + tmp7;
                                        EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=8*A_00*w27 + 8*A_11*w22 + 8*A_22*w13 + tmp16 + tmp2 + tmp6;
                                        EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=-8*A_00*w27 + 16*A_11*w22 + 16*A_22*w13 + tmp19 + tmp23 + tmp3;
                                        EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=32*A_00*w27 - 16*A_11*w22 - 16*A_22*w13 + tmp10 + tmp11 + tmp9;
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=-32*A_00*w27 - 32*A_11*w22 - 32*A_22*w13 + tmp20 + tmp21 + tmp5;
                            ...
                            if (B.actsExpanded()) {
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        const double tmp262 = w32*(-B_2_1 - B_2_3);
                                        const double tmp263 = w43*(-B_2_4 - B_2_6);
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=-B_0_0*w47 - B_0_1*w38 - B_0_6*w30 - B_0_7*w46 + B_1_0*w44 - B_1_2*w39 - B_1_5*w31 + B_1_7*w45 - B_2_0*w40 - B_2_3*w32 - B_2_4*w43 - B_2_7*w41 + tmp132 + tmp133 + tmp208 + tmp209 + tmp210 + tmp211;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=-B_0_0*w38 - B_0_1*w47 - B_0_6*w46 - B_0_7*w30 + tmp128 + tmp129 + tmp242 + tmp243 + tmp244 + tmp245 + tmp246 + tmp247 + tmp248 + tmp249;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-B_1_0*w39 + B_1_2*w44 + B_1_5*w45 - B_1_7*w31 + tmp138 + tmp139 + tmp140 + tmp142 + tmp143 + tmp144 + tmp145 + tmp146 + tmp173 + tmp179;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=tmp100 + tmp101 + tmp102 + tmp103 + tmp42 + tmp43 + tmp96 + tmp97 + tmp98 + tmp99;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=-B_2_0*w43 - B_2_3*w41 - B_2_4*w40 - B_2_7*w32 + tmp114 + tmp115 + tmp116 + tmp117 + tmp118 + tmp119 + tmp120 + tmp121 + tmp92 + tmp93;
                                        EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=tmp190 + tmp193 + tmp195 + tmp196 + tmp197 + tmp199 + tmp224 + tmp225 + tmp226 + tmp227;
                                        EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=tmp234 + tmp235 + tmp238 + tmp239 + tmp240 + tmp241 + tmp260 + tmp261 + tmp262 + tmp263;
                                        EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=tmp60 + tmp61 + tmp62 + tmp63 + tmp64 + tmp65;
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=B_0_0*w47 + B_0_1*w38 + B_0_6*w30 + B_0_7*w46 + tmp148 + tmp149 + tmp242 + tmp243 + tmp244 + tmp245 + tmp246 + tmp247 + tmp248 + tmp249;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=B_0_0*w38 + B_0_1*w47 + B_0_6*w46 + B_0_7*w30 + B_1_1*w44 - B_1_3*w39 - B_1_4*w31 + B_1_6*w45 - B_2_1*w40 - B_2_2*w32 - B_2_5*w43 - B_2_6*w41 + tmp152 + tmp155 + tmp164 + tmp165 + tmp168 + tmp169;
                                        EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=tmp103 + tmp40 + tmp42 + tmp43 + tmp46 + tmp47 + tmp48 + tmp97 + tmp98 + tmp99;
                                        EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=-B_1_1*w39 + B_1_3*w44 + B_1_4*w45 - B_1_6*w31 + tmp20 + tmp21 + tmp22 + tmp23 + tmp24 + tmp25 + tmp26 + tmp27 + tmp28 + tmp29;
                                        EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=tmp193 + tmp199 + tmp214 + tmp215 + tmp216 + tmp217 + tmp224 + tmp225 + tmp226 + tmp227;
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=-B_2_1*w43 - B_2_2*w41 - B_2_5*w40 - B_2_6*w32 + tmp72 + tmp73 + tmp82 + tmp83 + tmp86 + tmp87 + tmp88 + tmp89 + tmp90 + tmp91;
                                        EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=tmp60 + tmp61 + tmp62 + tmp65 + tmp80 + tmp81;
                                        EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+=tmp180 + tmp183 + tmp185 + tmp186 + tmp187 + tmp189 + tmp254 + tmp255 + tmp256 + tmp257;
                                        EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-B_1_0*w44 + B_1_2*w39 + B_1_5*w31 - B_1_7*w45 + tmp138 + tmp139 + tmp140 + tmp141 + tmp142 + tmp143 + tmp144 + tmp145 + tmp146 + tmp147;
                                        EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=tmp100 + tmp101 + tmp102 + tmp41 + tmp42 + tmp43 + tmp44 + tmp45 + tmp49 + tmp96;
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=-B_0_2*w47 - B_0_3*w38 - B_0_4*w30 - B_0_5*w46 + B_1_0*w39 - B_1_2*w44 - B_1_5*w45 + B_1_7*w31 - B_2_1*w32 - B_2_2*w40 - B_2_5*w41 - B_2_6*w43 + tmp153 + tmp154 + tmp164 + tmp165 + tmp166 + tmp167;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=-B_0_2*w38 - B_0_3*w47 - B_0_4*w46 - B_0_5*w30 + tmp200 + tmp201 + tmp202 + tmp203 + tmp204 + tmp205 + tmp206 + tmp207 + tmp222 + tmp223;
                                        EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=tmp228 + tmp231 + tmp233 + tmp234 + tmp235 + tmp237 + tmp260 + tmp261 + tmp262 + tmp263;
                                        EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=tmp60 + tmp61 + tmp63 + tmp64 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=-B_2_1*w41 - B_2_2*w43 - B_2_5*w32 - B_2_6*w40 + tmp70 + tmp71 + tmp72 + tmp73 + tmp74 + tmp75 + tmp76 + tmp77 + tmp78 + tmp79;
                                        EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=tmp107 + tmp113 + tmp156 + tmp157 + tmp158 + tmp159 + tmp160 + tmp161 + tmp162 + tmp163;
                                        EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=tmp40 + tmp41 + tmp42 + tmp43 + tmp44 + tmp45 + tmp46 + tmp47 + tmp48 + tmp49;
                                        EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=-B_1_1*w44 + B_1_3*w39 + B_1_4*w31 - B_1_6*w45 + tmp20 + tmp21 + tmp22 + tmp24 + tmp25 + tmp26 + tmp27 + tmp28 + tmp33 + tmp39;
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=B_0_2*w47 + B_0_3*w38 + B_0_4*w30 + B_0_5*w46 + tmp200 + tmp201 + tmp202 + tmp203 + tmp204 + tmp205 + tmp206 + tmp207 + tmp56 + tmp57;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=B_0_2*w38 + B_0_3*w47 + B_0_4*w46 + B_0_5*w30 + B_1_1*w39 - B_1_3*w44 - B_1_4*w45 + B_1_6*w31 - B_2_0*w32 - B_2_3*w40 - B_2_4*w41 - B_2_7*w43 + tmp132 + tmp133 + tmp134 + tmp135 + tmp136 + tmp137;
                                        EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=tmp60 + tmp61 + tmp80 + tmp81 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=tmp186 + tmp187 + tmp218 + tmp219 + tmp220 + tmp221 + tmp254 + tmp255 + tmp256 + tmp257;
                                        EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=tmp104 + tmp107 + tmp109 + tmp110 + tmp111 + tmp113 + tmp160 + tmp161 + tmp162 + tmp163;
                                        EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+=-B_2_0*w41 - B_2_3*w43 - B_2_4*w32 - B_2_7*w40 + tmp0 + tmp1 + tmp4 + tmp5 + tmp6 + tmp7 + tmp8 + tmp9 + tmp92 + tmp93;
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=B_2_0*w40 + B_2_3*w32 + B_2_4*w43 + B_2_7*w41 + tmp114 + tmp115 + tmp116 + tmp117 + tmp118 + tmp119 + tmp120 + tmp121 + tmp2 + tmp3;
                                        EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=tmp190 + tmp191 + tmp192 + tmp193 + tmp194 + tmp195 + tmp196 + tmp197 + tmp198 + tmp199;
                                        EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=tmp229 + tmp230 + tmp232 + tmp234 + tmp235 + tmp236 + tmp238 + tmp239 + tmp240 + tmp241;
                                        EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=tmp258 + tmp259 + tmp62 + tmp63 + tmp64 + tmp65;
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=-B_0_2*w30 - B_0_3*w46 - B_0_4*w47 - B_0_5*w38 - B_1_1*w31 + B_1_3*w45 + B_1_4*w44 - B_1_6*w39 + B_2_0*w43 + B_2_3*w41 + B_2_4*w40 + B_2_7*w32 + tmp150 + tmp151 + tmp152 + tmp153 + tmp154 + tmp155;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=-B_0_2*w46 - B_0_3*w30 - B_0_4*w38 - B_0_5*w47 + tmp222 + tmp223 + tmp50 + tmp51 + tmp52 + tmp53 + tmp54 + tmp55 + tmp58 + tmp59;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=B_1_1*w45 - B_1_3*w31 - B_1_4*w39 + B_1_6*w44 + tmp23 + tmp29 + tmp30 + tmp31 + tmp32 + tmp34 + tmp35 + tmp36 + tmp37 + tmp38;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=tmp10 + tmp11 + tmp12 + tmp13 + tmp14 + tmp15 + tmp16 + tmp17 + tmp18 + tmp19;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=tmp191 + tmp192 + tmp193 + tmp194 + tmp198 + tmp199 + tmp214 + tmp215 + tmp216 + tmp217;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=B_2_1*w40 + B_2_2*w32 + B_2_5*w43 + B_2_6*w41 + tmp82 + tmp83 + tmp84 + tmp85 + tmp86 + tmp87 + tmp88 + tmp89 + tmp90 + tmp91;
                                        EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=tmp258 + tmp259 + tmp62 + tmp65 + tmp80 + tmp81;
                                        EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=tmp180 + tmp181 + tmp182 + tmp183 + tmp184 + tmp185 + tmp186 + tmp187 + tmp188 + tmp189;
                                        EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=B_0_2*w30 + B_0_3*w46 + B_0_4*w47 + B_0_5*w38 + tmp50 + tmp51 + tmp52 + tmp53 + tmp54 + tmp55 + tmp56 + tmp57 + tmp58 + tmp59;
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=B_0_2*w46 + B_0_3*w30 + B_0_4*w38 + B_0_5*w47 - B_1_0*w31 + B_1_2*w45 + B_1_5*w44 - B_1_7*w39 + B_2_1*w43 + B_2_2*w41 + B_2_5*w40 + B_2_6*w32 + tmp135 + tmp136 + tmp208 + tmp211 + tmp212 + tmp213;
                                        EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+=tmp11 + tmp12 + tmp13 + tmp14 + tmp15 + tmp19 + tmp66 + tmp67 + tmp68 + tmp69;
                                        EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+=B_1_0*w45 - B_1_2*w31 - B_1_5*w39 + B_1_7*w44 + tmp170 + tmp171 + tmp172 + tmp173 + tmp174 + tmp175 + tmp176 + tmp177 + tmp178 + tmp179;
                                        EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=tmp228 + tmp229 + tmp230 + tmp231 + tmp232 + tmp233 + tmp234 + tmp235 + tmp236 + tmp237;
                                        EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=tmp258 + tmp259 + tmp63 + tmp64 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=B_2_1*w32 + B_2_2*w40 + B_2_5*w41 + B_2_6*w43 + tmp70 + tmp71 + tmp74 + tmp75 + tmp76 + tmp77 + tmp78 + tmp79 + tmp84 + tmp85;
                                        EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=tmp105 + tmp106 + tmp107 + tmp108 + tmp112 + tmp113 + tmp156 + tmp157 + tmp158 + tmp159;
                                        EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=B_1_1*w31 - B_1_3*w45 - B_1_4*w44 + B_1_6*w39 + tmp30 + tmp31 + tmp32 + tmp33 + tmp34 + tmp35 + tmp36 + tmp37 + tmp38 + tmp39;
                                        EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=tmp10 + tmp12 + tmp13 + tmp16 + tmp17 + tmp18 + tmp250 + tmp251 + tmp252 + tmp253;
                                        EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=-B_0_0*w30 - B_0_1*w46 - B_0_6*w47 - B_0_7*w38 - B_1_1*w45 + B_1_3*w31 + B_1_4*w39 - B_1_6*w44 + B_2_1*w41 + B_2_2*w43 + B_2_5*w32 + B_2_6*w40 + tmp134 + tmp137 + tmp209 + tmp210 + tmp212 + tmp213;
                                        EM_S[INDEX4(k,m,6,7,numEq,numComp,8)]+=-B_0_0*w46 - B_0_1*w30 - B_0_6*w38 - B_0_7*w47 + tmp122 + tmp123 + tmp124 + tmp125 + tmp126 + tmp127 + tmp128 + tmp129 + tmp130 + tmp131;
                                        EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=tmp258 + tmp259 + tmp80 + tmp81 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+=tmp181 + tmp182 + tmp184 + tmp186 + tmp187 + tmp188 + tmp218 + tmp219 + tmp220 + tmp221;
                                        EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+=tmp104 + tmp105 + tmp106 + tmp107 + tmp108 + tmp109 + tmp110 + tmp111 + tmp112 + tmp113;
                                        EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+=B_2_0*w32 + B_2_3*w40 + B_2_4*w41 + B_2_7*w43 + tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6 + tmp7 + tmp8 + tmp9;
                                        EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+=tmp12 + tmp13 + tmp250 + tmp251 + tmp252 + tmp253 + tmp66 + tmp67 + tmp68 + tmp69;
                                        EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=B_1_0*w31 - B_1_2*w45 - B_1_5*w44 + B_1_7*w39 + tmp141 + tmp147 + tmp170 + tmp171 + tmp172 + tmp174 + tmp175 + tmp176 + tmp177 + tmp178;
                                        EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=B_0_0*w30 + B_0_1*w46 + B_0_6*w47 + B_0_7*w38 + tmp122 + tmp123 + tmp124 + tmp125 + tmp126 + tmp127 + tmp130 + tmp131 + tmp148 + tmp149;
                                        EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+=B_0_0*w46 + B_0_1*w30 + B_0_6*w38 + B_0_7*w47 - B_1_0*w45 + B_1_2*w31 + B_1_5*w39 - B_1_7*w44 + B_2_0*w41 + B_2_3*w43 + B_2_4*w32 + B_2_7*w40 + tmp150 + tmp151 + tmp166 + tmp167 + tmp168 + tmp169;
                                    }
                                }
                            } else { // constant data
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=4*B_0*w53 + B_1*w51 - B_2*w50;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=4*B_0*w53 - B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-B_0*w48 + B_1*w51 + B_2*w52;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=-B_0*w48 - B_1*w49 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=-B_0*w48 - B_1*w49 - B_2*w50;
                                        EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=-B_0*w48 + B_1*w51/4 + B_2*w52;
                                        EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=B_0*w53 - B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=B_0*w53 + B_1*w51/4 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=-4*B_0*w53 - B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=-4*B_0*w53 + B_1*w51 - B_2*w50;
                                        EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=B_0*w48 - B_1*w49 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=B_0*w48 + B_1*w51 + B_2*w52;
                                        EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=B_0*w48 + B_1*w51/4 + B_2*w52;
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=B_0*w48 - B_1*w49 - B_2*w50;
                                        EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=-B_0*w53 + B_1*w51/4 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+=-B_0*w53 - B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-B_0*w48 - B_1*w51 + B_2*w52;
                                        EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=-B_0*w48 + B_1*w49 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=4*B_0*w53 - B_1*w51 - B_2*w50;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=4*B_0*w53 + B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=B_0*w53 + B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=B_0*w53 - B_1*w51/4 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=-B_0*w48 + B_1*w49 - B_2*w50;
                                        EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=-B_0*w48 - B_1*w51/4 + B_2*w52;
                                        EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=B_0*w48 + B_1*w49 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=B_0*w48 - B_1*w51 + B_2*w52;
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=-4*B_0*w53 + B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=-4*B_0*w53 - B_1*w51 - B_2*w50;
                                        EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=-B_0*w53 - B_1*w51/4 + B_2*w52/2;
                                        EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=-B_0*w53 + B_1*w49 + B_2*w52;
                                        EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=B_0*w48 - B_1*w51/4 + B_2*w52;
                                        EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+=B_0*w48 + B_1*w49 - B_2*w50;
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=-B_0*w48 - B_1*w49 + B_2*w50;
                                        EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=-B_0*w48 + B_1*w51/4 - B_2*w52;
                                        EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=B_0*w53 - B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=B_0*w53 + B_1*w51/4 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=4*B_0*w53 + B_1*w51 + B_2*w50;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=4*B_0*w53 - B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=-B_0*w48 + B_1*w51 - B_2*w52;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=-B_0*w48 - B_1*w49 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=B_0*w48 + B_1*w51/4 - B_2*w52;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=B_0*w48 - B_1*w49 + B_2*w50;
                                        EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=-B_0*w53 + B_1*w51/4 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=-B_0*w53 - B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=2*B_0*w48 - B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=-4*B_0*w53 + B_1*w51 + B_2*w50;
                                        EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+=B_0*w48 - B_1*w49 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+=B_0*w48 + B_1*w51 - B_2*w52;
                                        EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=B_0*w53 + B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=B_0*w53 - B_1*w51/4 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=-B_0*w48 + B_1*w49 + B_2*w50;
                                        EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=-B_0*w48 - B_1*w51/4 - B_2*w52;
                                        EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=-B_0*w48 - B_1*w51 - B_2*w52;
                                        EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=-B_0*w48 + B_1*w49 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=4*B_0*w53 - B_1*w51 + B_2*w50;
                                        EM_S[INDEX4(k,m,6,7,numEq,numComp,8)]+=4*B_0*w53 + B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=-B_0*w53 - B_1*w51/4 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+=-B_0*w53 + B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+=B_0*w48 - B_1*w51/4 - B_2*w52;
                                        EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+=B_0*w48 + B_1*w49 + B_2*w50;
                                        EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+=B_0*w48 + B_1*w49 + B_2*w50/4;
                                        EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=B_0*w48 - B_1*w51 - B_2*w52;
                                        EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=-4*B_0*w53 + B_1*w49 - B_2*w52;
                                        EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+=-4*B_0*w53 - B_1*w51 + B_2*w50;
                                    }
                                }
                            }
                        }
                            ...
                            if (C.actsExpanded()) {
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        const double tmp262 = w32*(C_2_5 + C_2_7);
                                        const double tmp263 = w43*(C_2_0 + C_2_2);
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=-C_0_0*w47 - C_0_1*w38 - C_0_6*w30 - C_0_7*w46 + C_1_0*w44 - C_1_2*w39 - C_1_5*w31 + C_1_7*w45 - C_2_0*w40 - C_2_3*w32 - C_2_4*w43 - C_2_7*w41 + tmp132 + tmp133 + tmp208 + tmp209 + tmp210 + tmp211;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=C_0_0*w47 + C_0_1*w38 + C_0_6*w30 + C_0_7*w46 + tmp128 + tmp129 + tmp242 + tmp243 + tmp244 + tmp245 + tmp246 + tmp247 + tmp248 + tmp249;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-C_1_0*w44 + C_1_2*w39 + C_1_5*w31 - C_1_7*w45 + tmp138 + tmp139 + tmp140 + tmp142 + tmp143 + tmp144 + tmp145 + tmp146 + tmp173 + tmp179;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=tmp100 + tmp101 + tmp102 + tmp103 + tmp42 + tmp43 + tmp96 + tmp97 + tmp98 + tmp99;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=C_2_0*w40 + C_2_3*w32 + C_2_4*w43 + C_2_7*w41 + tmp114 + tmp115 + tmp116 + tmp117 + tmp118 + tmp119 + tmp120 + tmp121 + tmp92 + tmp93;
                                        EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=tmp190 + tmp193 + tmp195 + tmp196 + tmp197 + tmp199 + tmp224 + tmp225 + tmp226 + tmp227;
                                        EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=tmp234 + tmp235 + tmp238 + tmp239 + tmp240 + tmp241 + tmp260 + tmp261 + tmp262 + tmp263;
                                        EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=tmp60 + tmp61 + tmp62 + tmp63 + tmp64 + tmp65;
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=-C_0_0*w38 - C_0_1*w47 - C_0_6*w46 - C_0_7*w30 + tmp148 + tmp149 + tmp242 + tmp243 + tmp244 + tmp245 + tmp246 + tmp247 + tmp248 + tmp249;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=C_0_0*w38 + C_0_1*w47 + C_0_6*w46 + C_0_7*w30 + C_1_1*w44 - C_1_3*w39 - C_1_4*w31 + C_1_6*w45 - C_2_1*w40 - C_2_2*w32 - C_2_5*w43 - C_2_6*w41 + tmp152 + tmp155 + tmp164 + tmp165 + tmp168 + tmp169;
                                        EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=tmp103 + tmp40 + tmp42 + tmp43 + tmp46 + tmp47 + tmp48 + tmp97 + tmp98 + tmp99;
                                        EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=-C_1_1*w44 + C_1_3*w39 + C_1_4*w31 - C_1_6*w45 + tmp20 + tmp21 + tmp22 + tmp23 + tmp24 + tmp25 + tmp26 + tmp27 + tmp28 + tmp29;
                                        EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=tmp193 + tmp199 + tmp214 + tmp215 + tmp216 + tmp217 + tmp224 + tmp225 + tmp226 + tmp227;
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=C_2_1*w40 + C_2_2*w32 + C_2_5*w43 + C_2_6*w41 + tmp72 + tmp73 + tmp82 + tmp83 + tmp86 + tmp87 + tmp88 + tmp89 + tmp90 + tmp91;
                                        EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=tmp60 + tmp61 + tmp62 + tmp65 + tmp80 + tmp81;
                                        EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+=tmp180 + tmp183 + tmp185 + tmp186 + tmp187 + tmp189 + tmp254 + tmp255 + tmp256 + tmp257;
                                        EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-C_1_0*w39 + C_1_2*w44 + C_1_5*w45 - C_1_7*w31 + tmp138 + tmp139 + tmp140 + tmp141 + tmp142 + tmp143 + tmp144 + tmp145 + tmp146 + tmp147;
                                        EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=tmp100 + tmp101 + tmp102 + tmp41 + tmp42 + tmp43 + tmp44 + tmp45 + tmp49 + tmp96;
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=-C_0_2*w47 - C_0_3*w38 - C_0_4*w30 - C_0_5*w46 + C_1_0*w39 - C_1_2*w44 - C_1_5*w45 + C_1_7*w31 - C_2_1*w32 - C_2_2*w40 - C_2_5*w41 - C_2_6*w43 + tmp153 + tmp154 + tmp164 + tmp165 + tmp166 + tmp167;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=C_0_2*w47 + C_0_3*w38 + C_0_4*w30 + C_0_5*w46 + tmp200 + tmp201 + tmp202 + tmp203 + tmp204 + tmp205 + tmp206 + tmp207 + tmp222 + tmp223;
                                        EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=tmp228 + tmp231 + tmp233 + tmp234 + tmp235 + tmp237 + tmp260 + tmp261 + tmp262 + tmp263;
                                        EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=tmp60 + tmp61 + tmp63 + tmp64 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=C_2_1*w32 + C_2_2*w40 + C_2_5*w41 + C_2_6*w43 + tmp70 + tmp71 + tmp72 + tmp73 + tmp74 + tmp75 + tmp76 + tmp77 + tmp78 + tmp79;
                                        EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=tmp107 + tmp113 + tmp156 + tmp157 + tmp158 + tmp159 + tmp160 + tmp161 + tmp162 + tmp163;
                                        EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=tmp40 + tmp41 + tmp42 + tmp43 + tmp44 + tmp45 + tmp46 + tmp47 + tmp48 + tmp49;
                                        EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=-C_1_1*w39 + C_1_3*w44 + C_1_4*w45 - C_1_6*w31 + tmp20 + tmp21 + tmp22 + tmp24 + tmp25 + tmp26 + tmp27 + tmp28 + tmp33 + tmp39;
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=-C_0_2*w38 - C_0_3*w47 - C_0_4*w46 - C_0_5*w30 + tmp200 + tmp201 + tmp202 + tmp203 + tmp204 + tmp205 + tmp206 + tmp207 + tmp56 + tmp57;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=C_0_2*w38 + C_0_3*w47 + C_0_4*w46 + C_0_5*w30 + C_1_1*w39 - C_1_3*w44 - C_1_4*w45 + C_1_6*w31 - C_2_0*w32 - C_2_3*w40 - C_2_4*w41 - C_2_7*w43 + tmp132 + tmp133 + tmp134 + tmp135 + tmp136 + tmp137;
                                        EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=tmp60 + tmp61 + tmp80 + tmp81 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=tmp186 + tmp187 + tmp218 + tmp219 + tmp220 + tmp221 + tmp254 + tmp255 + tmp256 + tmp257;
                                        EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=tmp104 + tmp107 + tmp109 + tmp110 + tmp111 + tmp113 + tmp160 + tmp161 + tmp162 + tmp163;
                                        EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+=C_2_0*w32 + C_2_3*w40 + C_2_4*w41 + C_2_7*w43 + tmp0 + tmp1 + tmp4 + tmp5 + tmp6 + tmp7 + tmp8 + tmp9 + tmp92 + tmp93;
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=-C_2_0*w43 - C_2_3*w41 - C_2_4*w40 - C_2_7*w32 + tmp114 + tmp115 + tmp116 + tmp117 + tmp118 + tmp119 + tmp120 + tmp121 + tmp2 + tmp3;
                                        EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=tmp190 + tmp191 + tmp192 + tmp193 + tmp194 + tmp195 + tmp196 + tmp197 + tmp198 + tmp199;
                                        EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=tmp229 + tmp230 + tmp232 + tmp234 + tmp235 + tmp236 + tmp238 + tmp239 + tmp240 + tmp241;
                                        EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=tmp258 + tmp259 + tmp62 + tmp63 + tmp64 + tmp65;
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=-C_0_2*w30 - C_0_3*w46 - C_0_4*w47 - C_0_5*w38 - C_1_1*w31 + C_1_3*w45 + C_1_4*w44 - C_1_6*w39 + C_2_0*w43 + C_2_3*w41 + C_2_4*w40 + C_2_7*w32 + tmp150 + tmp151 + tmp152 + tmp153 + tmp154 + tmp155;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=C_0_2*w30 + C_0_3*w46 + C_0_4*w47 + C_0_5*w38 + tmp222 + tmp223 + tmp50 + tmp51 + tmp52 + tmp53 + tmp54 + tmp55 + tmp58 + tmp59;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=C_1_1*w31 - C_1_3*w45 - C_1_4*w44 + C_1_6*w39 + tmp23 + tmp29 + tmp30 + tmp31 + tmp32 + tmp34 + tmp35 + tmp36 + tmp37 + tmp38;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=tmp10 + tmp11 + tmp12 + tmp13 + tmp14 + tmp15 + tmp16 + tmp17 + tmp18 + tmp19;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=tmp191 + tmp192 + tmp193 + tmp194 + tmp198 + tmp199 + tmp214 + tmp215 + tmp216 + tmp217;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=-C_2_1*w43 - C_2_2*w41 - C_2_5*w40 - C_2_6*w32 + tmp82 + tmp83 + tmp84 + tmp85 + tmp86 + tmp87 + tmp88 + tmp89 + tmp90 + tmp91;
                                        EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=tmp258 + tmp259 + tmp62 + tmp65 + tmp80 + tmp81;
                                        EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=tmp180 + tmp181 + tmp182 + tmp183 + tmp184 + tmp185 + tmp186 + tmp187 + tmp188 + tmp189;
                                        EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=-C_0_2*w46 - C_0_3*w30 - C_0_4*w38 - C_0_5*w47 + tmp50 + tmp51 + tmp52 + tmp53 + tmp54 + tmp55 + tmp56 + tmp57 + tmp58 + tmp59;
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=C_0_2*w46 + C_0_3*w30 + C_0_4*w38 + C_0_5*w47 - C_1_0*w31 + C_1_2*w45 + C_1_5*w44 - C_1_7*w39 + C_2_1*w43 + C_2_2*w41 + C_2_5*w40 + C_2_6*w32 + tmp135 + tmp136 + tmp208 + tmp211 + tmp212 + tmp213;
                                        EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+=tmp11 + tmp12 + tmp13 + tmp14 + tmp15 + tmp19 + tmp66 + tmp67 + tmp68 + tmp69;
                                        EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+=C_1_0*w31 - C_1_2*w45 - C_1_5*w44 + C_1_7*w39 + tmp170 + tmp171 + tmp172 + tmp173 + tmp174 + tmp175 + tmp176 + tmp177 + tmp178 + tmp179;
                                        EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=tmp228 + tmp229 + tmp230 + tmp231 + tmp232 + tmp233 + tmp234 + tmp235 + tmp236 + tmp237;
                                        EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=tmp258 + tmp259 + tmp63 + tmp64 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=-C_2_1*w41 - C_2_2*w43 - C_2_5*w32 - C_2_6*w40 + tmp70 + tmp71 + tmp74 + tmp75 + tmp76 + tmp77 + tmp78 + tmp79 + tmp84 + tmp85;
                                        EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=tmp105 + tmp106 + tmp107 + tmp108 + tmp112 + tmp113 + tmp156 + tmp157 + tmp158 + tmp159;
                                        EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=C_1_1*w45 - C_1_3*w31 - C_1_4*w39 + C_1_6*w44 + tmp30 + tmp31 + tmp32 + tmp33 + tmp34 + tmp35 + tmp36 + tmp37 + tmp38 + tmp39;
                                        EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=tmp10 + tmp12 + tmp13 + tmp16 + tmp17 + tmp18 + tmp250 + tmp251 + tmp252 + tmp253;
                                        EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=-C_0_0*w30 - C_0_1*w46 - C_0_6*w47 - C_0_7*w38 - C_1_1*w45 + C_1_3*w31 + C_1_4*w39 - C_1_6*w44 + C_2_1*w41 + C_2_2*w43 + C_2_5*w32 + C_2_6*w40 + tmp134 + tmp137 + tmp209 + tmp210 + tmp212 + tmp213;
                                        EM_S[INDEX4(k,m,6,7,numEq,numComp,8)]+=C_0_0*w30 + C_0_1*w46 + C_0_6*w47 + C_0_7*w38 + tmp122 + tmp123 + tmp124 + tmp125 + tmp126 + tmp127 + tmp128 + tmp129 + tmp130 + tmp131;
                                        EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=tmp258 + tmp259 + tmp80 + tmp81 + tmp94 + tmp95;
                                        EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+=tmp181 + tmp182 + tmp184 + tmp186 + tmp187 + tmp188 + tmp218 + tmp219 + tmp220 + tmp221;
                                        EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+=tmp104 + tmp105 + tmp106 + tmp107 + tmp108 + tmp109 + tmp110 + tmp111 + tmp112 + tmp113;
                                        EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+=-C_2_0*w41 - C_2_3*w43 - C_2_4*w32 - C_2_7*w40 + tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6 + tmp7 + tmp8 + tmp9;
                                        EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+=tmp12 + tmp13 + tmp250 + tmp251 + tmp252 + tmp253 + tmp66 + tmp67 + tmp68 + tmp69;
                                        EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=C_1_0*w45 - C_1_2*w31 - C_1_5*w39 + C_1_7*w44 + tmp141 + tmp147 + tmp170 + tmp171 + tmp172 + tmp174 + tmp175 + tmp176 + tmp177 + tmp178;
                                        EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=-C_0_0*w46 - C_0_1*w30 - C_0_6*w38 - C_0_7*w47 + tmp122 + tmp123 + tmp124 + tmp125 + tmp126 + tmp127 + tmp130 + tmp131 + tmp148 + tmp149;
                                        EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+=C_0_0*w46 + C_0_1*w30 + C_0_6*w38 + C_0_7*w47 - C_1_0*w45 + C_1_2*w31 + C_1_5*w39 - C_1_7*w44 + C_2_0*w41 + C_2_3*w43 + C_2_4*w32 + C_2_7*w40 + tmp150 + tmp151 + tmp166 + tmp167 + tmp168 + tmp169;
                                    }
                                }
                            } else { // constant data
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=4*C_0*w53 + C_1*w51 - C_2*w50;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=-4*C_0*w53 - C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-C_0*w48 - C_1*w51 + C_2*w52;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=C_0*w48 + C_1*w49 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=-C_0*w48 - C_1*w49 + C_2*w50;
                                        EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=C_0*w48 + C_1*w51/4 - C_2*w52;
                                        EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=C_0*w53 + C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=-C_0*w53 - C_1*w51/4 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=4*C_0*w53 - C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=-4*C_0*w53 + C_1*w51 - C_2*w50;
                                        EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=-C_0*w48 + C_1*w49 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=C_0*w48 - C_1*w51 + C_2*w52;
                                        EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=-C_0*w48 + C_1*w51/4 - C_2*w52;
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=C_0*w48 - C_1*w49 + C_2*w50;
                                        EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=C_0*w53 - C_1*w51/4 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+=-C_0*w53 + C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-C_0*w48 + C_1*w51 + C_2*w52;
                                        EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=C_0*w48 - C_1*w49 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=4*C_0*w53 - C_1*w51 - C_2*w50;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=-4*C_0*w53 + C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=C_0*w53 - C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=-C_0*w53 + C_1*w51/4 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=-C_0*w48 + C_1*w49 + C_2*w50;
                                        EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=C_0*w48 - C_1*w51/4 - C_2*w52;
                                        EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=-C_0*w48 - C_1*w49 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=C_0*w48 + C_1*w51 + C_2*w52;
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=4*C_0*w53 + C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=-4*C_0*w53 - C_1*w51 - C_2*w50;
                                        EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=C_0*w53 + C_1*w51/4 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=-C_0*w53 - C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=-C_0*w48 - C_1*w51/4 - C_2*w52;
                                        EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+=C_0*w48 + C_1*w49 + C_2*w50;
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=-C_0*w48 - C_1*w49 - C_2*w50;
                                        EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=C_0*w48 + C_1*w51/4 + C_2*w52;
                                        EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=C_0*w53 + C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=-C_0*w53 - C_1*w51/4 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=4*C_0*w53 + C_1*w51 + C_2*w50;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=-4*C_0*w53 - C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=-C_0*w48 - C_1*w51 - C_2*w52;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=C_0*w48 + C_1*w49 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=-C_0*w48 + C_1*w51/4 + C_2*w52;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=C_0*w48 - C_1*w49 - C_2*w50;
                                        EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=C_0*w53 - C_1*w51/4 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=-C_0*w53 + C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=4*C_0*w53 - C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=-4*C_0*w53 + C_1*w51 + C_2*w50;
                                        EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+=-C_0*w48 + C_1*w49 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+=C_0*w48 - C_1*w51 - C_2*w52;
                                        EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=C_0*w53 - C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=-C_0*w53 + C_1*w51/4 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=-C_0*w48 + C_1*w49 - C_2*w50;
                                        EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=C_0*w48 - C_1*w51/4 + C_2*w52;
                                        EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=-C_0*w48 + C_1*w51 - C_2*w52;
                                        EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=C_0*w48 - C_1*w49 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=4*C_0*w53 - C_1*w51 + C_2*w50;
                                        EM_S[INDEX4(k,m,6,7,numEq,numComp,8)]+=-4*C_0*w53 + C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=C_0*w53 + C_1*w51/4 + C_2*w52/2;
                                        EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+=-C_0*w53 - C_1*w49 + C_2*w52;
                                        EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+=-C_0*w48 - C_1*w51/4 + C_2*w52;
                                        EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+=C_0*w48 + C_1*w49 - C_2*w50;
                                        EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+=-C_0*w48 - C_1*w49 + C_2*w50/4;
                                        EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=C_0*w48 + C_1*w51 - C_2*w52;
                                        EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=4*C_0*w53 + C_1*w49 - C_2*w52;
                                        EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+=-4*C_0*w53 - C_1*w51 + C_2*w50;
                                    }
                                }
                            }
                        }
                            ...
                            if (D.actsExpanded()) {
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        const double tmp57 = w54*(D_6 + D_7);
                                        const double tmp58 = w56*(D_0 + D_1);
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=D_0*w59 + D_7*w60 + tmp49 + tmp50;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=tmp26 + tmp57 + tmp58;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=tmp30 + tmp31 + tmp32;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=tmp10 + tmp11;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=tmp1 + tmp23 + tmp24;
                                        ...
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=tmp26 + tmp57 + tmp58;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=D_1*w59 + D_6*w60 + tmp45 + tmp46;
                                        ...
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=tmp17 + tmp19 + tmp20;
                                        ...
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=D_2*w59 + D_5*w60 + tmp35 + tmp36;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=tmp13 + tmp47 + tmp48;
                                        ...
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=tmp13 + tmp47 + tmp48;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=D_3*w59 + D_4*w60 + tmp28 + tmp29;
                                        ...
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=tmp1 + tmp23 + tmp24;
                                        ...
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=D_3*w60 + D_4*w59 + tmp33 + tmp34;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=tmp12 + tmp13 + tmp14;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=tmp6 + tmp8 + tmp9;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=tmp3 + tmp4;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=tmp43 + tmp44;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=tmp17 + tmp19 + tmp20;
                                        ...
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=D_2*w60 + D_5*w59 + tmp53 + tmp54;
                                        EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+=tmp3 + tmp4;
                                        EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+=tmp31 + tmp39 + tmp40;
                                        ...
                                        EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=tmp6 + tmp8 + tmp9;
                                        EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=tmp3 + tmp4;
                                        EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=D_1*w60 + D_6*w59 + tmp51 + tmp52;
                                        ...
                                        EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=tmp31 + tmp39 + tmp40;
                                        EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=tmp25 + tmp26 + tmp27;
                                        EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+=D_0*w60 + D_7*w59 + tmp37 + tmp38;
                                    }
                                 }
                            } else { // constant data
                                for (index_t k=0; k<numEq; k++) {
                                    for (index_t m=0; m<numComp; m++) {
                                        ...
                                        EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=64*D_0*w55;
                                        EM_S[INDEX4(k,m,6,7,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=8*D_0*w55;
                                        EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+=16*D_0*w55;
                                        EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=32*D_0*w55;
                                        EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+=64*D_0*w55;
                                    }
                                }
                            }
                        }
                        ...
                        if (!X.isEmpty()) {
                            ...
                            if (X.actsExpanded()) {
                                for (index_t k=0; k<numEq; k++) {
                                    ...
                                    EM_F[INDEX2(k,2,numEq)]+=tmp13 + tmp18 + tmp19 + tmp20 + tmp21 + tmp22 + tmp23 + tmp24 + tmp25;
                                    EM_F[INDEX2(k,3,numEq)]+=tmp26 + tmp27 + tmp28 + tmp29 + tmp30 + tmp31 + tmp32 + tmp33 + tmp4;
                                    EM_F[INDEX2(k,4,numEq)]+=tmp10 + tmp18 + tmp34 + tmp35 + tmp36 + tmp37 + tmp38 + tmp39 + tmp40;
                                    EM_F[INDEX2(k,5,numEq)]+=tmp1 + tmp26 + tmp41 + tmp42 + tmp43 + tmp44 + tmp45 + tmp46 + tmp47;
                                    EM_F[INDEX2(k,6,numEq)]+=tmp0 + tmp27 + tmp43 + tmp48 + tmp49 + tmp50 + tmp51 + tmp52 + tmp53;
                                    EM_F[INDEX2(k,7,numEq)]+=tmp19 + tmp36 + tmp54 + tmp55 + tmp56 + tmp57 + tmp58 + tmp59 + tmp9;
                                }
                            } else { // constant data
                                for (index_t k=0; k<numEq; k++) {
                                    ...
                                    EM_F[INDEX2(k,0,numEq)]+=18*X_0*w53 + 12*X_1*w64 + 12*X_2*w65;
                                    EM_F[INDEX2(k,1,numEq)]+=-18*X_0*w53 + 12*X_1*w64 + 12*X_2*w65;
                                    EM_F[INDEX2(k,2,numEq)]+=18*X_0*w53 - 12*X_1*w64 + 12*X_2*w65;
                                    EM_F[INDEX2(k,3,numEq)]+=-18*X_0*w53 - 12*X_1*w64 + 12*X_2*w65;
                                    EM_F[INDEX2(k,4,numEq)]+=18*X_0*w53 + 12*X_1*w64 - 12*X_2*w65;
                                    EM_F[INDEX2(k,5,numEq)]+=-18*X_0*w53 + 12*X_1*w64 - 12*X_2*w65;
                                    EM_F[INDEX2(k,6,numEq)]+=18*X_0*w53 - 12*X_1*w64 - 12*X_2*w65;
                                    EM_F[INDEX2(k,7,numEq)]+=-18*X_0*w53 - 12*X_1*w64 - 12*X_2*w65;
                                }
                            }
                        }
                        ///////////////
                        ...
                        if (!Y.isEmpty()) {
                            ...
                            if (Y.actsExpanded()) {
                                for (index_t k=0; k<numEq; k++) {
                                    ...
                                    const double tmp14 = w72*(Y_1 + Y_2 + Y_4);
                                    const double tmp15 = w71*(Y_3 + Y_5 + Y_6);
                                    EM_F[INDEX2(k,0,numEq)]+=Y_0*w70 + Y_7*w73 + tmp0 + tmp1;
                                    EM_F[INDEX2(k,1,numEq)]+=Y_1*w70 + Y_6*w73 + tmp2 + tmp3;
                                    EM_F[INDEX2(k,2,numEq)]+=Y_2*w70 + Y_5*w73 + tmp4 + tmp5;
                                    EM_F[INDEX2(k,3,numEq)]+=Y_3*w70 + Y_4*w73 + tmp6 + tmp7;
                                    EM_F[INDEX2(k,4,numEq)]+=Y_3*w73 + Y_4*w70 + tmp8 + tmp9;
                                    EM_F[INDEX2(k,5,numEq)]+=Y_2*w73 + Y_5*w70 + tmp10 + tmp11;
                                    EM_F[INDEX2(k,6,numEq)]+=Y_1*w73 + Y_6*w70 + tmp12 + tmp13;
                                    EM_F[INDEX2(k,7,numEq)]+=Y_0*w73 + Y_7*w70 + tmp14 + tmp15;
                                }
                            } else { // constant data
                                for (index_t k=0; k<numEq; k++) {
                                    const double Y_0 = Y_p[k];
                                    EM_F[INDEX2(k,0,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,1,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,2,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,3,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,4,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,5,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,6,numEq)]+=216*Y_0*w55;
                                    EM_F[INDEX2(k,7,numEq)]+=216*Y_0*w55;
                                }
                            }
                        }
        ...
        const escript::Data& X, const escript::Data& Y) const
{
    ...
    const double w0 = .0625*m_dx[0];
    const double w1 = .0625*m_dx[1];
    const double w2 = .0625*m_dx[2];
    const double w3 = .03125*m_dx[0]*m_dx[1];
    const double w4 = .03125*m_dx[0]*m_dx[2];
    const double w5 = .03125*m_dx[1]*m_dx[2];
    const double w6 = .0625*m_dx[0]*m_dx[1]/m_dx[2];
    const double w7 = .0625*m_dx[0]*m_dx[2]/m_dx[1];
    const double w8 = .0625*m_dx[1]*m_dx[2]/m_dx[0];
    const double w9 = .015625*m_dx[0]*m_dx[1]*m_dx[2];
                ...
                for (index_t k1=0; k1<m_NE[1]; ++k1) {
                    for (index_t k0=0; k0<m_NE[0]; ++k0)  {
                        ...
                        if (!A.isEmpty()) {
                            ...
                            for (index_t k=0; k<numEq; k++) {
                                for (index_t m=0; m<numComp; m++) {
                                    ...
                                    const double A_21 = A_p[INDEX4(k,2,m,1,numEq,3,numComp)];
                                    const double A_22 = A_p[INDEX4(k,2,m,2,numEq,3,numComp)];
                                    const double tmp0 = (A_01 + A_10)*w2;
                                    const double tmp1 = (A_02 + A_20)*w1;
                                    const double tmp2 = (A_12 + A_21)*w0;
                                    const double tmp3 = A_00*w8;
                                    const double tmp4 = A_01*w2;
                                    const double tmp5 = A_02*w1;
                                    const double tmp6 = A_10*w2;
                                    const double tmp7 = A_11*w7;
                                    const double tmp8 = A_12*w0;
                                    const double tmp9 = A_20*w1;
                                    const double tmp10 = A_21*w0;
                                    const double tmp11 = A_22*w6;
                                    EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=tmp0 + tmp1 + tmp2 + tmp3 + tmp7 + tmp11;
                                    EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=tmp2 - tmp3 - tmp4 - tmp5 + tmp6 + tmp7 + tmp9 + tmp11;
                                    EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=tmp1 + tmp3 + tmp4 - tmp6 - tmp7 - tmp8 + tmp10 + tmp11;
                                    EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=-tmp0 - tmp7 - tmp8 + tmp10 - tmp5 + tmp9 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=tmp0 + tmp3 + tmp5 + tmp7 + tmp8 - tmp9 - tmp10 - tmp11;
                                    EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+=-tmp10 + tmp8 - tmp1 + tmp6 - tmp4 - tmp11 + tmp7 - tmp3;
                                    EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=-tmp7 + tmp4 - tmp6 - tmp2 - tmp9 + tmp5 + tmp3 - tmp11;
                                    EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp7 - tmp2 - tmp11 - tmp3;
                                    EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=tmp4 - tmp6 - tmp9 + tmp5 + tmp2 + tmp7 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2 + tmp3 + tmp7 + tmp11;
                                    EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=tmp0 - tmp7 - tmp9 - tmp8 + tmp5 + tmp10 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+=-tmp7 - tmp1 + tmp6 - tmp8 - tmp4 + tmp3 + tmp10 + tmp11;
                                    EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=tmp4 - tmp10 + tmp8 - tmp6 + tmp1 - tmp11 + tmp7 - tmp3;
                                    EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+=-tmp0 - tmp10 + tmp8 + tmp3 - tmp11 + tmp7 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=tmp0 - tmp7 - tmp2 + tmp1 - tmp11 - tmp3;
                                    EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+=-tmp7 + tmp6 - tmp2 - tmp4 + tmp3 - tmp11 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-tmp7 - tmp10 + tmp8 + tmp6 - tmp4 + tmp1 + tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+=tmp0 - tmp7 - tmp10 + tmp8 - tmp5 + tmp9 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2 + tmp3 + tmp7 + tmp11;
                                    EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+=tmp4 - tmp6 - tmp2 + tmp7 - tmp5 + tmp9 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=-tmp7 + tmp6 - tmp9 - tmp4 + tmp5 + tmp2 + tmp3 - tmp11;
                                    EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=tmp0 - tmp1 + tmp2 - tmp3 - tmp7 - tmp11;
                                    EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=-tmp0 + tmp3 + tmp5 + tmp7 - tmp8 - tmp9 + tmp10 - tmp11;
                                    EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+=-tmp1 - tmp3 + tmp4 - tmp6 + tmp7 - tmp8 + tmp10 - tmp11;
                                    EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=-tmp0 - tmp7 + tmp8 - tmp9 + tmp5 - tmp3 - tmp10 + tmp11;
                                    EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+=-tmp1 + tmp3 + tmp4 - tmp6 - tmp7 + tmp8 - tmp10 + tmp11;
                                    EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=tmp6 - tmp2 - tmp3 - tmp4 + tmp5 + tmp7 - tmp9 + tmp11;
                                    EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+=tmp0 - tmp1 - tmp2 + tmp3 + tmp7 + tmp11;
                                    EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2 - tmp3 - tmp7 - tmp11;
                                    EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+=-tmp7 + tmp4 - tmp6 + tmp2 + tmp3 - tmp11 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=tmp1 - tmp3 - tmp4 + tmp6 + tmp7 - tmp8 + tmp10 - tmp11;
                                    EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+=tmp0 - tmp8 + tmp3 - tmp11 + tmp7 + tmp10 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=tmp0 - tmp8 + tmp3 - tmp11 + tmp7 + tmp10 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+=tmp6 - tmp8 - tmp4 + tmp1 - tmp11 + tmp7 + tmp10 - tmp3;
                                    EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=-tmp7 + tmp4 - tmp6 + tmp2 + tmp3 - tmp11 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=-tmp0 - tmp7 + tmp1 + tmp2 - tmp11 - tmp3;
                                    EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=tmp0 - tmp1 - tmp2 + tmp3 + tmp7 + tmp11;
                                    EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+=tmp6 - tmp2 - tmp9 - tmp4 + tmp5 + tmp7 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=-tmp7 + tmp4 - tmp10 + tmp8 - tmp1 - tmp6 + tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+=-tmp0 - tmp7 - tmp10 + tmp8 - tmp9 + tmp5 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=tmp4 - tmp1 - tmp6 - tmp8 - tmp11 + tmp7 + tmp10 - tmp3;
                                    EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+=-tmp0 - tmp9 - tmp8 + tmp5 + tmp3 - tmp11 + tmp7 + tmp10;
                                    EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=tmp0 - tmp7 - tmp1 + tmp2 - tmp11 - tmp3;
                                    EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+=-tmp7 + tmp6 - tmp9 - tmp4 + tmp5 + tmp2 + tmp3 - tmp11;
                                    EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=tmp4 - tmp6 - tmp2 + tmp7 - tmp5 + tmp9 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+=-tmp0 - tmp2 + tmp1 + tmp3 + tmp7 + tmp11;
                                    EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=tmp0 - tmp7 - tmp10 + tmp8 - tmp5 + tmp9 - tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+=-tmp7 - tmp10 + tmp8 + tmp6 - tmp4 + tmp1 + tmp3 + tmp11;
                                    EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=-tmp7 + tmp6 - tmp2 - tmp4 + tmp3 - tmp11 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=tmp0 - tmp7 - tmp2 + tmp1 - tmp11 - tmp3;
                                    EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=-tmp0 - tmp10 + tmp8 + tmp3 - tmp11 + tmp7 - tmp5 + tmp9;
                                    EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+=tmp4 - tmp10 + tmp8 - tmp6 + tmp1 - tmp11 + tmp7 - tmp3;
                        ...
                        if (!B.isEmpty()) {
                            ...
                            for (index_t k=0; k<numEq; k++) {
                                for (index_t m=0; m<numComp; m++) {
                                    const double tmp0 = B_p[INDEX3(k,0,m, numEq, 3)]*w5;
                                    const double tmp1 = B_p[INDEX3(k,1,m, numEq, 3)]*w4;
                                    const double tmp2 = B_p[INDEX3(k,2,m, numEq, 3)]*w3;
                                    EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,0,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,0,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,0,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,1,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,1,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,1,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,1,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,1,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,1,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,1,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,2,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,2,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,2,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,2,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,2,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,2,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,2,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,3,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,3,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,3,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,3,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,3,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,3,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,3,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,4,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,4,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,4,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,4,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,4,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,4,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,4,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,5,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,5,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,5,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,5,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,5,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,5,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,5,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,6,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,6,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,6,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,6,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,6,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=-tmp1 - tmp0 - tmp2;
                                    EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+= tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+=-tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+= tmp0 + tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+=-tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,5,7,numEq,numComp,8)]+= tmp0 - tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,6,7,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,7,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                }
                            }
                        }
                        ///////////////
                        ...
                        if (!C.isEmpty()) {
                            ...
                            for (index_t k=0; k<numEq; k++) {
                                for (index_t m=0; m<numComp; m++) {
                                    const double tmp0 = C_p[INDEX3(k, m, 0, numEq, numComp)]*w5;
                                    const double tmp1 = C_p[INDEX3(k, m, 1, numEq, numComp)]*w4;
                                    const double tmp2 = C_p[INDEX3(k, m, 2, numEq, numComp)]*w3;
                                    EM_S[INDEX4(k,m,0,0,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,1,0,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,2,0,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    EM_S[INDEX4(k,m,3,0,numEq,numComp,8)]+=-tmp0 - tmp1 - tmp2;
                                    ...
                                    EM_S[INDEX4(k,m,6,6,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,7,6,numEq,numComp,8)]+=-tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,1,7,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,2,7,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,3,7,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                                    EM_S[INDEX4(k,m,4,7,numEq,numComp,8)]+= tmp0 + tmp1 + tmp2;
                        ...
                        if (!D.isEmpty()) {
                            ...
                            for (index_t k=0; k<numEq; k++) {
                                for (index_t m=0; m<numComp; m++) {
                                    const double tmp0 = D_p[INDEX2(k, m, numEq)]*w9;
                                    ...
                                    EM_S[INDEX4(k,m,7,0,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,6,1,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,5,2,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,4,3,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,3,4,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,2,5,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,1,6,numEq,numComp,8)]+=tmp0;
                                    ...
                                    EM_S[INDEX4(k,m,0,7,numEq,numComp,8)]+=tmp0;
                        ...
                        if (!X.isEmpty()) {
                            ...
                            const double* X_p=const_cast<escript::Data*>(&X)->getSampleDataRO(e);
                            for (index_t k=0; k<numEq; k++) {
                                const double tmp0 = 8*X_p[INDEX2(k, 0, numEq)]*w5;
                                const double tmp1 = 8*X_p[INDEX2(k, 1, numEq)]*w4;
                                const double tmp2 = 8*X_p[INDEX2(k, 2, numEq)]*w3;
                                EM_F[INDEX2(k,0,numEq)]+=-tmp0 - tmp1 - tmp2;
                                EM_F[INDEX2(k,1,numEq)]+= tmp0 - tmp1 - tmp2;
                                EM_F[INDEX2(k,2,numEq)]+=-tmp0 + tmp1 - tmp2;
                                EM_F[INDEX2(k,3,numEq)]+= tmp0 + tmp1 - tmp2;
                                EM_F[INDEX2(k,4,numEq)]+=-tmp0 - tmp1 + tmp2;
                                EM_F[INDEX2(k,5,numEq)]+= tmp0 - tmp1 + tmp2;
                                EM_F[INDEX2(k,6,numEq)]+=-tmp0 + tmp1 + tmp2;
                                EM_F[INDEX2(k,7,numEq)]+= tmp0 + tmp1 + tmp2;
                            }
                        }
                        ///////////////
                        // process Y //
...
void Brick::assemblePDEBoundarySingleReduced(Paso_SystemMatrix* mat,
      escript::Data& rhs, const escript::Data& d, const escript::Data& y) const
{
    const double w0 = 0.0625*m_dx[0]*m_dx[1];
    const double w1 = 0.0625*m_dx[0]*m_dx[2];
    const double w2 = 0.0625*m_dx[1]*m_dx[2];
    const bool add_EM_S=!d.isEmpty();
    const bool add_EM_F=!y.isEmpty();
    rhs.requireWrite();
#pragma omp parallel
