                    ...
                    if (!mu.isEmpty() || !lambda.isEmpty()) {
                        ...
                        if (mu.actsExpanded() || lambda.actsExpanded()) {
                            ...
                            if (!mu.isEmpty()) {
                                ...
                                A_0000[0] += 2*mu_p[INDEX5(0,0,0,0,0,numEq,2,numComp,2)];
                                A_0000[1] += 2*mu_p[INDEX5(0,0,0,0,1,numEq,2,numComp,2)];
                                A_0000[2] += 2*mu_p[INDEX5(0,0,0,0,2,numEq,2,numComp,2)];
                                A_0000[3] += 2*mu_p[INDEX5(0,0,0,0,3,numEq,2,numComp,2)];
                                A_0110[0] += mu_p[INDEX5(0,1,1,0,0,numEq,2,numComp,2)];
                                A_0101[0] += mu_p[INDEX5(0,1,0,1,0,numEq,2,numComp,2)];
                                A_0110[1] += mu_p[INDEX5(0,1,1,0,1,numEq,2,numComp,2)];
                                A_0101[1] += mu_p[INDEX5(0,1,0,1,1,numEq,2,numComp,2)];
                                A_0110[2] += mu_p[INDEX5(0,1,1,0,2,numEq,2,numComp,2)];
                                A_0101[2] += mu_p[INDEX5(0,1,0,1,2,numEq,2,numComp,2)];
                                A_0110[3] += mu_p[INDEX5(0,1,1,0,3,numEq,2,numComp,2)];
                                A_0101[3] += mu_p[INDEX5(0,1,0,1,3,numEq,2,numComp,2)];
                                A_1001[0] += mu_p[INDEX5(1,0,0,1,0,numEq,2,numComp,2)];
                                A_1010[0] += mu_p[INDEX5(1,0,1,0,0,numEq,2,numComp,2)];
                                A_1001[1] += mu_p[INDEX5(1,0,0,1,1,numEq,2,numComp,2)];
                                A_1010[1] += mu_p[INDEX5(1,0,1,0,1,numEq,2,numComp,2)];
                                A_1001[2] += mu_p[INDEX5(1,0,0,1,2,numEq,2,numComp,2)];
                                A_1010[2] += mu_p[INDEX5(1,0,1,0,2,numEq,2,numComp,2)];
                                A_1001[3] += mu_p[INDEX5(1,0,0,1,3,numEq,2,numComp,2)];
                                A_1010[3] += mu_p[INDEX5(1,0,1,0,3,numEq,2,numComp,2)];
                                A_1111[0] += 2*mu_p[INDEX5(1,1,1,1,0,numEq,2,numComp,2)];
                                A_1111[1] += 2*mu_p[INDEX5(1,1,1,1,1,numEq,2,numComp,2)];
                                A_1111[2] += 2*mu_p[INDEX5(1,1,1,1,2,numEq,2,numComp,2)];
                                A_1111[3] += 2*mu_p[INDEX5(1,1,1,1,3,numEq,2,numComp,2)];
                            }
                            if (!lambda.isEmpty()) {
                                const double *lambda_p = lambda.getSampleDataRO(e);
                                A_0000[0] += lambda_p[INDEX5(0,0,0,0,0,numEq,2,numComp,2)];
                                A_0000[1] += lambda_p[INDEX5(0,0,0,0,1,numEq,2,numComp,2)];
                                A_0000[2] += lambda_p[INDEX5(0,0,0,0,2,numEq,2,numComp,2)];
                                A_0000[3] += lambda_p[INDEX5(0,0,0,0,3,numEq,2,numComp,2)];
                                A_0011[0] += lambda_p[INDEX5(0,0,1,1,0,numEq,2,numComp,2)];
                                A_0011[1] += lambda_p[INDEX5(0,0,1,1,1,numEq,2,numComp,2)];
                                A_0011[2] += lambda_p[INDEX5(0,0,1,1,2,numEq,2,numComp,2)];
                                A_0011[3] += lambda_p[INDEX5(0,0,1,1,3,numEq,2,numComp,2)];
                                A_1100[0] += lambda_p[INDEX5(1,1,0,0,0,numEq,2,numComp,2)];
                                A_1100[1] += lambda_p[INDEX5(1,1,0,0,1,numEq,2,numComp,2)];
                                A_1100[2] += lambda_p[INDEX5(1,1,0,0,2,numEq,2,numComp,2)];
                                A_1100[3] += lambda_p[INDEX5(1,1,0,0,3,numEq,2,numComp,2)];
                                A_1111[0] += lambda_p[INDEX5(1,1,1,1,0,numEq,2,numComp,2)];
                                A_1111[1] += lambda_p[INDEX5(1,1,1,1,1,numEq,2,numComp,2)];
                                A_1111[2] += lambda_p[INDEX5(1,1,1,1,2,numEq,2,numComp,2)];
                                A_1111[3] += lambda_p[INDEX5(1,1,1,1,3,numEq,2,numComp,2)];
                            }
                            const double tmp00_0 = w3*(A_0101[0] + A_0101[1] + A_0101[2] + A_0101[3]);
                            const double tmp00_2 = w4*(A_0000[2] + A_0000[3]);
                            const double tmp00_3 = w0*(A_0000[0] + A_0000[1]);
                            const double tmp00_7 = w3*(-A_0101[0] - A_0101[1] - A_0101[2] - A_0101[3]);
                            const double tmp00_8 = w6*(A_0000[0] + A_0000[1] + A_0000[2] + A_0000[3]);
                            const double tmp00_11 = w4*(A_0000[0] + A_0000[1]);
                            const double tmp00_12 = w0*(A_0000[2] + A_0000[3]);
                            const double tmp00_15 = w7*(A_0101[0] + A_0101[2]);
                            const double tmp00_16 = w4*(-A_0000[2] - A_0000[3]);
                            const double tmp00_17 = w0*(-A_0000[0] - A_0000[1]);
                            const double tmp00_19 = w8*(A_0101[1] + A_0101[3]);
                            const double tmp00_21 = w7*(A_0101[1] + A_0101[3]);
                            const double tmp00_22 = w4*(-A_0000[0] - A_0000[1]);
                            const double tmp00_23 = w0*(-A_0000[2] - A_0000[3]);
                            const double tmp00_25 = w8*(A_0101[0] + A_0101[2]);
                            const double tmp00_30 = w7*(-A_0101[1] - A_0101[3]);
                            const double tmp00_33 = w8*(-A_0101[0] - A_0101[2]);
                            const double tmp00_34 = w6*(-A_0000[0] - A_0000[1] - A_0000[2] - A_0000[3]);
                            const double tmp00_38 = w7*(-A_0101[0] - A_0101[2]);
                            const double tmp00_40 = w8*(-A_0101[1] - A_0101[3]);
                            const double tmp01_1 = w1*(A_0011[0] + A_0011[3] - A_0110[1] - A_0110[2]);
                            const double tmp01_4 = w5*(A_0011[2] - A_0110[3]);
                            const double tmp01_5 = w2*(-A_0011[1] + A_0110[0]);
                            const double tmp01_6 = w5*(A_0011[3] + A_0110[0]);
                            const double tmp01_9 = w1*(A_0011[1] + A_0011[2] + A_0110[1] + A_0110[2]);
                            const double tmp01_10 = w2*(-A_0011[0] - A_0110[3]);
                            const double tmp01_13 = w5*(A_0011[1] - A_0110[0]);
                            const double tmp01_14 = w2*(-A_0011[2] + A_0110[3]);
                            const double tmp01_18 = w5*(A_0011[3] + A_0110[3]);
                            const double tmp01_20 = w2*(-A_0011[0] - A_0110[0]);
                            const double tmp01_24 = w5*(A_0011[0] + A_0110[0]);
                            const double tmp01_26 = w2*(-A_0011[3] - A_0110[3]);
                            const double tmp01_27 = w5*(-A_0011[1] - A_0110[2]);
                            const double tmp01_28 = w1*(-A_0011[0] - A_0011[3] - A_0110[0] - A_0110[3]);
                            const double tmp01_29 = w2*(A_0011[2] + A_0110[1]);
                            const double tmp01_31 = w1*(-A_0011[1] - A_0011[2] + A_0110[0] + A_0110[3]);
                            const double tmp01_32 = w5*(-A_0011[0] + A_0110[2]);
                            const double tmp01_35 = w2*(A_0011[3] - A_0110[1]);
                            const double tmp01_36 = w5*(A_0011[0] + A_0110[3]);
                            const double tmp01_37 = w2*(-A_0011[3] - A_0110[0]);
                            const double tmp01_39 = w5*(-A_0011[3] + A_0110[1]);
                            const double tmp01_41 = w2*(A_0011[0] - A_0110[2]);
                            const double tmp01_42 = w5*(A_0011[1] - A_0110[3]);
                            const double tmp01_43 = w2*(-A_0011[2] + A_0110[0]);
                            const double tmp01_44 = w5*(A_0011[2] - A_0110[0]);
                            const double tmp01_45 = w2*(-A_0011[1] + A_0110[3]);
                            const double tmp01_46 = w5*(-A_0011[0] + A_0110[1]);
                            const double tmp01_47 = w2*(A_0011[3] - A_0110[2]);
                            const double tmp01_48 = w5*(-A_0011[1] - A_0110[1]);
                            const double tmp01_49 = w2*(A_0011[2] + A_0110[2]);
                            const double tmp01_50 = w5*(-A_0011[3] + A_0110[2]);
                            const double tmp01_51 = w2*(A_0011[0] - A_0110[1]);
                            const double tmp01_52 = w5*(-A_0011[2] - A_0110[1]);
                            const double tmp01_53 = w2*(A_0011[1] + A_0110[2]);
                            const double tmp01_54 = w5*(-A_0011[2] - A_0110[2]);
                            const double tmp01_55 = w2*(A_0011[1] + A_0110[1]);
                            const double tmp10_1 = w1*(A_1001[0] + A_1001[3] - A_1100[1] - A_1100[2]);
                            const double tmp10_4 = w5*(A_1001[2] - A_1100[3]);
                            const double tmp10_5 = w2*(-A_1001[1] + A_1100[0]);
                            const double tmp10_6 = w5*(A_1001[3] + A_1100[0]);
                            const double tmp10_9 = w1*(A_1001[1] + A_1001[2] + A_1100[1] + A_1100[2]);
                            const double tmp10_10 = w2*(-A_1001[0] - A_1100[3]);
                            const double tmp10_13 = w5*(A_1001[1] - A_1100[0]);
                            const double tmp10_14 = w2*(-A_1001[2] + A_1100[3]);
                            const double tmp10_18 = w5*(A_1001[3] + A_1100[3]);
                            const double tmp10_20 = w2*(-A_1001[0] - A_1100[0]);
                            const double tmp10_24 = w5*(A_1001[0] + A_1100[0]);
                            const double tmp10_26 = w2*(-A_1001[3] - A_1100[3]);
                            const double tmp10_27 = w5*(-A_1001[1] - A_1100[2]);
                            const double tmp10_28 = w1*(-A_1001[0] - A_1001[3] - A_1100[0] - A_1100[3]);
                            const double tmp10_29 = w2*(A_1001[2] + A_1100[1]);
                            const double tmp10_31 = w1*(-A_1001[1] - A_1001[2] + A_1100[0] + A_1100[3]);
                            const double tmp10_32 = w5*(-A_1001[0] + A_1100[2]);
                            const double tmp10_35 = w2*(A_1001[3] - A_1100[1]);
                            const double tmp10_36 = w5*(A_1001[0] + A_1100[3]);
                            const double tmp10_37 = w2*(-A_1001[3] - A_1100[0]);
                            const double tmp10_39 = w5*(-A_1001[3] + A_1100[1]);
                            const double tmp10_41 = w2*(A_1001[0] - A_1100[2]);
                            const double tmp10_42 = w5*(A_1001[1] - A_1100[3]);
                            const double tmp10_43 = w2*(-A_1001[2] + A_1100[0]);
                            const double tmp10_44 = w5*(A_1001[2] - A_1100[0]);
                            const double tmp10_45 = w2*(-A_1001[1] + A_1100[3]);
                            const double tmp10_46 = w5*(-A_1001[0] + A_1100[1]);
                            const double tmp10_47 = w2*(A_1001[3] - A_1100[2]);
                            const double tmp10_48 = w5*(-A_1001[1] - A_1100[1]);
                            const double tmp10_49 = w2*(A_1001[2] + A_1100[2]);
                            const double tmp10_50 = w5*(-A_1001[3] + A_1100[2]);
                            const double tmp10_51 = w2*(A_1001[0] - A_1100[1]);
                            const double tmp10_52 = w5*(-A_1001[2] - A_1100[1]);
                            const double tmp10_53 = w2*(A_1001[1] + A_1100[2]);
                            const double tmp10_54 = w5*(-A_1001[2] - A_1100[2]);
                            const double tmp10_55 = w2*(A_1001[1] + A_1100[1]);
                            const double tmp11_0 = w3*(A_1111[0] + A_1111[1] + A_1111[2] + A_1111[3]);
                            const double tmp11_2 = w4*(A_1010[2] + A_1010[3]);
                            const double tmp11_3 = w0*(A_1010[0] + A_1010[1]);
                            const double tmp11_7 = w3*(-A_1111[0] - A_1111[1] - A_1111[2] - A_1111[3]);
                            const double tmp11_8 = w6*(A_1010[0] + A_1010[1] + A_1010[2] + A_1010[3]);
                            const double tmp11_11 = w4*(A_1010[0] + A_1010[1]);
                            const double tmp11_12 = w0*(A_1010[2] + A_1010[3]);
                            const double tmp11_15 = w7*(A_1111[0] + A_1111[2]);
                            const double tmp11_16 = w4*(-A_1010[2] - A_1010[3]);
                            const double tmp11_17 = w0*(-A_1010[0] - A_1010[1]);
                            const double tmp11_19 = w8*(A_1111[1] + A_1111[3]);
                            const double tmp11_21 = w7*(A_1111[1] + A_1111[3]);
                            const double tmp11_22 = w4*(-A_1010[0] - A_1010[1]);
                            const double tmp11_23 = w0*(-A_1010[2] - A_1010[3]);
                            const double tmp11_25 = w8*(A_1111[0] + A_1111[2]);
                            const double tmp11_30 = w7*(-A_1111[1] - A_1111[3]);
                            const double tmp11_33 = w8*(-A_1111[0] - A_1111[2]);
                            const double tmp11_34 = w6*(-A_1010[0] - A_1010[1] - A_1010[2] - A_1010[3]);
                            const double tmp11_38 = w7*(-A_1111[0] - A_1111[2]);
                            const double tmp11_40 = w8*(-A_1111[1] - A_1111[3]);

                            EM_S[INDEX4(0,0,0,0,numEq,numComp,4)]+=tmp00_15 + tmp00_16 + tmp00_17 + tmp00_19;
                            EM_S[INDEX4(0,0,0,1,numEq,numComp,4)]+=tmp00_0 + tmp00_2 + tmp00_3;
                            EM_S[INDEX4(0,0,0,2,numEq,numComp,4)]+=tmp00_34 + tmp00_38 + tmp00_40;
                            EM_S[INDEX4(0,0,0,3,numEq,numComp,4)]+=tmp00_7 + tmp00_8;
                            EM_S[INDEX4(0,0,1,0,numEq,numComp,4)]+=tmp00_0 + tmp00_2 + tmp00_3;
                            EM_S[INDEX4(0,0,1,1,numEq,numComp,4)]+=tmp00_16 + tmp00_17 + tmp00_21 + tmp00_25;
                            EM_S[INDEX4(0,0,1,2,numEq,numComp,4)]+=tmp00_7 + tmp00_8;
                            EM_S[INDEX4(0,0,1,3,numEq,numComp,4)]+=tmp00_30 + tmp00_33 + tmp00_34;
                            EM_S[INDEX4(0,0,2,0,numEq,numComp,4)]+=tmp00_34 + tmp00_38 + tmp00_40;
                            EM_S[INDEX4(0,0,2,1,numEq,numComp,4)]+=tmp00_7 + tmp00_8;
                            EM_S[INDEX4(0,0,2,2,numEq,numComp,4)]+=tmp00_15 + tmp00_19 + tmp00_22 + tmp00_23;
                            EM_S[INDEX4(0,0,2,3,numEq,numComp,4)]+=tmp00_0 + tmp00_11 + tmp00_12;
                            EM_S[INDEX4(0,0,3,0,numEq,numComp,4)]+=tmp00_7 + tmp00_8;
                            EM_S[INDEX4(0,0,3,1,numEq,numComp,4)]+=tmp00_30 + tmp00_33 + tmp00_34;
                            EM_S[INDEX4(0,0,3,2,numEq,numComp,4)]+=tmp00_0 + tmp00_11 + tmp00_12;
                            EM_S[INDEX4(0,0,3,3,numEq,numComp,4)]+=tmp00_21 + tmp00_22 + tmp00_23 + tmp00_25;
                            EM_S[INDEX4(0,1,0,0,numEq,numComp,4)]+=tmp01_18 + tmp01_20 + tmp01_9;
                            EM_S[INDEX4(0,1,0,1,numEq,numComp,4)]+=tmp01_1 + tmp01_4 + tmp01_5;
                            EM_S[INDEX4(0,1,0,2,numEq,numComp,4)]+=tmp01_31 + tmp01_39 + tmp01_41;
                            EM_S[INDEX4(0,1,0,3,numEq,numComp,4)]+=tmp01_28 + tmp01_52 + tmp01_53;
                            EM_S[INDEX4(0,1,1,0,numEq,numComp,4)]+=tmp01_31 + tmp01_50 + tmp01_51;
                            EM_S[INDEX4(0,1,1,1,numEq,numComp,4)]+=tmp01_28 + tmp01_54 + tmp01_55;
                            EM_S[INDEX4(0,1,1,2,numEq,numComp,4)]+=tmp01_10 + tmp01_6 + tmp01_9;
                            EM_S[INDEX4(0,1,1,3,numEq,numComp,4)]+=tmp01_1 + tmp01_44 + tmp01_45;
                            EM_S[INDEX4(0,1,2,0,numEq,numComp,4)]+=tmp01_1 + tmp01_42 + tmp01_43;
                            EM_S[INDEX4(0,1,2,1,numEq,numComp,4)]+=tmp01_36 + tmp01_37 + tmp01_9;
                            EM_S[INDEX4(0,1,2,2,numEq,numComp,4)]+=tmp01_28 + tmp01_48 + tmp01_49;
                            EM_S[INDEX4(0,1,2,3,numEq,numComp,4)]+=tmp01_31 + tmp01_46 + tmp01_47;
                            EM_S[INDEX4(0,1,3,0,numEq,numComp,4)]+=tmp01_27 + tmp01_28 + tmp01_29;
                            EM_S[INDEX4(0,1,3,1,numEq,numComp,4)]+=tmp01_31 + tmp01_32 + tmp01_35;
                            EM_S[INDEX4(0,1,3,2,numEq,numComp,4)]+=tmp01_1 + tmp01_13 + tmp01_14;
                            EM_S[INDEX4(0,1,3,3,numEq,numComp,4)]+=tmp01_24 + tmp01_26 + tmp01_9;
                            EM_S[INDEX4(1,0,0,0,numEq,numComp,4)]+=tmp10_18 + tmp10_20 + tmp10_9;
                            EM_S[INDEX4(1,0,0,1,numEq,numComp,4)]+=tmp10_1 + tmp10_4 + tmp10_5;
                            EM_S[INDEX4(1,0,0,2,numEq,numComp,4)]+=tmp10_31 + tmp10_39 + tmp10_41;
                            EM_S[INDEX4(1,0,0,3,numEq,numComp,4)]+=tmp10_28 + tmp10_52 + tmp10_53;
                            EM_S[INDEX4(1,0,1,0,numEq,numComp,4)]+=tmp10_31 + tmp10_50 + tmp10_51;
                            EM_S[INDEX4(1,0,1,1,numEq,numComp,4)]+=tmp10_28 + tmp10_54 + tmp10_55;
                            EM_S[INDEX4(1,0,1,2,numEq,numComp,4)]+=tmp10_10 + tmp10_6 + tmp10_9;
                            EM_S[INDEX4(1,0,1,3,numEq,numComp,4)]+=tmp10_1 + tmp10_44 + tmp10_45;
                            EM_S[INDEX4(1,0,2,0,numEq,numComp,4)]+=tmp10_1 + tmp10_42 + tmp10_43;
                            EM_S[INDEX4(1,0,2,1,numEq,numComp,4)]+=tmp10_36 + tmp10_37 + tmp10_9;
                            EM_S[INDEX4(1,0,2,2,numEq,numComp,4)]+=tmp10_28 + tmp10_48 + tmp10_49;
                            EM_S[INDEX4(1,0,2,3,numEq,numComp,4)]+=tmp10_31 + tmp10_46 + tmp10_47;
                            EM_S[INDEX4(1,0,3,0,numEq,numComp,4)]+=tmp10_27 + tmp10_28 + tmp10_29;
                            EM_S[INDEX4(1,0,3,1,numEq,numComp,4)]+=tmp10_31 + tmp10_32 + tmp10_35;
                            EM_S[INDEX4(1,0,3,2,numEq,numComp,4)]+=tmp10_1 + tmp10_13 + tmp10_14;
                            EM_S[INDEX4(1,0,3,3,numEq,numComp,4)]+=tmp10_24 + tmp10_26 + tmp10_9;
                            EM_S[INDEX4(1,1,0,0,numEq,numComp,4)]+=tmp11_15 + tmp11_16 + tmp11_17 + tmp11_19;
                            EM_S[INDEX4(1,1,0,1,numEq,numComp,4)]+=tmp11_0 + tmp11_2 + tmp11_3;
                            EM_S[INDEX4(1,1,0,2,numEq,numComp,4)]+=tmp11_34 + tmp11_38 + tmp11_40;
                            EM_S[INDEX4(1,1,0,3,numEq,numComp,4)]+=tmp11_7 + tmp11_8;
                            EM_S[INDEX4(1,1,1,0,numEq,numComp,4)]+=tmp11_0 + tmp11_2 + tmp11_3;
                            EM_S[INDEX4(1,1,1,1,numEq,numComp,4)]+=tmp11_16 + tmp11_17 + tmp11_21 + tmp11_25;
                            EM_S[INDEX4(1,1,1,2,numEq,numComp,4)]+=tmp11_7 + tmp11_8;
                            EM_S[INDEX4(1,1,1,3,numEq,numComp,4)]+=tmp11_30 + tmp11_33 + tmp11_34;
                            EM_S[INDEX4(1,1,2,0,numEq,numComp,4)]+=tmp11_34 + tmp11_38 + tmp11_40;
                            EM_S[INDEX4(1,1,2,1,numEq,numComp,4)]+=tmp11_7 + tmp11_8;
                            EM_S[INDEX4(1,1,2,2,numEq,numComp,4)]+=tmp11_15 + tmp11_19 + tmp11_22 + tmp11_23;
                            EM_S[INDEX4(1,1,2,3,numEq,numComp,4)]+=tmp11_0 + tmp11_11 + tmp11_12;
                            EM_S[INDEX4(1,1,3,0,numEq,numComp,4)]+=tmp11_7 + tmp11_8;
                            EM_S[INDEX4(1,1,3,1,numEq,numComp,4)]+=tmp11_30 + tmp11_33 + tmp11_34;
                            EM_S[INDEX4(1,1,3,2,numEq,numComp,4)]+=tmp11_0 + tmp11_11 + tmp11_12;
                            EM_S[INDEX4(1,1,3,3,numEq,numComp,4)]+=tmp11_21 + tmp11_22 + tmp11_23 + tmp11_25;
