...
The time-step size is calculated based on the Courant–Friedrichs–Lewy condition (CFL condition)  \index{Courant number}\index{CFL condition}, to ensure stable solutions.
