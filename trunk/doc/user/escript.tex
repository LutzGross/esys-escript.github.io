...
But \var{x0} contains values between $0$ and $1$ inclusive so we need to continue the table to the ninth entry.
...
\end{python}
Any values which interpolate to larger than \var{toobig} will raise an exception.
