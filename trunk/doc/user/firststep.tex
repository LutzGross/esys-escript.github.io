...
>>> 
\end{verbatim}
Here you can use all available python commands and language features\footnote{Throughout our examples, we use the python3 form of 
...
\end{python}
will write \var{u} to a \SILO file if escript was compiled with \SILO support.
