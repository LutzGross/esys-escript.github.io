...
% \centerline{\includegraphics[width=\figwidth]{quad}}
...
the geometries you can create.  For example, \pycad
...
\begin{figure}
% \centerline{\includegraphics[width=\figwidth]{brick}}
...
\begin{figure}
% \centerline{\includegraphics[width=\figwidth]{refine1}}
...
sets options for the mesh generator. \var{algorithm2D} sets the 2D meshing algorithm to be used.
...
\var{curvature_based_element_size}=\True switches on curvature based definition of element size.
\var{generate_hexahedra}=\True switches on the usage of quadrilateral/hexahedra elements.
\end{methoddesc}
