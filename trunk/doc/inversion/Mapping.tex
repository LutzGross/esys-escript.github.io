...
\begin{classdesc}{DensityMapping}{domain \optional{,
\optional{, z0=None 
\optional{, rho0=0
\optional{, drho=$2750 \cdot kg \cdot m^{-3}$
\optional{,  beta=2.}}}}}}
a linear density mapping including depth weighting. \var{domain} is the domain of the 
inversion, \var{z0} reference depth in the depth weighting factor, 
\var{drho} is the density scaling factor (by default the density of granite is used) and
\var{beta} is the exponent in depth weighting factor. If no reference depth \var{z0} is given
no depth weighting is applied. \var{rho0} is the reference density. it may be a function 
...
\begin{classdesc}{SusceptibilityMapping}{domain \optional{,
\optional{, z0=None 
\optional{, k0=0
\optional{, k=1
\optional{,  beta=2.}}}}}}
a linear susceptibility mapping including depth weighting. \var{domain} is the domain of the 
inversion, \var{z0} reference depth in the depth weighting factor, 
\var{dk} is the susceptibility scaling factor (by default one is used) and
\var{beta} is the exponent in depth weighting factor. If no reference depth \var{z0} is given
no depth weighting is applied. \var{k0} is the reference susceptibility. It may be a function 
of its location in the domain. 
\end{classdesc}
