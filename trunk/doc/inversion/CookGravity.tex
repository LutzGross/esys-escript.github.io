...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{QLDWestGravityDataPlot.png}
\caption{Gravity Anomaly Data in $mgal$ from Western Queensland, Australia.  \AZADEH{ADD CREDITS}}
\label{FIG:P1:GRAV:0}
\end{figure}
...
In practice gravity acceleration is measured in various way, for instance by airborne surveys \AZADEH{Telford, W.M., Geldart, L.P., Sheriff, R.E. and Keys, D.A.Applied Geophysics (2nd Edition). Cambridge University Press,1990,P.26.}. \downunder
...
\end{itemize}
have been applied to the data. In general, data prepared in such a form are called Bouguer anomalies \AZADEH{Telford, W.M., Geldart, L.P., Sheriff, R.E. and Keys, D.A.Applied Geophysics (2nd Edition). Cambridge University Press,1990,P.15.}. 
...
The script \examplefile{create_netcdf.py} shows how to create a \netcdf file from these information.
...
\CIHAN{ADD some remarkes in several data sets: add and example, altitude?, restrictions?}
