...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{DenMu1Contour.png}
\caption{3D contour plot of density distribution of inversion of data \file{data/QLDWest_grav.nc} ($\mu=1.$). Colors
...
\begin{figure}
        ...
        \subfigure[$\mu=0.1$]{%
	            \label{fig:first}
	            \includegraphics[width=0.4\textwidth]{density11.png}
	        }%
	        \subfigure[$\mu=1.$]{%
	           \label{fig:second}
	           \includegraphics[width=0.4\textwidth]{density11.png}
