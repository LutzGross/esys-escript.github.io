...
In practice gravity acceleration is measured in various way, for instance by airborne surveys \AZADEH{add reference}. \downunder
...
\end{itemize}
have been applied to the data. In general, data prepared in such a form are called Bouguer anomalies \AZADEH{add reference}. 
