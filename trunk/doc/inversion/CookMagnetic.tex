...
going to highlight now. The magnetic inversion requires data about the background  magnetic flux densit which is added to the domain
by the statements 
\begin{verbatim}
B_b= [ -41000*U.Nano * U.Tesla, 31000*U.Nano * U.Tesla, 0.]
dom.setBackgroundMagneticFluxDensity(B_b)
\end{verbatim}
Here it is assumed that the background magnetic flux density is constant across the domain.
