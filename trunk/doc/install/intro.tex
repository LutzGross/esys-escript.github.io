...
\begin{enumerate}
  ...
  These are available in Debian and Ubuntu repositories, so just use your normal package manager (so you don't need this guide). They are alos available for Anaconda Python 3.
  \item Using flatpak
