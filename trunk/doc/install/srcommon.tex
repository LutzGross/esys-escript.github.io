...
\begin{itemize}
\item \filename{scons/TEMPLATE_linux.py} (\linux and \macosx desktop)
\item \filename{scons/TEMPLATE_windows.py} (\winxp)
\end{itemize}
...
\filename{/opt/netcdf4/include}\footnote{or \ldots/include32 or \ldots/include64 or \ldots/inc}
and the \emph{libraries} in \filename{/opt/netcdf4/lib}\footnote{or \ldots/lib32 or \ldots/lib64}.
...
directories underneath \filename{./debugbuild}.
