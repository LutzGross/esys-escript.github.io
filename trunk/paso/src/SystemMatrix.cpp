...
{
  return paso::Coupler_getNumOverlapComponents(A->row_coupler);
}
dim_t Paso_SystemMatrix_getColOverlap(const Paso_SystemMatrix* A)
{
  return paso::Coupler_getNumOverlapComponents(A->col_coupler);
}
