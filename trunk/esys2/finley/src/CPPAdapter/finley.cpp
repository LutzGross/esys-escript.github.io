...
BOOST_PYTHON_MODULE(finley)
{
  ...
  class_<finley::MeshAdapter, bases<escript::AbstractContinuousDomain> >
      ...
      .def("addRobinConditionsToSystem",&finley::MeshAdapter::addRobinConditionsToSystem)
      .def("addContactToSystem",&finley::MeshAdapter::addContactToSystem)
