...
v2 = Velocity(scene = s, data_collector = dc1, vector = None, scalar = None,
...
v3 = Velocity(scene = s, data_collector = dc1, vector = None, scalar = None, 
...
v4 = Velocity(scene = s, data_collector = dc1, vector = None, scalar = None, 
