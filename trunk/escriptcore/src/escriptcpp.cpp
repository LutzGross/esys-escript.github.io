...
args("source", "q", "r","factor"),
  ...
  enum_<escript::SolverOptions>("SolverOptions")
    .value("DEFAULT", escript::ESCRIPT_DEFAULT)
    .value("DIRECT", escript::ESCRIPT_DIRECT)
    .value("CHOLEVSKY", escript::ESCRIPT_CHOLEVSKY)
    .value("PCG", escript::ESCRIPT_PCG)
    .value("CR", escript::ESCRIPT_CR)
    .value("CGS", escript::ESCRIPT_CGS)
    .value("BICGSTAB", escript::ESCRIPT_BICGSTAB)
    .value("ILU0", escript::ESCRIPT_ILU0)
    ...
    .value("HRZ_LUMPING", escript::ESCRIPT_HRZ_LUMPING)
    .value("NO_REORDERING", escript::ESCRIPT_NO_REORDERING)
    .value("MINIMUM_FILL_IN", escript::ESCRIPT_MINIMUM_FILL_IN)
    .value("NESTED_DISSECTION", escript::ESCRIPT_NESTED_DISSECTION)
    .value("MKL", escript::ESCRIPT_MKL)
    .value("UMFPACK", escript::ESCRIPT_UMFPACK)
    .value("ITERATIVE", escript::ESCRIPT_ITERATIVE)
    .value("PASO", escript::ESCRIPT_PASO)
    .value("AMG", escript::ESCRIPT_AMG)
    .value("REC_ILU", escript::ESCRIPT_REC_ILU)
    .value("TRILINOS", escript::ESCRIPT_TRILINOS)
    .value("NONLINEAR_GMRES", escript::ESCRIPT_NONLINEAR_GMRES)
    .value("TFQMR", escript::ESCRIPT_TFQMR)
    .value("MINRES", escript::ESCRIPT_MINRES)
    .value("GAUSS_SEIDEL", escript::ESCRIPT_GAUSS_SEIDEL)
    .value("RILU", escript::ESCRIPT_RILU)
    .value("DEFAULT_REORDERING", escript::ESCRIPT_DEFAULT_REORDERING)
    .value("SUPER_LU", escript::ESCRIPT_SUPER_LU)
    .value("PASTIX", escript::ESCRIPT_PASTIX)
    .value("YAIR_SHAPIRA_COARSENING", escript::ESCRIPT_YAIR_SHAPIRA_COARSENING)
    .value("RUGE_STUEBEN_COARSENING", escript::ESCRIPT_RUGE_STUEBEN_COARSENING)
    .value("AGGREGATION_COARSENING", escript::ESCRIPT_AGGREGATION_COARSENING)
    .value("NO_PRECONDITIONER", escript::ESCRIPT_NO_PRECONDITIONER)
    .value("MIN_COARSE_MATRIX_SIZE", escript::ESCRIPT_MIN_COARSE_MATRIX_SIZE)
    .value("AMLI", escript::ESCRIPT_AMLI)
    .value("STANDARD_COARSENING", escript::ESCRIPT_STANDARD_COARSENING)
    .value("CLASSIC_INTERPOLATION_WITH_FF_COUPLING", escript::ESCRIPT_CLASSIC_INTERPOLATION_WITH_FF_COUPLING)
    .value("CLASSIC_INTERPOLATION", escript::ESCRIPT_CLASSIC_INTERPOLATION)
    .value("DIRECT_INTERPOLATION", escript::ESCRIPT_DIRECT_INTERPOLATION)
    .value("BOOMERAMG", escript::ESCRIPT_BOOMERAMG)
    .value("CIJP_FIXED_RANDOM_COARSENING", escript::ESCRIPT_CIJP_FIXED_RANDOM_COARSENING)
    .value("CIJP_COARSENING", escript::ESCRIPT_CIJP_COARSENING)
    .value("FALGOUT_COARSENING", escript::ESCRIPT_FALGOUT_COARSENING)
    .value("PMIS_COARSENING", escript::ESCRIPT_PMIS_COARSENING)
