...
class Test_VTKFiles(Test_VisualizationInterface):
  ...
  def test_hex_2D_order2_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2.msh"))
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2.xml"),domain=dom)
  ...
  def test_hex_2D_order2_AllPoints_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2_AllPoints_Scalar.xml"),data_r=x_r[0],data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_order2_02Points_Scalar_vtk(self):
     ...
     x=Solution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2_O2Points_Scalar.xml"),data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_order2_2Cells_Scalar_vtk(self):
     ...
     try: 
        saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2_2Cells_Scalar.xml"),data=x[0],data_b=x_b[0])
  ...
  def test_hex_2D_order2_BoundaryPoint_Scalar_vtk(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2_BoundaryPoint_Scalar.xml"),data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_hex_2D_order2_Cells_AllData_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2_Cells_AllData.xml"),data_s=x[0],data_v=x[0]*[1.,2.],data_t=x[0]*[[11.,12.],[21.,22.]],data_t2=x[0]*[[-11.,-12.],[-21.,-22.]])
  ...
  def test_hex_2D_order2_CellsPoints_AllData_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2_CellsPoints_AllData.xml"),data_sp=x_p[0],
                                                     data_vp=x_p[0]*[1.,2.],
  ...
  def test_hex_contact_2D_order1_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_Solution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_Solution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_Solution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_Solution_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_Solution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_Solution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_ReducedSolution_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_Function_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_Function_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_ReducedFunction_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_FunctionOnBoundary_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_FunctionOnContactZero_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_FunctionOnContactOne_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Scalar_vtk(self):
	...
	dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
	x=ReducedFunctionOnContactOne(dom).getX()
	saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Vector_vtk(self):
	...
	dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
	x=ReducedFunctionOnContactOne(dom).getX()
	saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Tensor_vtk(self):
	...
	dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"))
	x=ReducedFunctionOnContactOne(dom).getX()
	saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
	self.check_vtk("hex_contact_2D_order1_onFace_ReducedFunctionOnContactOne_Tensor.xml",reference)
  # ======================================================================================================================
  def test_hex_contact_2D_order2_ContinuousFunction_Scalar_vtk(self):
     reference="hex_2D_o2_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_Solution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_Solution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_Solution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_Solution_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_Solution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_Solution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_ReducedSolution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_Function_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_Function_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_FunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_contact_2D_order2_onFace_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_2D_order2_onFace_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_3D_order1_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_Solution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_Solution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_Solution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_Solution_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_Solution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_Solution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_ReducedSolution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_Function_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_Function_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_FunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order1_onFace_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order1_onFace_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_Solution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_Solution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_Solution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_Solution_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_Solution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_Solution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_ReducedSolution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_Function_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_Function_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnContactZero_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnContactZero_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnContactZero_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnContactZero_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnContactZero_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnContactZero(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnContactZero_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_FunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=FunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_FunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnContactOne_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnContactOne_Scalar.xml"),data=x[0])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnContactOne_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnContactOne_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_contact_3D_order2_onFace_ReducedFunctionOnContactOne_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"))
     x=ReducedFunctionOnContactOne(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_contact_3D_order2_onFace_ReducedFunctionOnContactOne_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
