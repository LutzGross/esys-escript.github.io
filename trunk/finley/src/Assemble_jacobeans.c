...
void Assemble_jacobeans_1D(double* coordinates, dim_t numQuad,double* QuadWeights,
     ...
     #pragma omp parallel 
     {
       ...
       for(e=0;e<numElements;e++){
           ...
           for (q=0;q<numQuad;q++) {
              D=0;
              for (s=0;s<numShape; s++) D+=X0[s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
              if (D==0.) {
     ...
     #pragma omp parallel 
     {
       ...
       for(e=0;e<numElements;e++){
           ...
           for (q=0;q<numQuad;q++) {
              ...
              dXdv11=0;
              for (s=0;s<numShape; s++) {
                 dXdv00+=X0[s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10+=X1[s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv01+=X0[s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv11+=X1[s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
              }
...
void Assemble_jacobeans_2D_M1D_E1D_C(double* coordinates, dim_t numQuad,double* QuadWeights,
     ...
     #pragma omp parallel 
     {
       ...
       register double dXdv00_1,dXdv10_1,dvdX00_1,dvdX01_1,D_1,invD_1;
       double X0[2*numShape], X1[2*numShape];
       #pragma omp for private(e,q,s) schedule(static) 
       for(e=0;e<numElements;e++){
           ...
           for (q=0;q<numQuad;q++) {
              ...
              dXdv10_1=0;
              for (s=0;s<numShape; s++) {
                 dXdv00_0+=X0[s]         *DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10_0+=X1[s]         *DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv00_1+=X0[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10_1+=X1[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
              }
       ...
       for(e=0;e<numElements;e++){
           ...
           for (q=0;q<numQuad;q++) {
              ...
              for (s=0;s<numShape; s++) {
                 dXdv00_0+=X0[         s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10_0+=X1[         s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv01_0+=X0[         s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv11_0+=X1[         s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv00_1+=X0[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10_1+=X1[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv01_1+=X0[numShape+s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv11_1+=X1[numShape+s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
              }
       ...
       for(e=0;e<numElements;e++){
           ...
           for (q=0;q<numQuad;q++) {
              ...
              for (s=0;s<numShape; s++) {
                 dXdv00+=X0[s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10+=X1[s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv20+=X2[s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv01+=X0[s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv11+=X1[s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv21+=X2[s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv02+=X0[s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv12+=X1[s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv22+=X2[s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
              }
...
void Assemble_jacobeans_3D_M2D_E3D_C(double* coordinates, dim_t numQuad,double* QuadWeights,
     ...
     #pragma omp parallel 
     {
       ...
       double X0[2*numShape], X1[2*numShape], X2[2*numShape];
       #pragma omp for private(e,q,s) schedule(static) 
       for(e=0;e<numElements;e++){
           for (s=0;s<2*numShape; s++) {
             X0[s]=coordinates[INDEX2(0,nodes[INDEX2(s,e,numNodes)],DIM)];
           ...
           for (q=0;q<numQuad;q++) {
              ...
              for (s=0;s<numShape; s++) {
                 dXdv00_0+=X0[         s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10_0+=X1[         s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv20_0+=X2[         s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv01_0+=X0[         s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv11_0+=X1[         s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv21_0+=X2[         s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv02_0+=X0[         s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv12_0+=X1[         s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv22_0+=X2[         s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv00_1+=X0[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv10_1+=X1[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv20_1+=X2[numShape+s]*DSDv[INDEX3(s,0,q,numShape,LOCDIM)];
                 dXdv01_1+=X0[numShape+s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv11_1+=X1[numShape+s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv21_1+=X2[numShape+s]*DSDv[INDEX3(s,1,q,numShape,LOCDIM)];
                 dXdv02_1+=X0[numShape+s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv12_1+=X1[numShape+s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
                 dXdv22_1+=X2[numShape+s]*DSDv[INDEX3(s,2,q,numShape,LOCDIM)];
              }
