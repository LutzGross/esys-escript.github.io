...
void Assemble_jacobeans_1D(double*, dim_t,double*, dim_t, dim_t,index_t* , double*, dim_t,double*, double*, double*, index_t*);
void Assemble_jacobeans_2D(double*, dim_t,double*, dim_t, dim_t,index_t* , double*, dim_t,double*, double*, double*, index_t*);
void Assemble_jacobeans_2D_M1D(double*, dim_t,double*, dim_t, dim_t,index_t* , double*, dim_t,double*, double*, double*, index_t*);
void Assemble_jacobeans_3D(double*, dim_t,double*, dim_t, dim_t,index_t* , double*, dim_t,double*, double*, double*, index_t*);
void Assemble_jacobeans_3D_M2D(double*, dim_t,double*, dim_t, dim_t,index_t* , double*, dim_t,double*, double*, double*, index_t*);
void Assemble_jacobeans_3D_M1D(double*, dim_t,double*, dim_t, dim_t,index_t* , double*, dim_t,double*, double*, double*, index_t*);
