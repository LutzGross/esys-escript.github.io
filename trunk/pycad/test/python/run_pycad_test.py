...
Point(1) = {0.000000 , 0.000000, 0.000000 , 0.010000 };
Point(2) = {1.000000 , 0.000000, 0.000000 , 0.010000 };
Point(3) = {1.000000 , 1.000000, 0.000000 , 0.010000 };
Point(4) = {0.000000 , 1.000000, 0.000000 , 0.010000 };
Line(5) = {1, 2};
Line(6) = {2, 3};
Line(7) = {3, 4};
Line(8) = {4, 1};
...
Mesh.Algorithm = 1; // = MeshAdapt
Mesh.Algorithm3D = 4; // = Frontal
Point(1) = {0.000000 , 0.000000, 0.000000 , 0.001000 };
Point(2) = {1.000000 , 1.000000, 1.000000 , 0.002000 };
Point(3) = {2.000000 , 2.000000, 2.000000 , 0.003000 };
Point(4) = {3.000000 , 3.000000, 3.000000 , 0.004000 };
Spline(5) = {1, 2, 3, 4};
Physical Line(6) = {5};
"""
       self.assertTrue(scrpt == ref )
...
Point(1) = {0.000000 , 0.000000, 0.000000 , 0.001000 };
Point(2) = {1.000000 , 1.000000, 1.000000 , 0.002000 };
Point(3) = {1.000000 , 2.000000, 3.000000 , 0.010000 };
Circle(4) = {2, 1, 3};
Physical Line(5) = {4};
"""
       self.assertTrue(scrpt == ref )
...
Mesh.Algorithm3D = 4; // = Frontal
Point(1) = {0.000000 , 0.000000, 0.000000 , 0.001000 };
Point(2) = {0.000000 , 1.000000, 0.000000 , 0.001000 };
Point(3) = {1.000000 , 1.000000, 1.000000 , 0.002000 };
Point(4) = {1.000000 , 2.000000, 3.000000 , 0.010000 };
Ellipse(5) = {3, 1, 2, 4};
Physical Line(6) = {5};
"""
       self.assertTrue(scrpt == ref )
...
Point(3) = {2.000000 , 2.000000, 2.000000 , 0.003000 };
Point(4) = {3.000000 , 3.000000, 3.000000 , 0.004000 };
Point(5) = {1.000000 , 2.000000, 3.000000 , 0.010000 };
Line(7) = {1, 2};
Circle(8) = {2, 4, 3};
Spline(12) = {3, 5, 1};
Line Loop(13) = {7, 8, 12};
...
Mesh.Algorithm3D = 4; // = Frontal
Point(1) = {0.000000 , 0.000000, 0.000000 , 0.010000 };
Point(2) = {10.000000 , 0.000000, 0.000000 , 0.020000 };
Point(3) = {10.000000 , 10.000000, 0.000000 , 0.030000 };
Point(4) = {0.000000 , 10.000000, 3.000000 , 0.040000 };
Point(5) = {5.000000 , 5.000000, 0.000000 , 0.001000 };
Point(6) = {7.000000 , 5.000000, 0.000000 , 0.001000 };
Point(7) = {5.000000 , 7.000000, 0.000000 , 0.001000 };
Line(10) = {1, 2};
Line(11) = {2, 3};
Line(12) = {3, 4};
Line(13) = {4, 1};
...
Point(2) = {10.000000 , 0.000000, 0.000000 , 0.020000 };
Point(3) = {10.000000 , 10.000000, 0.000000 , 0.030000 };
Point(4) = {0.000000 , 10.000000, 0.000000 , 0.040000 };
Line(5) = {1, 2};
...
Mesh.Algorithm = 1; // = MeshAdapt
Mesh.Algorithm3D = 4; // = Frontal
Point(1) = {-2.000000 , -2.000000, -2.000000 , 0.001000 };
Point(2) = {2.000000 , -2.000000, -2.000000 , 0.001000 };
Point(3) = {-2.000000 , 2.000000, -2.000000 , 0.001000 };
Point(4) = {2.000000 , 2.000000, -2.000000 , 0.001000 };
Point(5) = {-2.000000 , -2.000000, 2.000000 , 0.001000 };
Point(6) = {2.000000 , -2.000000, 2.000000 , 0.001000 };
Point(7) = {-2.000000 , 2.000000, 2.000000 , 0.001000 };
Point(8) = {2.000000 , 2.000000, 2.000000 , 0.001000 };
Line(9) = {1, 2};
Line(10) = {2, 6};
Line(11) = {6, 5};
Line(12) = {5, 1};
...
Point(34) = {-1.000000 , -1.000000, -1.000000 , 0.001000 };
Point(35) = {1.000000 , -1.000000, -1.000000 , 0.001000 };
Point(36) = {-1.000000 , 1.000000, -1.000000 , 0.001000 };
Point(37) = {1.000000 , 1.000000, -1.000000 , 0.001000 };
Point(38) = {-1.000000 , -1.000000, 1.000000 , 0.001000 };
Point(39) = {1.000000 , -1.000000, 1.000000 , 0.001000 };
Point(40) = {-1.000000 , 1.000000, 1.000000 , 0.001000 };
Point(41) = {1.000000 , 1.000000, 1.000000 , 0.001000 };
Line(42) = {34, 35};
Line(43) = {35, 39};
Line(44) = {39, 38};
Line(45) = {38, 34};
...
Mesh.Algorithm = 1; // = MeshAdapt
Mesh.Algorithm3D = 4; // = Frontal
Point(1) = {1.000000 , 2.000000, 3.000000 , 0.090000 };
Point(2) = {0.000000 , 0.000000, 0.000000 , 0.090000 };
Point(3) = {8.000000 , 6.000000, 6.000000 , 0.090000 };
Point(4) = {8.000000 , 6.000000, -6.000000 , 0.090000 };
Line(5) = {1, 2};
Circle(6) = {2, 3, 4};
Line(7) = {4, 1};
...
Point(3) = {10.000000 , 10.000000, 0.000000 , 0.030000 };
Point(4) = {0.000000 , 10.000000, 0.000000 , 0.040000 };
Point(5) = {5.000000 , 5.000000, 0.000000 , 0.000100 };
Point(6) = {7.000000 , 5.000000, 0.000000 , 0.000100 };
Point(7) = {5.000000 , 7.000000, 0.000000 , 0.000100 };
Line(8) = {1, 2};
Line(9) = {2, 3};
Line(10) = {3, 4};
Line(11) = {4, 1};
