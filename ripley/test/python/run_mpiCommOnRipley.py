...
"""
Test suite for MPI communicator retrieval on Ripley domains
"""
...
class Test_MPI_Comm_Ripley2D(Test_MPI_Comm_Retrieval):
    """Test MPI communicator retrieval on 2D Ripley Rectangle domains"""
    ...
    def createDomain(self, comm=None):
        ...
        if comm is None:
            ...
            # For custom communicators, let ripley auto-detect subdivision
            return Rectangle(n0=20, n1=20, comm=comm)


class Test_MPI_Comm_Ripley3D(Test_MPI_Comm_Retrieval):
    """Test MPI communicator retrieval on 3D Ripley Brick domains"""
