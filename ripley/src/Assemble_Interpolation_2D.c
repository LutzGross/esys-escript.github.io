      ...
      for (k1 =0; k1 < N1; ++k1) {
         for (k0 =0; k0 < N0; ++k0) {
            for (i =0; i < NCOMP; ++i) {
               ...
               out[INDEX3(i,0,INDEX2(k0,k1,N0),NCOMP,4)] = f_00*tmp0_1 + f_11*tmp0_2 + tmp0_0*(f_01 + f_10);
               out[INDEX3(i,1,INDEX2(k0,k1,N0),NCOMP,4)] = f_01*tmp0_2 + f_10*tmp0_1 + tmp0_0*(f_00 + f_11);
               out[INDEX3(i,2,INDEX2(k0,k1,N0),NCOMP,4)] = f_01*tmp0_1 + f_10*tmp0_2 + tmp0_0*(f_00 + f_11);
               out[INDEX3(i,3,INDEX2(k0,k1,N0),NCOMP,4)] = f_00*tmp0_2 + f_11*tmp0_1 + tmp0_0*(f_01 + f_10);
      ...
      if (face_offset(0)>-1) {
         ...
         for (k1 =0; k1 < N1; ++k1) {
            for (i =0; i < NCOMP; ++i) {
               ...
               out[INDEX3(i,0,face_offset(0)+INDEX2(k0,k1,N0),NCOMP,2)] = f_00*tmp0_1 + f_01*tmp0_0;
               out[INDEX3(i,1,face_offset(0)+INDEX2(k0,k1,N0),NCOMP,2)] = f_00*tmp0_0 + f_01*tmp0_1;
            } /* close component loop i */
         } /* close k1 loop */
      } /* end of face 0 */
      if (face_offset(1)>-1) {
         ...
         for (k1 =0; k1 < N1; ++k1) {
            for (i =0; i < NCOMP; ++i) {
               ...
               out[INDEX3(i,0,face_offset(1)+INDEX2(k0,k1,N0),NCOMP,2)] = f_10*tmp0_0 + f_11*tmp0_1;
               out[INDEX3(i,1,face_offset(1)+INDEX2(k0,k1,N0),NCOMP,2)] = f_10*tmp0_1 + f_11*tmp0_0;
            } /* close component loop i */
         } /* close k1 loop */
      } /* end of face 1 */
      if (face_offset(2)>-1) {
         ...
         for (k0 =0; k0 < N0; ++k0) {
            for (i =0; i < NCOMP; ++i) {
               ...
               out[INDEX3(i,0,face_offset(2)+INDEX2(k0,k1,N0),NCOMP,2)] = f_00*tmp0_1 + f_10*tmp0_0;
               out[INDEX3(i,1,face_offset(2)+INDEX2(k0,k1,N0),NCOMP,2)] = f_00*tmp0_0 + f_10*tmp0_1;
            } /* close component loop i */
         } /* close k0 loop */
      } /* end of face 2 */
      if (face_offset(3)>-1) {
         ...
         for (k0 =0; k0 < N0; ++k0) {
            for (i =0; i < NCOMP; ++i) {
               ...
               out[INDEX3(i,0,face_offset(3)+INDEX2(k0,k1,N0),NCOMP,2)] = f_01*tmp0_1 + f_11*tmp0_0;
               out[INDEX3(i,1,face_offset(3)+INDEX2(k0,k1,N0),NCOMP,2)] = f_01*tmp0_0 + f_11*tmp0_1;
            } /* close component loop i */
         } /* close k0 loop */
      } /* end of face 3 */
