...
cmake \
      ...
      -D CMAKE_EXE_LINKER_FLAGS=" -L/opt/homebrew/opt/llvm/lib/c++ -Wl,-rpath,/opt/homebrew/opt/llvm/lib/c++ " \
      -D CMAKE_SHARED_LINKER_FLAGS=" -L/opt/homebrew/opt/llvm/lib/c++ -Wl,-rpath,/opt/homebrew/opt/llvm/lib/c++ " \
