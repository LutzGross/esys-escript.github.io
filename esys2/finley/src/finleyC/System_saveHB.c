...
/* Finley: SystemMatrix is saved to Harwell-Boeing format     */
...
void Finley_SystemMatrix_saveHB( Finley_SystemMatrix *A_p, char *filename_p )
{
	/* open the file */
...
// 				fprintf( fileHandle_p, "bleh CSR found,,\n" );
		default:
				...
				sprintf( Finley_ErrorMsg, "%s: only CSC is currently supported.\n", __FILE__ );
	}
...
/*
 * $Log$
 * Revision 1.2  2005/07/08 04:07:58  jgs
 * Merge of development branch back to main trunk on 2005-07-08
 *
 * Revision 1.1.2.2  2005/07/04 07:32:52  imran
 * fixed "output bug" (fortran indexing)
 *
 * Revision 1.1.2.1  2005/07/04 00:53:12  imran
