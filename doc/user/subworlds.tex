...
Adds a variable to each of the subworlds build by the function \var{constructor} with argumemnts \var{args}. 
\end{funcdesc}
...
Individual jobs can use properties of \var{self} such as \member{swid} or \member{jobid} to distiguish between
themselves.
\end{funcdesc}
