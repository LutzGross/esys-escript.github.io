...
%options.setTrilinosParameter("print initial parameters", True)
%options.setTrilinosParameter("print unused parameters", True)
\end{python}
...
A more complicated example that controls the numer or pre and post sweeps is
