...
coarse we can tell \VisIt to draw all vectors. Bring up the Vector plot
attributes (double-click on the plot as before) and under 'Vector amount'
select 'Stride', leaving the parameter as 1. Click on Apply and dismiss the
dialog.
