...
\subsubsection*{class EscriptDataset}
...
\paragraph{EscriptDataset.setDomain(domain)}
...
\paragraph{EscriptDataset.addData(data, name \optional{, units="")}
}
...
\paragraph{EscriptDataset.setCycleAndTime(cycle, time)}
...
\paragraph{EscriptDataset.setMeshLabels(x, y \optional{, z="")}
}
...
\paragraph{EscriptDataset.setMeshUnits(x, y \optional{, z="")}
}
...
\paragraph{EscriptDataset.setMetadataSchemaString(\optional{schema="" \optional{, metadata="")}
}}
...
\paragraph{EscriptDataset.saveSilo(filename)}
...
\paragraph{EscriptDataset.saveVTK(filename)}
...
\paragraph{createDataset(domain, **data)}
...
\paragraph{saveVTK(filename \optional{, domain=None \optional{, metadata="" \optional{, metadata_schema=None)}
}}, **data}
...
\paragraph{saveSilo(filename \optional{, domain=None)}
, **data}
    convenience function that creates a dataset with the given domain and \Data
...
\paragraph{saveVoxet(filename, **data)}
...
\paragraph{visitInitialize(simFile \optional{, comment="")}
}
...
\paragraph{visitPublishData(dataset)}
