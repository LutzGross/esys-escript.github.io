...
To enter the escript environment you use \program{run-escript} command\footnote{\program{run-escript} is not available under Windows yet. If you run under windows you can just use the
...
\begin{verbatim}
  run-escript poisson\hackscore VTK.py
