...
\begin{memberdesc}[LinearPDE]{TRILINOS}
the TRILINOS,~\Ref{TRILINOS}. Remark: TRILINOS is a class library of parallel sparse solvers from Sandia National Laboratory
\end{memberdesc}
