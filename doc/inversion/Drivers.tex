...
set the tolerance for the the solver used to minimize the cost function. If \member{m_tol} is set the iteration is terminated 
...
\begin{classdesc}{MagneticInversion}{\optional{solverclass=None}}
