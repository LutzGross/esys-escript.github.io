...
Once you are satisfied, the \file{escript.d/build} and \file{\$PKG_ROOT/build} directories can be removed.
...
\begin{itemize}
\item  \file{scons}, \file{scons-1.2.0}, \file{cmake-2.6.3} and \file{cmake}
\end{itemize}
