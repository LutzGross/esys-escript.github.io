...
\footnote{These should either be in \filename{escript.d/release/doc} or in the case of Debian, in \filename{/usr/share/doc/escript}.}.
To test your installation try to run the following from a terminal:
\begin{shellCode}
 escript poission.py
\end{shellCode}
This should produce a VTK file called \filename{u.vtu} (which can be removed).
