...
# to show the mesh.
#
d.setScriptFileName(os.path.join(save_path,"simple.geo"))
...
# to show the mesh.
#
d.setMeshFileName(os.path.join(save_path,"simple.msh"))
#
...
domain.write(os.path.join(save_path,"simple.fly"))
