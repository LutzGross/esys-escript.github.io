...
\begin{verbatim}
 myPDE.setSymmetryOn()
\end{verbatim}
To input the PDE into \verb escript it must be compared with the general form equation of a linear PDE which is described by:
\begin{equation}\label{eqn:genfrm}
