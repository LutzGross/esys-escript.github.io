...
{ Point1, "Point1", 1, Point1,
     PointQuad, Point1Shape, Point1Shape,
  1, 
    { 0 },
    { -1 } },
{ Line2, "Line2", 2, Line2,
    LineQuad, Line2Shape, Line2Shape,
  2, 
    { 1, 0 },
    { -1 } },
{ Tri3, "Tri3", 3, Tri3,
    TriQuad, Tri3Shape, Tri3Shape,
  3, 
    { 1, 2, 0 },
    { 0, 2, 1 } },
{ Tet4, "Tet4", 4, Tet4,
    TetQuad, Tet4Shape, Tet4Shape,
  4, 
    { -1 },
    { -1 } },
{ Line2Face, "Line2Face", 2, Line2Face,
    PointQuad, Line2Shape, Line2Shape,
  1, 
    { 0, 1, 2 },
    { -1 } },
{ Tri3Face, "Tri3Face", 3, Tri3Face,
    LineQuad, Tri3Shape, Tri3Shape,
  2, 
    { 1, 0, 2 },
    { -1 } },
{ Tet4Face, "Tet4Face", 4, Tet4Face,
    TriQuad, Tet4Shape, Tet4Shape,
  4, 
    { 1, 2, 0, 3 },
    { 0, 2, 1, 3 } },
{ NoRef, "noElement", 0, NoRef,
    NoQuad, NoShape, NoShape,
  -1, 
    { 0 },
    { 0 } }
