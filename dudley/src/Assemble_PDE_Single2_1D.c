			    ...
			    B_q=&(B_p[INDEX3(0,0,0, DIM, p.numQuadTotal)]);
                            for (s=0;s<p.row_numShapes;s++) {
                              for (r=0;r<p.col_numShapes;r++) {
                                rtmp=0;
                                for (q=0;q<p.numQuadTotal;q++) {
                                   rtmp+=vol*DSDX[INDEX3(s,0,q,p.row_numShapesTotal,DIM)]*B_q[INDEX2(0,q,DIM)]*S[INDEX2(r,q,p.row_numShapes)];
                                }
                                EM_S[INDEX4(0,0,s,r,p.numEqu,p.numComp,p.row_numShapesTotal)]+=rtmp;
                              }
                            }
			    ...
			    D_q=&(D_p[INDEX2(0,0, p.numQuadTotal)]);
                            for (s=0;s<p.row_numShapes;s++) {
                              for (r=0;r<p.col_numShapes;r++) {
                                 rtmp=0;
                                 for (q=0;q<p.numQuadTotal;q++) {
                                    rtmp+=vol*S[INDEX2(s,q,p.row_numShapes)]*D_q[q]*S[INDEX2(r,q,p.row_numShapes)];
                                }
                                EM_S[INDEX4(0,0,s,r,p.numEqu,p.numComp,p.row_numShapesTotal)]+=rtmp;
                              }
                            }
		           ...
		           X_q=&(X_p[INDEX3(0,0,0, DIM,p.numQuadTotal)]);
                           for (s=0;s<p.row_numShapes;s++) {
                             rtmp=0;
                             for (q=0;q<p.numQuadTotal;q++) rtmp+=vol*DSDX[INDEX3(s,0,q,p.row_numShapesTotal,DIM)]*X_q[INDEX2(0,q,DIM)];
