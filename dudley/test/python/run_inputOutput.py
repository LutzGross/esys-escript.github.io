...
class Test_InputOutputOnDudley(unittest.TestCase):
     ...
     def test_readgmsh_format(self):
          print("\n reading format 2..... ")
          mydomain1 = ReadGmsh(os.path.join(DUDLEY_TEST_MESH_PATH,"Kalgoorlie.2.msh"),  numDim=3)
          print(" reading format 2.2..... ")
          mydomain2 = ReadGmsh(os.path.join(DUDLEY_TEST_MESH_PATH,"Kalgoorlie.22.msh"), numDim=3)
          print(" reading format 4.0..... ")
          mydomain3 = ReadGmsh(os.path.join(DUDLEY_TEST_MESH_PATH,"Kalgoorlie.40.msh"),  numDim=3)
          print(" reading format 4.1..... ")
          mydomain4 = ReadGmsh(os.path.join(DUDLEY_TEST_MESH_PATH,"Kalgoorlie.41.msh"),  numDim=3)
