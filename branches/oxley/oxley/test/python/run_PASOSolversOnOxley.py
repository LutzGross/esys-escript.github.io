...
class Test_SimpleSolveOxley2D_Paso_DIRECT(SimpleSolveOnPaso):
    def setUp(self):
        self.domain = Rectangle(order=2, n0=NE0*NX-1, n1=NE1*NY-1, d0=NX, d1=NY)
...
#     def setUp(self):
#         self.domain = Brick(order=2, n0=NE0*NXb-1, n1=NE1*NYb-1, n2=NE2*NZb-1, d0=NXb, d1=NYb, d2=NZb)
#         self.package = SolverOptions.PASO
