			...
			if (NULL != A_p)
			{
				...
				for (s = 0; s < p.row_numShapes; s++)
				{
					...
					for (q = 0; q < p.numQuadTotal; q++)
					{
						...
						vol * (DSDX[INDEX3(s, 0, q, p.row_numShapesTotal, DIM)] *
						       ...
						       DSDX[INDEX3(r, 1, q, p.row_numShapesTotal, DIM)] +
						       DSDX[INDEX3(s, 0, q, p.row_numShapesTotal, DIM)] *
						       A_q[INDEX3(0, 2, q, DIM, DIM)] *
						       DSDX[INDEX3(r, 2, q, p.row_numShapesTotal, DIM)] +
						       DSDX[INDEX3(s, 1, q, p.row_numShapesTotal, DIM)] *
						       ...
						       DSDX[INDEX3(r, 2, q, p.row_numShapesTotal, DIM)] +
						       DSDX[INDEX3(s, 2, q, p.row_numShapesTotal, DIM)] *
				...
				for (s = 0; s < p.row_numShapes; s++)
				{
					...
					for (q = 0; q < p.numQuadTotal; q++)
					{
					    ...
					    rtmp2 = vol * DSDX[INDEX3(s, 2, q, p.row_numShapesTotal, DIM)];
