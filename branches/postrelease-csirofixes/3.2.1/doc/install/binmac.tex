...
You will need to download both escript (\file{escript_3.2.1_osx.dmg}) and the support files (\file{escript-support_3.0_osx.dmg}).
...
A previous release (3.1) installed sucessfully on \macosx 10.6.2 (``Snow Leopard'') but we have not tested this one. 
