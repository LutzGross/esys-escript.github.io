...
temperature at a constant level $T\hackscore0=100^{\circ} C$.  As heat is
...
the temperature to $T\hackscore{0}$ at the left end of the rod where we have
$x\hackscore{0}=0$ and 
$T\hackscore{ref}$ elsewhere. Instead of \verb|whereNegative| function we now
...
have the value $T\hackscore0$ on the left hand side of the domain. As mentioned
