...
\begin{itemize}
 ...
 \item Added timeStepFormat option to esys.escript.saveESD.
 ...
 \item Efficiency improvements in esys.downunder.
 \item Removed support for VSL random (boost::random is sufficient).
