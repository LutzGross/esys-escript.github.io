...
class Test_VTKFiles(Test_VisualizationInterface):
  ...
  def test_hex_2D_macro_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro.xml"),domain=dom)
  ...
  def test_hex_2D_macro_AllPoints_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_AllPoints_Scalar.xml"),data_r=x_r[0],data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_macro_02Points_Scalar_vtk(self):
     ...
     x=Solution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_O2Points_Scalar.xml"),data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_macro_2Cells_Scalar_vtk(self):
     ...
     try: 
        saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_2Cells_Scalar.xml"),data=x[0],data_b=x_b[0])
  ...
  def test_hex_2D_macro_BoundaryPoint_Scalar_vtk(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_BoundaryPoint_Scalar.xml"),data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_hex_2D_macro_Cells_AllData_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Cells_AllData.xml"),data_s=x[0],data_v=x[0]*[1.,2.],data_t=x[0]*[[11.,12.],[21.,22.]],data_t2=x[0]*[[-11.,-12.],[-21.,-22.]])
  ...
  def test_hex_2D_macro_CellsPoints_AllData_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_CellsPoints_AllData.xml"),data_sp=x_p[0],
                                                     data_vp=x_p[0]*[1.,2.],
  ...
  def test_hex_2D_macro_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_macro_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_macro_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
     self.check_vtk("hex_2D_macro_ContinuousFunction_Tensor.xml",reference)
  def test_hex_2D_macro_Solution_Scalar_vtk(self):
     reference="hex_2D_o2p_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Solution_Scalar.xml"),data=x[0])
     self.check_vtk("hex_2D_macro_Solution_Scalar.xml",reference)
  def test_hex_2D_macro_Solution_Vector_vtk(self):
     reference="hex_2D_o2p_node_v.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Solution_Vector.xml"),data=x[0]*[1.,2.])
     self.check_vtk("hex_2D_macro_Solution_Vector.xml",reference)
  def test_hex_2D_macro_Solution_Tensor_vtk(self):
     reference="hex_2D_o2p_node_t.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Solution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_macro_ReducedSolution_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_macro_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_macro_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_macro_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_macro_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Function_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_macro_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_Function_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_macro_ReducedFunction_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_macro_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_macro_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_macro_FunctionOnBoundary_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_macro_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_macro_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_macro_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_macro_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_macro_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_macro.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_macro_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_order2p_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2.xml"),domain=dom)
     self.check_vtk("hex_2D_order2.xml",reference)
  ...
  def test_hex_2D_order2p_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_order2p_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_order2p_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
     self.check_vtk("hex_2D_order2p_ContinuousFunction_Tensor.xml",reference)
  def test_hex_2D_order2p_Solution_Scalar_vtk(self):
     reference="hex_2D_o2p_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_Solution_Scalar.xml"),data=x[0])
     self.check_vtk("hex_2D_order2p_Solution_Scalar.xml",reference)
  def test_hex_2D_order2p_Solution_Vector_vtk(self):
     reference="hex_2D_o2p_node_v.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_Solution_Vector.xml"),data=x[0]*[1.,2.])
     self.check_vtk("hex_2D_order2p_Solution_Vector.xml",reference)
  def test_hex_2D_order2p_Solution_Tensor_vtk(self):
     reference="hex_2D_o2p_node_t.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_Solution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
     self.check_vtk("hex_2D_order2p_Solution_Tensor.xml",reference)
  def test_hex_2D_order2p_ReducedSolution_Scalar_vtk(self):
     reference="hex_2D_o2p_reduced_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_order2p_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_order2p_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_order2p_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_order2p_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_Function_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_order2p_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_Function_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_order2p_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_order2p_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_order2p_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_order2p_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_order2p_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_order2p_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_2D_order2p_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_2D_order2p_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_hex_2D_order2p_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_2D_order2p.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_2D_order2p_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_hex_contact_2D_order1_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order1_onFace.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
  ...
  def test_hex_contact_2D_order2_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_2D_order2_onFace.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
  ...
  def test_hex_contact_3D_order1_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order1_onFace.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
  ...
  def test_hex_contact_3D_order2_onFace_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_contact_3D_order2_onFace.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
  ...
  def test_hex_3D_order2p_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_order2p_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_order2p_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
     self.check_vtk("hex_3D_order2p_ContinuousFunction_Tensor.xml",reference)
  def test_hex_3D_order2p_Solution_Scalar_vtk(self):
     reference="hex_3D_o2p_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_Solution_Scalar.xml"),data=x[0])
     self.check_vtk("hex_3D_order2p_Solution_Scalar.xml",reference)
  def test_hex_3D_order2p_Solution_Vector_vtk(self):
     reference="hex_3D_o2p_node_v.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_Solution_Vector.xml"),data=x[0]*[1.,2.,3.])
     self.check_vtk("hex_3D_order2p_Solution_Vector.xml",reference)
  def test_hex_3D_order2p_Solution_Tensor_vtk(self):
     reference="hex_3D_o2p_node_t.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_Solution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_order2p_ReducedSolution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_order2p_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_order2p_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_order2p_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_order2p_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_Function_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_order2p_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_Function_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_order2p_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_order2p_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_order2p_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_order2p_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_order2p_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_order2p_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_order2p_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_order2p_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_order2p_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_order2p.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_order2p_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_macro_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_macro_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_macro_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
     self.check_vtk("hex_3D_macro_ContinuousFunction_Tensor.xml",reference)
  def test_hex_3D_macro_Solution_Scalar_vtk(self):
     reference="hex_3D_macro_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_Solution_Scalar.xml"),data=x[0])
     self.check_vtk("hex_3D_macro_Solution_Scalar.xml",reference)
  def test_hex_3D_macro_Solution_Vector_vtk(self):
     reference="hex_3D_macro_node_v.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_Solution_Vector.xml"),data=x[0]*[1.,2.,3.])
     self.check_vtk("hex_3D_macro_Solution_Vector.xml",reference)
  def test_hex_3D_macro_Solution_Tensor_vtk(self):
     reference="hex_3D_macro_node_t.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_Solution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_macro_ReducedSolution_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedSolution_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_macro_ReducedSolution_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_macro_ReducedSolution_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_macro_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_Function_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_macro_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_Function_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_macro_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_Function_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_macro_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_macro_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_macro_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_macro_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_macro_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_macro_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_hex_3D_macro_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_hex_3D_macro_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_hex_3D_macro_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"hex_3D_macro.msh"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"hex_3D_macro_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_tet_2D_macro_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro.xml"),domain=dom)
  ...
  def test_tet_2D_macro_AllPoints_Scalar_vtk(self):
     ...
     x_r=ReducedSolution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_AllPoints_Scalar.xml"),data_r=x_r[0],data_n=x_n[0],data=x[0])
  ...
  def test_tet_2D_macro_02Points_Scalar_vtk(self):
     ...
     x=Solution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_O2Points_Scalar.xml"),data_n=x_n[0],data=x[0])
  ...
  def test_tet_2D_macro_2Cells_Scalar_vtk(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_2Cells_Scalar.xml"),data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_tet_2D_macro_BoundaryPoint_Scalar_vtk(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_BoundaryPoint_Scalar.xml"),data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_tet_2D_macro_Cells_AllData_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_Cells_AllData.xml"),data_s=x[0],data_v=x[0]*[1.,2.],data_t=x[0]*[[11.,12.],[21.,22.]],data_t2=x[0]*[[-11.,-12.],[-21.,-22.]])
  ...
  def test_tet_2D_macro_CellsPoints_AllData_vtk(self):
     ...
     x_c=Function(dom).getX()
     x_p=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_CellsPoints_AllData.xml"),data_sp=x_p[0],
                                                     data_vp=x_p[0]*[1.,2.],
                                                     data_tp=x_p[0]*[[11.,12.],[21.,22.]],
                                                     data_sc=x_c[0],
                                                     data_vc=x_c[0]*[1.,2.],
  ...
  def test_tet_2D_macro_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_tet_2D_macro_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_tet_2D_macro_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_Function_Scalar.xml"),data=x[0])
  ...
  def test_tet_2D_macro_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_Function_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_tet_2D_macro_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_Function_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_tet_2D_macro_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_tet_2D_macro_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_tet_2D_macro_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_tet_2D_macro_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_tet_2D_macro_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_tet_2D_macro_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_tet_2D_macro_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_tet_2D_macro_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.])
  ...
  def test_tet_2D_macro_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_2D_macro.fly"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_2D_macro_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.],[21.,22.]])
  ...
  def test_tet_3D_macro_ContinuousFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ContinuousFunction_Scalar.xml"),data=x[0])
  ...
  def test_tet_3D_macro_ContinuousFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ContinuousFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_tet_3D_macro_ContinuousFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ContinuousFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ContinuousFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
     self.check_vtk("tet_3D_macro_ContinuousFunction_Tensor.xml",reference)
  def test_tet_3D_macro_Solution_Scalar_vtk(self):
     reference="tet_3D_macro_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_Solution_Scalar.xml"),data=x[0])
     self.check_vtk("tet_3D_macro_Solution_Scalar.xml",reference)
  def test_tet_3D_macro_Solution_Vector_vtk(self):
     reference="tet_3D_macro_node_v.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_Solution_Vector.xml"),data=x[0]*[1.,2.,3.])
     self.check_vtk("tet_3D_macro_Solution_Vector.xml",reference)
  def test_tet_3D_macro_Solution_Tensor_vtk(self):
     reference="tet_3D_macro_node_t.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=Solution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_Solution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
     self.check_vtk("tet_3D_macro_Solution_Tensor.xml",reference)
  def test_tet_3D_macro_ReducedSolution_Scalar_vtk(self):
     reference="tet_3D_o1_node_s.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedSolution_Scalar.xml"),data=x[0])
     self.check_vtk("tet_3D_macro_ReducedSolution_Scalar.xml",reference)
  def test_tet_3D_macro_ReducedSolution_Vector_vtk(self):
     reference="tet_3D_o1_node_v.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedSolution_Vector.xml"),data=x[0]*[1.,2.,3.])
     self.check_vtk("tet_3D_macro_ReducedSolution_Vector.xml",reference)
  def test_tet_3D_macro_ReducedSolution_Tensor_vtk(self):
     reference="tet_3D_o1_node_t.xml"
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedSolution(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedSolution_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_tet_3D_macro_Function_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_Function_Scalar.xml"),data=x[0])
  ...
  def test_tet_3D_macro_Function_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_Function_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_tet_3D_macro_Function_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=Function(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_Function_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_tet_3D_macro_ReducedFunction_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedFunction_Scalar.xml"),data=x[0])
  ...
  def test_tet_3D_macro_ReducedFunction_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedFunction_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_tet_3D_macro_ReducedFunction_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedFunction(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedFunction_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_tet_3D_macro_FunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_FunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_tet_3D_macro_FunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_FunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_tet_3D_macro_FunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=FunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_FunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
  ...
  def test_tet_3D_macro_ReducedFunctionOnBoundary_Scalar_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedFunctionOnBoundary_Scalar.xml"),data=x[0])
  ...
  def test_tet_3D_macro_ReducedFunctionOnBoundary_Vector_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedFunctionOnBoundary_Vector.xml"),data=x[0]*[1.,2.,3.])
  ...
  def test_tet_3D_macro_ReducedFunctionOnBoundary_Tensor_vtk(self):
     ...
     dom=ReadMesh(os.path.join(FINLEY_TEST_MESH_PATH,"tet_3D_macro.fly"),optimize=False)
     x=ReducedFunctionOnBoundary(dom).getX()
     saveVTK(os.path.join(FINLEY_WORKDIR_PATH,"tet_3D_macro_ReducedFunctionOnBoundary_Tensor.xml"),data=x[0]*[[11.,12.,13.],[21.,22.,23],[31.,32.,33.]])
