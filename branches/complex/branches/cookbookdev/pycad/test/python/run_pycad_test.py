...
class Test_PyCAD_Transformations(unittest.TestCase):
   ...
   def test_Translation_x(self):
        ...
        self.failUnless(self.__distance(s0,numpy.array([2,0,0]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([1,1,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([1,0,1]))<self.ABS_TOL,"s2 is wrong.")
   def test_Translation_y(self):
        t=Translation([0,1,0])
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([1,1,0]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0,2,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0,1,1]))<self.ABS_TOL,"s2 is wrong.")
   def test_Translation_z(self):
        t=Translation([0,0,1])
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([1,0,1]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0,1,1]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0,0,2]))<self.ABS_TOL,"s2 is wrong.")
   ...
   def test_Dilation_0_half(self):
        ...
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([0.5,0,0]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0,0.5,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0,0,0.5]))<self.ABS_TOL,"s2 is wrong.")
   def test_Dilation_x_two(self):
        ...
        s0_1=t([0,0,0])
        self.failUnless(isinstance(s0_1,numpy.ndarray),"s0_1 is not an ndarray object.")
        self.failUnless(self.__distance(s0_1,numpy.array([-1.,0,0]))<self.ABS_TOL,"s0_1 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([-1,2,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([-1.,0,2]))<self.ABS_TOL,"s2 is wrong.")
   def test_Dilation_x_half(self):
        ...
        s0_1=t([0,0,0])
        self.failUnless(isinstance(s0_1,numpy.ndarray),"s0_1 is not an ndarray object.")
        self.failUnless(self.__distance(s0_1,numpy.array([.5,0,0]))<self.ABS_TOL,"s0_1 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.5,0.5,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.5,0,0.5]))<self.ABS_TOL,"s2 is wrong.")
   def test_Dilation_y_two(self):
        t=Dilation(2.,[0.,1.,0.])
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([2.,-1.,0]))<self.ABS_TOL,"s0 is wrong.")
        s1_1=t([0,0,0])
        self.failUnless(isinstance(s1_1,numpy.ndarray),"s1_1 is not an ndarray object.")
        self.failUnless(self.__distance(s1_1,numpy.array([0.,-1.,0]))<self.ABS_TOL,"s1_1 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,1.,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.,-1.,2]))<self.ABS_TOL,"s2 is wrong.")
   def test_Dilation_y_half(self):
        t=Dilation(0.5,[0.,1.,0.])
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([0.5,0.5,0]))<self.ABS_TOL,"s0 is wrong.")
        s1_1=t([0,0,0])
        self.failUnless(isinstance(s1_1,numpy.ndarray),"s1_1 is not an ndarray object.")
        self.failUnless(self.__distance(s1_1,numpy.array([0,0.5,0]))<self.ABS_TOL,"s1_1 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,1.,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.,0.5,0.5]))<self.ABS_TOL,"s2 is wrong.")
   def test_Dilation_z_two(self):
        t=Dilation(2.,[0.,0.,1.])
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([2.,0.,-1.]))<self.ABS_TOL,"s0 is wrong.")
        s2_1=t([0,0,0])
        self.failUnless(isinstance(s2_1,numpy.ndarray),"s2_1 is not an ndarray object.")
        self.failUnless(self.__distance(s2_1,numpy.array([0.,0.,-1.]))<self.ABS_TOL,"s2_1 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,2.,-1.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
   ...
   def test_Dilation_z_half(self):
        ...
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([0.5,0.,0.5]))<self.ABS_TOL,"s0 is wrong.")
        s2_1=t([0,0,0])
        self.failUnless(isinstance(s2_1,numpy.ndarray),"s2_1 is not an ndarray object.")
        self.failUnless(self.__distance(s2_1,numpy.array([0,0,0.5]))<self.ABS_TOL,"s2_1 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,0.5,0.5]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.,0.,1.]))<self.ABS_TOL,"s2 is wrong.")
   def test_Reflection_x_offset0(self):
        ...
        self.failUnless(self.__distance(s,numpy.array([-1.,2,3]))<self.ABS_TOL,"s is wrong.")
   def test_Reflection_x_offset2(self):
        t=Reflection([-2.,0.,0.],offset=-4)
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([3.,0,0.]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([4,1,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([4,0,1]))<self.ABS_TOL,"s2 is wrong.")
        s=t([1,2,3])
        self.failUnless(isinstance(s,numpy.ndarray),"s is not an ndarray object.")
        self.failUnless(self.__distance(s,numpy.array([3.,2,3]))<self.ABS_TOL,"s is wrong.")
   ...
   def test_Reflection_y_offset2(self):
        ...
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([1.,4,0.]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0,3,0]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0,4,1]))<self.ABS_TOL,"s2 is wrong.")
        s=t([1,2,3])
        self.failUnless(isinstance(s,numpy.ndarray),"s is not an ndarray object.")
        self.failUnless(self.__distance(s,numpy.array([1.,2,3]))<self.ABS_TOL,"s is wrong.")
   ...
   def test_Reflection_z_offset2(self):
        ...
        s0=t([1,0,0])
        self.failUnless(isinstance(s0,numpy.ndarray),"s0 is not an ndarray object.")
        self.failUnless(self.__distance(s0,numpy.array([1.,0,4.]))<self.ABS_TOL,"s0 is wrong.")
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0,1,4]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0,0,3]))<self.ABS_TOL,"s2 is wrong.")
        s=t([1,2,3])
        self.failUnless(isinstance(s,numpy.ndarray),"s is not an ndarray object.")
   ...
   def test_Rotatation_x_90_0(self):
        ...
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,0,1.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
   ...
   def test_Rotatation_x_30_0(self):
        ...
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(abs(numpy.dot(s1,s1)-1.)<self.ABS_TOL,"s1 length is wrong.")
        self.failUnless(abs(s1[1]-math.cos(30*DEG))<self.ABS_TOL,"s1 angle is wrong.")
        self.failUnless(numpy.dot(_cross(s1,[0,1,0]),numpy.array([1.,0.,0.]))<0.,"s1 has wrong orientation.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
   ...
   def test_Rotatation_y_90_0(self):
        ...
        s1=t([0,5,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,5,0.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
   ...
   def test_Rotatation_y_30_0(self):
        ...
        self.failUnless(numpy.dot(_cross(s0,[1,0,0]),numpy.array([0.,1.,0.]))<0.,"s0 has wrong orientation.")
        s1=t([0,5,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,5,0.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
   ...
   def test_Rotatation_z_90_0(self):
        ...
        s1=t([0,5,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([-5.,0,0.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.,0,1.]))<self.ABS_TOL,"s2 is wrong.")
   def test_Rotatation_z_30_0(self):
        ...
        self.failUnless(abs(numpy.dot(s0,s0)-1.)<self.ABS_TOL,"s0 length is wrong.")
        self.failUnless(abs(s0[0]-math.cos(30*DEG))<self.ABS_TOL,"s0 angle is wrong.")
        self.failUnless(numpy.dot(_cross(s0,[1,0,0]),numpy.array([0.,0.,1.]))<0.,"s0 has wrong orientation.")
        s1=t([0,5,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        ...
        self.failUnless(numpy.dot(_cross(s1,[0,5,0]),numpy.array([0.,0.,1.]))<0.,"s1 has wrong orientation.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.,0,1.]))<self.ABS_TOL,"s2 is wrong.")
   ...
   def test_Rotatation_x_90_1(self):
        ...
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([0.,1,2.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(self.__distance(s2,numpy.array([0.,0,1.]))<self.ABS_TOL,"s2 is wrong.")
   def test_Rotatation_y_90_1(self):
        ...
        s1=t([0,1,0])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(self.__distance(s1,numpy.array([1.,1,1.]))<self.ABS_TOL,"s1 is wrong.")
        s2=t([0,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
   ...
   def test_Rotatation_diag_90_0(self):
        ...
        self.failUnless(abs(numpy.dot(s0,numpy.array([1,-1,0])))<self.ABS_TOL,"s0 angle is wrong.")
        self.failUnless(numpy.dot(_cross(s0,[1,-1,0]),numpy.array([1.,1.,1.]))<0.,"s0 has wrong orientation.")
        s1=t([0,1,-1])
        self.failUnless(isinstance(s1,numpy.ndarray),"s1 is not an ndarray object.")
        self.failUnless(abs(numpy.dot(s1,s1)-2.)<self.ABS_TOL,"s1 length is wrong.")
        self.failUnless(abs(numpy.dot(s1,numpy.array([0,1,-1])))<self.ABS_TOL,"s1 angle is wrong.")
        self.failUnless(numpy.dot(_cross(s1,[0,1,-1]),numpy.array([1.,1.,1.]))<0.,"s1 has wrong orientation.")
        s2=t([-1,0,1])
        self.failUnless(isinstance(s2,numpy.ndarray),"s2 is not an ndarray object.")
        self.failUnless(abs(numpy.dot(s2,s2)-2.)<self.ABS_TOL,"s2 length is wrong.")
        self.failUnless(abs(numpy.dot(s2,numpy.array([-1,0,1])))<self.ABS_TOL,"s2 angle is wrong.")
        self.failUnless(numpy.dot(_cross(s2,[-1,0,1]),numpy.array([1.,1.,1.]))<0.,"s2 has wrong orientation.")
        s3=t([1,1,1])
        self.failUnless(isinstance(s3,numpy.ndarray),"s3 is not an ndarray object.")
        self.failUnless(self.__distance(s3,numpy.array([1.,1,1.]))<self.ABS_TOL,"s3 is wrong.")
...
class Test_PyCAD_Primitives(unittest.TestCase):
   ...
   def test_Point(self):
       ...
       # check coordinates:
       c=p.getCoordinates()
       self.failUnless(isinstance(c,numpy.ndarray),"coordinates are not an ndarray object.")
       ...
       c=p.getCoordinates()
       self.failUnless(isinstance(c,numpy.ndarray),"new coordinates are not an ndarray object.")
       ...
       self.failUnless(not p.isColocated(numpy.array([-1.,-2.,-3.])),"colocation with ndarray representation not detected.")
       ...
       self.failUnless(shift_p.isColocated(Point(2,3.,4)),"applying shift by ndarray failed")
       self.failUnless(not shift_p.getID() == p.getID(),"shift by ndarray has same Id")
       self.failUnless(shift_p.getLocalScale()==3.,"shift by ndarray has wrong local scale.")
       # overloaded minus
       shift_p=p-[1,1,1]
       ...
       shift_p=p-numpy.array([1,1,1])
       self.failUnless(shift_p.isColocated(Point(0,1,2.)),"applying shift by -ndarray failed")
       self.failUnless(not shift_p.getID() == p.getID(),"shift by -ndarray has same Id")
       self.failUnless(shift_p.getLocalScale()==3.,"shift by -ndarray has wrong local scale.")
       ...
       p+=numpy.array([1,1,1])
       self.failUnless(p.isColocated(Point(3,4,5)),"modification by ndarray shift failed")
       ...
       p-=numpy.array([1,1,1])
       self.failUnless(p.isColocated(Point(1,2.,3)),"modification by -ndarray shift failed")
...
class Test_PyCAD_Design(unittest.TestCase):
   ...
   def test_GMSH(self):
       ...
       self.failUnless("gmsh -format msh -2 -algo tetgen -smooth 4 -v 3 -order 1 -o %s %s"%(os.path.join(".","mesh.msh"), os.path.join(".","script.geo")) == cmd%os.path.join(".","script.geo"))

       d.setOptions(optimize_quality=True)
       cmd=d.getCommandString()
       self.failUnless("gmsh -format msh -2 -algo iso -smooth 1 -optimize -v 3 -order 1 -o %s %s"%(os.path.join(".","mesh.msh"), os.path.join(".","script.geo")) == cmd%os.path.join(".","script.geo"))
