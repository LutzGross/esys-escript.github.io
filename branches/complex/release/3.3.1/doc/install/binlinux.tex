...
For example, \file{escript-3.3.1-1-squeeze_amd64.deb} would be the file for squeeze for 64bit processors.
...
\begin{enumerate}
 \item escript itself (\file{escript_3.3.1_i386.tar.bz2})\footnotemark\ from launchpad.net.\addtocounter{footnote}{-1}
