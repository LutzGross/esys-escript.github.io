...
\emph{This information is accurate as far as we can tell at time of writing but things may change.}
...
The options file we provide as an example below uses \texttt{clang} as its compiler.
If you wish to use \texttt{g++}, then you will need to modify the 
\begin{verbatim}
tools_names = ['clang']
\end{verbatim}
to
...
\texttt{scons/os/freebsd10.0_options.py}.
