...
BOOST_PYTHON_MODULE(brucecpp)
{
  ...
  class_<bruce::Bruce, bases<escript::AbstractContinuousDomain> >
      ("Bruce",init<>())
      ...
      .def("getNumSamples",&bruce::Bruce::getNumSamples)
      .def("getNumDataPointsPerSample",&bruce::Bruce::getNumDataPointsPerSample)
      .def("getX",&bruce::Bruce::getX)
      .def("setToX",&bruce::Bruce::setToX)
      .def("getSize",&bruce::Bruce::getSize)
      .def("setToSize",&bruce::Bruce::setToSize)
      .def("getTagFromSampleNo",&bruce::Bruce::getTagFromSampleNo)
      .def("getReferenceNoFromSampleNo",&bruce::Bruce::getReferenceNoFromSampleNo)
      .def("saveVTK",&bruce::Bruce::saveVTK)
