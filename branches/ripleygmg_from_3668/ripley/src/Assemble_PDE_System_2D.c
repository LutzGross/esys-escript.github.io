...
/*                                                                                                            */
/*    u is a scalar in a 2D domain. The shape functions for test and solution must be identical  */
/*                                                                                                            */
...
#endif
/**************************************************************/
void  Finley_Assemble_PDE_System_2D(Finley_Assemble_Parameters p,
                           ...
                           if (extendedA) {
                              for (k=0;k<p.numEqu;k++) {
                                 for (m=0;m<p.numComp;m++) {
                                    ...
                                    EM_S[INDEX4(k,m,0,1,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp1_1 + tmp2_1 + tmp3_1 + tmp4_1 + tmp5_1 + tmp6_1 + tmp7_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,1,2,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp11_1 + tmp12_1 + tmp13_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,3,2,p.numEqu,p.numComp,4)]+=tmp14_1 + tmp15_1 + tmp16_1 + tmp17_1 + tmp18_1 + tmp19_1 + tmp1_1 + tmp5_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,0,0,p.numEqu,p.numComp,4)]+=tmp13_1 + tmp20_1 + tmp21_1 + tmp22_1 + tmp23_1 + tmp24_1 + tmp25_1;
                                    EM_S[INDEX4(k,m,3,3,p.numEqu,p.numComp,4)]+=tmp13_1 + tmp26_1 + tmp27_1 + tmp28_1 + tmp29_1 + tmp30_1 + tmp31_1;
                                    EM_S[INDEX4(k,m,3,0,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp32_1 + tmp33_1 + tmp34_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,3,1,p.numEqu,p.numComp,4)]+=tmp35_1 + tmp36_1 + tmp37_1 + tmp38_1 + tmp39_1 + tmp40_1 + tmp41_1 + tmp42_1 + tmp43_1;
                                    EM_S[INDEX4(k,m,2,1,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp13_1 + tmp44_1 + tmp45_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,0,2,p.numEqu,p.numComp,4)]+=tmp36_1 + tmp38_1 + tmp43_1 + tmp46_1 + tmp47_1 + tmp48_1 + tmp49_1 + tmp50_1 + tmp51_1;
                                    EM_S[INDEX4(k,m,2,0,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp15_1 + tmp17_1 + tmp1_1 + tmp38_1 + tmp49_1 + tmp51_1 + tmp7_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,1,3,p.numEqu,p.numComp,4)]+=tmp14_1 + tmp19_1 + tmp1_1 + tmp2_1 + tmp38_1 + tmp40_1 + tmp42_1 + tmp4_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,2,3,p.numEqu,p.numComp,4)]+=tmp16_1 + tmp18_1 + tmp35_1 + tmp36_1 + tmp41_1 + tmp43_1 + tmp47_1 + tmp48_1 + tmp5_1;
                                    EM_S[INDEX4(k,m,2,2,p.numEqu,p.numComp,4)]+=tmp24_1 + tmp25_1 + tmp27_1 + tmp29_1 + tmp33_1 + tmp52_1 + tmp53_1;
                                    EM_S[INDEX4(k,m,1,0,p.numEqu,p.numComp,4)]+=tmp36_1 + tmp37_1 + tmp39_1 + tmp3_1 + tmp43_1 + tmp46_1 + tmp50_1 + tmp5_1 + tmp6_1;
                                    EM_S[INDEX4(k,m,0,3,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp33_1 + tmp54_1 + tmp55_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,1,1,p.numEqu,p.numComp,4)]+=tmp21_1 + tmp23_1 + tmp30_1 + tmp31_1 + tmp33_1 + tmp56_1 + tmp57_1;
                                 }
                              }
                           } else { /* constant data */
                              for (k=0;k<p.numEqu;k++) {
                                 for (m=0;m<p.numComp;m++) {
                                    ...
                                    EM_S[INDEX4(k,m,0,0,p.numEqu,p.numComp,4)]+=tmp5_1 + tmp7_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,3,3,p.numEqu,p.numComp,4)]+=tmp5_1 + tmp7_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,3,0,p.numEqu,p.numComp,4)]+=tmp4_1 + tmp6_1 + tmp9_1;
                                    ...
                                    EM_S[INDEX4(k,m,2,0,p.numEqu,p.numComp,4)]+=tmp11_1 + tmp12_1 + tmp1_1 + tmp2_1;
                                    EM_S[INDEX4(k,m,1,3,p.numEqu,p.numComp,4)]+=tmp11_1 + tmp12_1 + tmp1_1 + tmp2_1;
                                    EM_S[INDEX4(k,m,2,3,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp10_1 + tmp13_1 + tmp3_1;
                                    EM_S[INDEX4(k,m,2,2,p.numEqu,p.numComp,4)]+=tmp7_1 + tmp8_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,1,0,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp10_1 + tmp13_1 + tmp3_1;
                                    EM_S[INDEX4(k,m,0,3,p.numEqu,p.numComp,4)]+=tmp4_1 + tmp6_1 + tmp9_1;
                           ...
                           if (extendedB) {
                              for (k=0;k<p.numEqu;k++) {
                                 for (m=0;m<p.numComp;m++) {
                                    ...
                                    EM_S[INDEX4(k,m,1,2,p.numEqu,p.numComp,4)]+=tmp6_1 + tmp7_1 + tmp8_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,3,2,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp11_1 + tmp12_1 + tmp13_1 + tmp14_1 + tmp15_1;
                                    EM_S[INDEX4(k,m,0,0,p.numEqu,p.numComp,4)]+=tmp16_1 + tmp17_1 + tmp18_1 + tmp19_1 + tmp20_1 + tmp21_1 + tmp22_1 + tmp23_1;
                                    EM_S[INDEX4(k,m,3,3,p.numEqu,p.numComp,4)]+=tmp24_1 + tmp25_1 + tmp26_1 + tmp27_1 + tmp28_1 + tmp29_1 + tmp30_1 + tmp31_1;
                                    EM_S[INDEX4(k,m,3,0,p.numEqu,p.numComp,4)]+=tmp32_1 + tmp33_1 + tmp6_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,3,1,p.numEqu,p.numComp,4)]+=tmp34_1 + tmp35_1 + tmp36_1 + tmp37_1 + tmp38_1 + tmp39_1;
                                    EM_S[INDEX4(k,m,2,1,p.numEqu,p.numComp,4)]+=tmp32_1 + tmp33_1 + tmp40_1 + tmp41_1;
                                    EM_S[INDEX4(k,m,0,2,p.numEqu,p.numComp,4)]+=tmp42_1 + tmp43_1 + tmp44_1 + tmp45_1 + tmp46_1 + tmp47_1;
                                    EM_S[INDEX4(k,m,2,0,p.numEqu,p.numComp,4)]+=tmp45_1 + tmp47_1 + tmp48_1 + tmp49_1 + tmp50_1 + tmp51_1;
                                    EM_S[INDEX4(k,m,1,3,p.numEqu,p.numComp,4)]+=tmp37_1 + tmp39_1 + tmp52_1 + tmp53_1 + tmp54_1 + tmp55_1;
                                    EM_S[INDEX4(k,m,2,3,p.numEqu,p.numComp,4)]+=tmp11_1 + tmp12_1 + tmp56_1 + tmp57_1 + tmp58_1 + tmp59_1;
                                    EM_S[INDEX4(k,m,2,2,p.numEqu,p.numComp,4)]+=tmp60_1 + tmp61_1 + tmp62_1 + tmp63_1 + tmp64_1 + tmp65_1 + tmp66_1 + tmp67_1;
                                    EM_S[INDEX4(k,m,1,0,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp1_1 + tmp68_1 + tmp69_1 + tmp70_1 + tmp71_1;
                                    EM_S[INDEX4(k,m,0,3,p.numEqu,p.numComp,4)]+=tmp40_1 + tmp41_1 + tmp7_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,1,1,p.numEqu,p.numComp,4)]+=tmp72_1 + tmp73_1 + tmp74_1 + tmp75_1 + tmp76_1 + tmp77_1 + tmp78_1 + tmp79_1;
                                 }
                              }
                           } else { /* constant data */
                              for (k=0;k<p.numEqu;k++) {
                                 for (m=0;m<p.numComp;m++) {
                                    ...
                                    EM_S[INDEX4(k,m,3,3,p.numEqu,p.numComp,4)]+=tmp3_1 + tmp6_1;
                                    EM_S[INDEX4(k,m,3,0,p.numEqu,p.numComp,4)]+=tmp2_1 + tmp4_1;
                                    EM_S[INDEX4(k,m,3,1,p.numEqu,p.numComp,4)]+=tmp2_1 + tmp6_1;
                                    EM_S[INDEX4(k,m,2,1,p.numEqu,p.numComp,4)]+=tmp4_1 + tmp7_1;
                                    ...
                                    EM_S[INDEX4(k,m,2,3,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp4_1;
                                    ...
                                    EM_S[INDEX4(k,m,1,1,p.numEqu,p.numComp,4)]+=tmp3_1 + tmp5_1;
                                 }
                              }
                           }
                        }
                           ...
                           if (extendedC) {
                              for (k=0;k<p.numEqu;k++) {
                                 for (m=0;m<p.numComp;m++) {
                                    ...
                                    EM_S[INDEX4(k,m,0,0,p.numEqu,p.numComp,4)]+=tmp16_1 + tmp17_1 + tmp18_1 + tmp19_1 + tmp20_1 + tmp21_1 + tmp22_1 + tmp23_1;
                                    EM_S[INDEX4(k,m,3,3,p.numEqu,p.numComp,4)]+=tmp24_1 + tmp25_1 + tmp26_1 + tmp27_1 + tmp28_1 + tmp29_1 + tmp30_1 + tmp31_1;
                                    EM_S[INDEX4(k,m,3,0,p.numEqu,p.numComp,4)]+=tmp32_1 + tmp33_1 + tmp7_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,3,1,p.numEqu,p.numComp,4)]+=tmp34_1 + tmp35_1 + tmp36_1 + tmp37_1 + tmp38_1 + tmp39_1;
                                    EM_S[INDEX4(k,m,2,1,p.numEqu,p.numComp,4)]+=tmp32_1 + tmp33_1 + tmp40_1 + tmp41_1;
                                    EM_S[INDEX4(k,m,0,2,p.numEqu,p.numComp,4)]+=tmp42_1 + tmp43_1 + tmp44_1 + tmp45_1 + tmp46_1 + tmp47_1;
                                    EM_S[INDEX4(k,m,2,0,p.numEqu,p.numComp,4)]+=tmp46_1 + tmp47_1 + tmp48_1 + tmp49_1 + tmp50_1 + tmp51_1;
                                    EM_S[INDEX4(k,m,1,3,p.numEqu,p.numComp,4)]+=tmp37_1 + tmp38_1 + tmp52_1 + tmp53_1 + tmp54_1 + tmp55_1;
                                    EM_S[INDEX4(k,m,2,3,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp11_1 + tmp56_1 + tmp57_1 + tmp58_1 + tmp59_1;
                                    EM_S[INDEX4(k,m,2,2,p.numEqu,p.numComp,4)]+=tmp60_1 + tmp61_1 + tmp62_1 + tmp63_1 + tmp64_1 + tmp65_1 + tmp66_1 + tmp67_1;
                                    EM_S[INDEX4(k,m,1,0,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp2_1 + tmp68_1 + tmp69_1 + tmp70_1 + tmp71_1;
                                    EM_S[INDEX4(k,m,0,3,p.numEqu,p.numComp,4)]+=tmp40_1 + tmp41_1 + tmp6_1 + tmp8_1;
                                    EM_S[INDEX4(k,m,1,1,p.numEqu,p.numComp,4)]+=tmp72_1 + tmp73_1 + tmp74_1 + tmp75_1 + tmp76_1 + tmp77_1 + tmp78_1 + tmp79_1;
                                 }
                              }
                           } else { /* constant data */
                           ...
                           if (extendedD) {
                              for (k=0;k<p.numEqu;k++) {
                                 for (m=0;m<p.numComp;m++) {
                                    ...
                                    EM_S[INDEX4(k,m,0,1,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp1_1;
                                    EM_S[INDEX4(k,m,1,2,p.numEqu,p.numComp,4)]+=tmp2_1;
                                    EM_S[INDEX4(k,m,3,2,p.numEqu,p.numComp,4)]+=tmp3_1 + tmp4_1;
                                    EM_S[INDEX4(k,m,0,0,p.numEqu,p.numComp,4)]+=tmp5_1 + tmp6_1 + tmp7_1;
                                    EM_S[INDEX4(k,m,3,3,p.numEqu,p.numComp,4)]+=tmp5_1 + tmp8_1 + tmp9_1;
                                    EM_S[INDEX4(k,m,3,0,p.numEqu,p.numComp,4)]+=tmp2_1;
                                    EM_S[INDEX4(k,m,3,1,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp11_1;
                                    EM_S[INDEX4(k,m,2,1,p.numEqu,p.numComp,4)]+=tmp2_1;
                                    EM_S[INDEX4(k,m,0,2,p.numEqu,p.numComp,4)]+=tmp12_1 + tmp13_1;
                                    EM_S[INDEX4(k,m,2,0,p.numEqu,p.numComp,4)]+=tmp12_1 + tmp13_1;
                                    EM_S[INDEX4(k,m,1,3,p.numEqu,p.numComp,4)]+=tmp10_1 + tmp11_1;
                                    EM_S[INDEX4(k,m,2,3,p.numEqu,p.numComp,4)]+=tmp3_1 + tmp4_1;
                                    EM_S[INDEX4(k,m,2,2,p.numEqu,p.numComp,4)]+=tmp14_1 + tmp15_1 + tmp16_1;
                                    EM_S[INDEX4(k,m,1,0,p.numEqu,p.numComp,4)]+=tmp0_1 + tmp1_1;
                                    EM_S[INDEX4(k,m,0,3,p.numEqu,p.numComp,4)]+=tmp2_1;
                                    EM_S[INDEX4(k,m,1,1,p.numEqu,p.numComp,4)]+=tmp14_1 + tmp17_1 + tmp18_1;
                                 }
                              }
                           } else { /* constant data */
                              for (k=0;k<p.numEqu;k++) {
                        ...
                        if (NULL!=X_p) {
                           ...
                           if (extendedX) {
                              ...
                              for (k=0;k<p.numEqu;k++) {
                                 ...
                                 EM_F[INDEX2(k,1,p.numEqu)]+=tmp0_1 + tmp2_1;
                                 EM_F[INDEX2(k,2,p.numEqu)]+=tmp1_1 + tmp3_1;
                        ...
                        if (NULL!=Y_p) {
                           ...
                           if (extendedY) {
                              for (k=0;k<p.numEqu;k++) {
                                 ...
                                 EM_F[INDEX2(k,1,p.numEqu)]+=tmp3_1 + tmp4_1 + tmp5_1;
                                 EM_F[INDEX2(k,2,p.numEqu)]+=tmp4_1 + tmp6_1 + tmp7_1;
                                 EM_F[INDEX2(k,3,p.numEqu)]+=tmp1_1 + tmp8_1 + tmp9_1;
                              }
                           } else { /* constant data */
                              for (k=0;k<p.numEqu;k++) {
