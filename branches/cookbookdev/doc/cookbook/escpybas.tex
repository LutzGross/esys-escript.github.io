...
The \esys  library tree has three main modules, \verb escript , \verb finley  and \verb pycad . These three modules contain the bulk of the \esc package functions and data structures.
\begin{enumerate}
...
\end{figure}
When the domain variables are submitted to the domain constructor or meshing algorithm, three function spaces are also created (Figure \ref{fig:fs.}) They are;
\begin{enumerate}
