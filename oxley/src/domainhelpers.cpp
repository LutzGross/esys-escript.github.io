    ...
    try {
        ...
        switch(e.error()) {
            case boost::iostreams::gzip::zlib_error:
                throw OxleyException("Decompressing failed with: zlib error");
            case boost::iostreams::gzip::bad_crc:
                throw OxleyException("Decompressing failed with: CRC error");
            case boost::iostreams::gzip::bad_length:
                throw OxleyException("Decompressing failed with: bad length");
            case boost::iostreams::gzip::bad_header:
                throw OxleyException("Decompressing failed with: bad header");
            case boost::iostreams::gzip::bad_footer:
                throw OxleyException("Decompressing failed with: bad footer");
        }
    }
    return decompressed;
}
