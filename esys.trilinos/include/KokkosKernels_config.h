...
#define KOKKOSKERNELS_VERSION 40701
#define KOKKOSKERNELS_VERSION_MAJOR 4
#define KOKKOSKERNELS_VERSION_MINOR 7
#define KOKKOSKERNELS_VERSION_PATCH 1
...
/* #undef KOKKOSKERNELS_ENABLE_BENCHMARKS */
...
#define KOKKOSKERNELS_INST_COMPLEX_DOUBLE
...
/* #undef MKL_PROVIDES_BLAS_LAPACK */
...
/* Enabled components */
#define KOKKOSKERNELS_ENABLE_COMPONENT_BATCHED
#define KOKKOSKERNELS_ENABLE_COMPONENT_BLAS
#define KOKKOSKERNELS_ENABLE_COMPONENT_LAPACK
#define KOKKOSKERNELS_ENABLE_COMPONENT_SPARSE
#define KOKKOSKERNELS_ENABLE_COMPONENT_GRAPH
#define KOKKOSKERNELS_ENABLE_COMPONENT_ODE
