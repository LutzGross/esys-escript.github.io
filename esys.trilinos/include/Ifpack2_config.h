...
#define HAVE_IFPACK2_BELOS

/* Define if we have Galeri */
#define HAVE_IFPACK2_GALERI
...
/* Define if building with METIS */
/* #undef HAVE_IFPACK2_METIS */
