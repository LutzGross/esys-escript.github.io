...
struct Finley_Mesh {
  ...
  TagMap tagMap;                 // the tag map mapping names to tag keys
...
// interfaces:
Finley_Mesh* Finley_Mesh_alloc(char* name,int numDim, Esys_MPIInfo *mpi_info);
...
Finley_Mesh* Finley_Mesh_read(char*,int, int, bool_t);
Finley_Mesh* Finley_Mesh_readGmsh(char*,int, int, int, bool_t, bool_t);
...
void Finley_Mesh_createMappings(Finley_Mesh* in, const int *dof_distribution, const int *node_distribution);
