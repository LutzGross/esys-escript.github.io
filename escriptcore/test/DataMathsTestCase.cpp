...
void DataMathsTestCase::testMatMult()
{
    ...
    DataTypes::FloatVectorType leftData(DataTypes::noValues(leftShape),0);
//     DataArrayView leftDataView(leftData,leftShape);

    DataTypes::ShapeType rightShape;
    rightShape.push_back(3);
    rightShape.push_back(2);
    DataTypes::FloatVectorType rightData(DataTypes::noValues(rightShape),0);
//     DataArrayView rightDataView(rightData,rightShape);
    ...
    DataTypes::FloatVectorType resultData(DataTypes::noValues(resultShape),0);
...
void DataMathsTestCase::testUnaryOp()
{
...

  {
    ...
    int npoints=4;
    DataTypes::FloatVectorType data(DataTypes::noValues(shape)*npoints,0);
...
{
  {
    ...
    int npoints=4;
    DataTypes::FloatVectorType data1(DataTypes::noValues(shape)*npoints,0);
    DataTypes::FloatVectorType data2(DataTypes::noValues(shape)*npoints,0);
