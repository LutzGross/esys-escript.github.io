...
cxx='mpiicpc'
cxx_extra=' -I/sw/intel/compilers_and_libraries_2018.1.163/linux/mkl/include '
# cxx_extra+=' -march=native -lto '
domains=['finley','oxley','ripley','speckley']
gmsh=1
lapack=True
lapack_prefix=['/sw/intel/compilers_and_libraries_2018.1.163/linux/mkl/include','/sw/intel/compilers_and_libraries_2018.1.163/linux/mkl/lib/intel64']
launcher = "srun --nodes=%n --ntasks=%N --ntasks-per-node=%p --cpus-per-task=%t --cpu_bind=quiet %b"
ld_extra = '-ipo-separate -shared-intel -L/sw/intel/compilers_and_libraries_2018.1.163/linux/mkl/lib/intel64 -L/sw/libs/hdf5/1.8.14/lib'
ld_extra += ' -wd11021 -wd3180 -wd161 -Wno-unknown-pragmas -wd11012 ' 
ld_extra += ' -L/sw/libs/hdf5/1.8.14/lib/ -lhdf5 -L/sw/intel/compilers_and_libraries_2018.1.163/linux/mkl/lib/intel64'
mkl = True
...
silo_libs=['siloh5']
trilinos=1
trilinos_prefix='/home/uqaeller/6/escript_trilinos'
use_p4est=0
umfpack=0
use_p4est=1
verbose=0
