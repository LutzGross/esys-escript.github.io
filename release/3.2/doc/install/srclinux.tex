...
To compile matplotlib you will also need the following\footnote{For Debian and Ubuntu users, installing \file{libfreetype6-dev} and \file{libpng-dev} will be sufficient.} (if your distribution separates development files,
...
% The packages can be downloaded independently or in the \file{escript-support-visi-3-src}.
...
% \end{shellCode}
% 
% Now edit the \file{CMakeCache.txt} file and make the following changes.
% Where .... appears please replace it with the absolute path to the pkg directory.
% For example, replace \file{CMAKE_INSTALL_PREFIX:PATH=..../vtk-5.2.1} with
% \file{CMAKE_INSTALL_PREFIX:PATH=/home/bob/stand/pkg/vtk-5.2.1}
...
% \end{shellCode}
% 
% Edit \file{CMakeCache.txt} and change the following variables:
% 
% \begin{shellCode}
...
You will need to edit your options file and specify where to find python, boost and netcdf.
...
should be
\begin{python}
python_prefix = ['x/stand/pkg/python/include/python2.6', 'x/stand/pkg/python/lib']
\end{python}
...
should be
\begin{python}
boost_libs= ['boost_python-gcc43-mt-1_39']
\end{python}
...
should be
\begin{python}
netcdf_prefix = ['x/stand/pkg/netcdf/include', 'x/stand/pkg/netcdf/lib']
\end{python}
