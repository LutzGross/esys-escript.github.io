...
class Test_symbols(unittest.TestCase):
   ...
   def test_Symbol_Scalar_dd(self):
      ...
      self.assertEqual(s.getRank(),0,"wrong rank.")
      self.assertEqual(s.getShape(),(),"wrong shape.")
      self.assertEqual(s.getDim(),d,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   def test_Symbol_Vector_dd(self):
      ...
      self.assertEqual(s.getShape(),(d,),"wrong shape.")
      self.assertEqual(s.getDim(),d,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Vector_d1(self):
      ...
      self.assertEqual(s.getRank(),1,"wrong rank.")
      self.assertEqual(s.getShape(),(1,),"wrong shape.")
      self.assertEqual(s.getDim(),1,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   def test_Symbol_Vector_d3(self):
      ...
      self.assertEqual(s.getRank(),1,"wrong rank.")
      self.assertEqual(s.getShape(),(3,),"wrong shape.")
      self.assertEqual(s.getDim(),3,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor_dd(self):
      ...
      self.assertEqual(s.getShape(),(d,d),"wrong shape.")
      self.assertEqual(s.getDim(),d,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor_d1(self):
      ...
      self.assertEqual(s.getRank(),2,"wrong rank.")
      self.assertEqual(s.getShape(),(1, 1),"wrong shape.")
      self.assertEqual(s.getDim(),1,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor_d2(self):
      ...
      self.assertEqual(s.getRank(),2,"wrong rank.")
      self.assertEqual(s.getShape(),(2, 2),"wrong shape.")
      self.assertEqual(s.getDim(),2,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor_d3(self):
      ...
      self.assertEqual(s.getRank(),2,"wrong rank.")
      self.assertEqual(s.getShape(),(3, 3),"wrong shape.")
      self.assertEqual(s.getDim(),3,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor3_dd(self):
      ...
      self.assertEqual(s.getShape(),(d,d,d),"wrong shape.")
      self.assertEqual(s.getDim(),d,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor3_d1(self):
      ...
      self.assertEqual(s.getRank(),3,"wrong rank.")
      self.assertEqual(s.getShape(),(1, 1, 1),"wrong shape.")
      self.assertEqual(s.getDim(),1,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor3_d2(self):
      ...
      self.assertEqual(s.getRank(),3,"wrong rank.")
      self.assertEqual(s.getShape(),(2, 2, 2),"wrong shape.")
      self.assertEqual(s.getDim(),2,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor3_d3(self):
      ...
      self.assertEqual(s.getRank(),3,"wrong rank.")
      self.assertEqual(s.getShape(),(3, 3, 3),"wrong shape.")
      self.assertEqual(s.getDim(),3,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor4_dd(self):
      ...
      self.assertEqual(s.getShape(),(d,d,d,d),"wrong shape.")
      self.assertEqual(s.getDim(),d,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor4_d1(self):
      ...
      self.assertEqual(s.getRank(),4,"wrong rank.")
      self.assertEqual(s.getShape(),(1, 1, 1, 1),"wrong shape.")
      self.assertEqual(s.getDim(),1,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor4_d2(self):
      ...
      self.assertEqual(s.getRank(),4,"wrong rank.")
      self.assertEqual(s.getShape(),(2, 2, 2, 2),"wrong shape.")
      self.assertEqual(s.getDim(),2,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
   #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   def test_Symbol_Tensor4_d3(self):
      ...
      self.assertEqual(s.getRank(),4,"wrong rank.")
      self.assertEqual(s.getShape(),(3, 3, 3, 3),"wrong shape.")
      self.assertEqual(s.getDim(),3,"wrong spatial dimension.")
      self.assertEqual(s.getArgument(),[],"wrong arguments.")
