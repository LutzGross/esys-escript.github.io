...
class Test_VTKFiles(Test_VisualizationInterface):
  ...
  def test_hex_2D_order2_vtk(self):
     ...
     dom=ReadMesh(REERFENCE_FILE_DIR+"/hex_2D_order2.msh")
     saveVTK("hex_2D_order2.xml",domain=dom)
  ...
  def test_hex_2D_order2_AllPoints_Scalar_vtk(self):
     ...
     saveVTK("hex_2D_order2_AllPoints_Scalar.xml",data_r=x_r[0],data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_order2_02Points_Scalar_vtk(self):
     ...
     x=Solution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveVTK("hex_2D_order2_O2Points_Scalar.xml",data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_order2_2Cells_Scalar_vtk(self):
     ...
     try: 
        saveVTK("hex_2D_order2_2Cells_Scalar.xml",data=x[0],data_b=x_b[0])
  ...
  def test_hex_2D_order2_BoundrayPoint_Scalar_vtk(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveVTK("hex_2D_order2_BoundrayPoint_Scalar.xml",data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_hex_2D_order2_Cells_AllData_vtk(self):
     ...
     dom=ReadMesh(REERFENCE_FILE_DIR+"/hex_2D_order2.msh")
     x=Function(dom).getX()
     saveVTK("hex_2D_order2_Cells_AllData.xml",data_s=x[0],data_v=x[0]*[1.,2.],data_t=x[0]*[[11.,12.],[21.,22.]],data_t2=x[0]*[[-11.,-12.],[-21.,-22.]])
  ...
  def test_hex_2D_order2_CellsPoints_AllData_vtk(self):
     ...
     saveVTK("hex_2D_order2_CellsPoints_AllData.xml",data_sp=x_p[0],
                                                     data_vp=x_p[0]*[1.,2.],
...
class Test_DXFiles(Test_VisualizationInterface):
  ...
  def test_hex_2D_order2_dx(self):
     ...
     dom=ReadMesh(REERFENCE_FILE_DIR+"/hex_2D_order2.msh")
     saveDX("hex_2D_order2.dx",domain=dom)
  ...
  def test_hex_2D_order2_AllPoints_Scalar_dx(self):
     ...
     x_r=ReducedSolution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveDX("hex_2D_order2_AllPoints_Scalar.dx",data_r=x_r[0],data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_order2_02Points_Scalar_dx(self):
     ...
     x=Solution(dom).getX()
     x_n=ContinuousFunction(dom).getX()
     saveDX("hex_2D_order2_O2Points_Scalar.dx",data_n=x_n[0],data=x[0])
  ...
  def test_hex_2D_order2_2Cells_Scalar_dx(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveDX("hex_2D_order2_2Cells_Scalar.dx",data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_hex_2D_order2_BoundrayPoint_Scalar_dx(self):
     ...
     x_b=FunctionOnBoundary(dom).getX()
     try: 
        saveDX("hex_2D_order2_BoundrayPoint_Scalar.dx",data=x[0],data_b=x_b[0])
        self.fail("non-matching data not detected.")
     except StandardError:
        pass
  def test_hex_2D_order2_Cells_AllData_dx(self):
     ...
     dom=ReadMesh(REERFENCE_FILE_DIR+"/hex_2D_order2.msh")
     x=Function(dom).getX()
     saveDX("hex_2D_order2_Cells_AllData.dx",data_s=x[0],data_v=x[0]*[1.,2.],data_t=x[0]*[[11.,12.],[21.,22.]],data_t2=x[0]*[[-11.,-12.],[-21.,-22.]])
  ...
  def test_hex_2D_order2_CellsPoints_AllData_dx(self):
     ...
     x_c=Function(dom).getX()
     x_p=ContinuousFunction(dom).getX()
     saveDX("hex_2D_order2_CellsPoints_AllData.dx",data_sp=x_p[0],
                                                     data_vp=x_p[0]*[1.,2.],
                                                     data_tp=x_p[0]*[[11.,12.],[21.,22.]],
                                                     data_sc=x_c[0],
                                                     data_vc=x_c[0]*[1.,2.],
